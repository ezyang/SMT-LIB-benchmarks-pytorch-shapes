...
(assert eq_69)
(define-fun eq_70 () Bool (= cls_token_size2 256))
(assert eq_70)
...
(assert not__67)
(define-fun mul_46 () Int (* 512 cls_token_size0))
(define-fun sub_12 () Int (- cls_token_size0 1))
(define-fun mul_47 () Int (* 512 sub_12))
(define-fun add_21 () Int (+ 1 mul_47))
(define-fun add_22 () Int (+ add_21 511))
(define-fun mul_48 () Int (* 4 add_22))
(define-fun mul_49 () Int (* cls_token_size0 512))
...
(assert ge_10)
(define-fun mul_50 () Int (* mul_21 512))
(define-fun eq_75 () Bool (= mul_49 mul_50))
(assert eq_75)
(define-fun eq_76 () Bool (= cls_token_size0 cls_token_size0))
(assert eq_76)
(define-fun eq_77 () Bool (= cls_token_size1 512))
(define-fun not__71 () Bool (not eq_77))
(assert not__71)
(define-fun mod_3 () Int (mod 512 cls_token_size1))
(define-fun eq_78 () Bool (= mod_3 0))
(assert eq_78)
(define-fun floordiv_5 () Int (div 512 cls_token_size1))
...
(assert not__73)
(define-fun eq_81 () Bool (= 512 floordiv_5))
(assert eq_81)
(define-fun mul_52 () Int (* floordiv_5 cls_token_size0))
(define-fun eq_82 () Bool (= floordiv_5 512))
(assert eq_82)
...
(assert gt_12)
(define-fun lt_34 () Bool (< floordiv_5 512))
(define-fun not__81 () Bool (not lt_34))
(assert not__81)
(define-fun gt_13 () Bool (> floordiv_5 512))
