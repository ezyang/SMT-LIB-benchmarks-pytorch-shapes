...
(assert eq_37)
(define-fun eq_38 () Bool (= residual_size2 768))
(assert eq_38)
...
(define-fun mul_32 () Int (* 3072 floordiv))
(define-fun mul_33 () Int (* residual_size0 floordiv))
(define-fun mul_34 () Int (* mul_33 3072))
...
(assert not__43)
(define-fun gt_2 () Bool (> mul_32 3072))
(assert gt_2)
...
(define-fun mul_37 () Int (* 3072 sub_5))
...
(assert not__52)
(define-fun mul_44 () Int (* mul_33 768))
...
(define-fun mul_45 () Int (* 768 floordiv_1))
(define-fun mul_46 () Int (* residual_size0 floordiv_1))
(define-fun mul_47 () Int (* mul_46 768))
