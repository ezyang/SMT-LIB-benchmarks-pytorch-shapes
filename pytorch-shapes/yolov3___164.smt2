...
(define-fun eq_26 () Bool (= input_size1 1024))
(assert eq_26)
(define-fun lt_7 () Bool (< input_size2 1))
(define-fun not__18 () Bool (not lt_7))
(assert not__18)
(define-fun lt_8 () Bool (< input_size3 1))
...
(define-fun mul_26 () Int (* input_size0 255))
...
(define-fun output0_size1 () Int 255)
...
(define-fun output0_stride2 () Int add_12)
