...
(assert eq_35)
(define-fun eq_36 () Bool (= hidden_states_size2 768))
(assert eq_36)
(define-fun mul_23 () Int (* 768 hidden_states_size1))
(define-fun mul_24 () Int (* 768 sub_1))
(define-fun add_12 () Int (+ 1 mul_24))
(define-fun add_13 () Int (+ add_12 767))
(define-fun mul_25 () Int (* 4 add_13))
(define-fun mul_26 () Int (* hidden_states_size1 768))
...
(define-fun mul_28 () Int (* 768 floordiv))
...
(assert not__36)
(define-fun gt_1 () Bool (> mul_28 768))
(assert gt_1)
...
(assert eq_54)
(define-fun mul_37 () Int (* mul_29 12))
...
(assert lt_12)
(define-fun mul_48 () Int (* mul_4 12))
...
(assert eq_68)
(define-fun mul_50 () Int (* 12 floordiv))
...
(define-fun mul_54 () Int (* mul_52 11))
