...
(assert eq_29)
(define-fun eq_30 () Bool (= ___stack0_last_hidden_state_size2 256))
(assert eq_30)
...
(define-fun mul_39 () Int (* 30522 floordiv_1))
(define-fun mul_40 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_41 () Int (* mul_40 30522))
...
(define-fun mul_44 () Int (* mul_43 30522))
...
(define-fun mul_46 () Int (* mul_45 30522))
...
(assert not__54)
(define-fun mul_47 () Int (* 30522 floordiv_3))
...
(assert not__60)
(define-fun eq_73 () Bool (= mul_46 30522))
(define-fun not__61 () Bool (not eq_73))
(assert not__61)
(define-fun mod_6 () Int (mod mul_46 30522))
(define-fun eq_74 () Bool (= mod_6 0))
(assert eq_74)
(define-fun floordiv_6 () Int (div mul_46 30522))
...
(assert not__66)
(define-fun mul_51 () Int (* floordiv_3 30522))
...
(assert not__76)
(define-fun mul_53 () Int (* 30522 sub_13))
