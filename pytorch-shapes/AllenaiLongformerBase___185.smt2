...
(set-info :example-___stack0_last_hidden_state_size1 1024)
...
(define-fun mul_39 () Int (* 50265 floordiv_1))
(define-fun mul_40 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_41 () Int (* mul_40 50265))
...
(assert eq_61)
(define-fun eq_62 () Bool (= mul_41 50265))
(define-fun not__46 () Bool (not eq_62))
(assert not__46)
(define-fun mod_6 () Int (mod mul_41 50265))
(define-fun eq_63 () Bool (= mod_6 0))
(assert eq_63)
(define-fun floordiv_2 () Int (div mul_41 50265))
...
(assert not__50)
(define-fun mul_42 () Int (* floordiv_1 50265))
...
(assert not__58)
(define-fun mul_44 () Int (* 50265 sub_6))
(define-fun add_20 () Int (+ 1 mul_44))
(define-fun add_21 () Int (+ add_20 50264))
