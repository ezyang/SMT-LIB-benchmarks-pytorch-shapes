...
(set-info :example-shortcut_size1 1536)
...
(set-info :example-shortcut_stride0 98304)
...
(define-fun mul_48 () Int (* 1536 add_28))
...
(define-fun mul_57 () Int (* ___stack0_size0 1536))
...
(set-info :example-self_conv3_1x1_bn_running_mean_size0 1536)
...
(set-info :example-self_conv3_1x1_bn_running_var_size0 1536)
...
(assert not__74)
(define-fun eq_90 () Bool (= self_conv3_1x1_bn_running_mean_size0 1536))
(assert eq_90)
(define-fun eq_91 () Bool (= self_conv3_1x1_bn_running_var_size0 1536))
(assert eq_91)
...
(define-fun truediv_2 () Real (/ mul_59 1536))
...
(assert eq_99)
(define-fun eq_100 () Bool (= shortcut_size1 1536))
(assert eq_100)
