...
(set-info :example-___stack1_size2 1024)
(declare-const ___stack1_stride0 Int)
(set-info :example-___stack1_stride0 1048576)
(declare-const ___stack1_stride1 Int)
(set-info :example-___stack1_stride1 1024)
...
(set-info :example-v_size1 1024)
(declare-const v_size2 Int)
(set-info :example-v_size2 32)
...
(set-info :example-v_stride2 1024)
