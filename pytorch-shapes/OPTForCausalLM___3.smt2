...
(define-fun eq_27 () Bool (= hidden_states_size2 768))
(assert eq_27)
...
(assert eq_41)
(define-fun mul_26 () Int (* 768 hidden_states_size1))
...
(define-fun mul_29 () Int (* hidden_states_size1 768))
...
(assert not__42)
(define-fun gt_3 () Bool (> mul_31 768))
(assert gt_3)
...
(define-fun mul_38 () Int (* hidden_states_size0 12))
...
(assert eq_57)
(define-fun mul_40 () Int (* mul_32 12))
...
(assert lt_16)
(define-fun mul_51 () Int (* mul_4 12))
...
(assert eq_71)
(define-fun mul_53 () Int (* 12 floordiv))
