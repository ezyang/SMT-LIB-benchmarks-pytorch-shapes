...
(set-info :example-___stack0_size1 2048)
...
(define-fun mul_17 () Int (* ___stack0_size1 ___stack0_size0))
(define-fun mul_18 () Int (* ___stack0_size1 sub))
(define-fun add_9 () Int (+ 1 mul_18))
(define-fun add_10 () Int (+ add_9 sub_1))
(define-fun mul_19 () Int (* 4 add_10))
(define-fun eq_26 () Bool (= mul_5 0))
(define-fun not__18 () Bool (not eq_26))
(assert not__18)
(define-fun lt_7 () Bool (< 1 ___stack0_size1))
(assert lt_7)
(define-fun sym_float () Real (to_real mul_8))
(define-fun lt_8 () Bool (< ___stack0_size1 0))
(define-fun not__19 () Bool (not lt_8))
(assert not__19)
(define-fun lt_9 () Bool (< ___stack0_size0 0))
(define-fun not__20 () Bool (not lt_9))
(assert not__20)
(define-fun lt_10 () Bool (< ___stack0_size1 1))
(define-fun not__21 () Bool (not lt_10))
(assert not__21)
(define-fun eq_27 () Bool (= ___stack0_size0 -1))
(define-fun not__22 () Bool (not eq_27))
(assert not__22)
(define-fun eq_28 () Bool (= ___stack0_size1 -1))
(define-fun not__23 () Bool (not eq_28))
(assert not__23)
(define-fun eq_29 () Bool (= mul_5 mul_5))
(assert eq_29)
(define-fun lt_11 () Bool (< 1 mul_17))
(assert lt_11)
(define-fun lt_12 () Bool (< ___stack0_size1 mul_17))
(assert lt_12)
(define-fun eq_30 () Bool (= mul_17 mul_17))
(assert eq_30)
(define-fun eq_31 () Bool (= ___stack0_size1 2048))
(assert eq_31)
(define-fun mul_20 () Int (* 1000 ___stack0_size0))
(define-fun mul_21 () Int (* 1000 sub))
(define-fun add_11 () Int (+ 1 mul_21))
(define-fun add_12 () Int (+ add_11 999))
(define-fun mul_22 () Int (* 4 add_12))
(define-fun mul_23 () Int (* ___stack0_size0 1000))
(define-fun eq_32 () Bool (= mul_23 0))
(define-fun not__24 () Bool (not eq_32))
(assert not__24)
(define-fun lt_13 () Bool (< ___stack0_size0 2))
(define-fun not__25 () Bool (not lt_13))
(assert not__25)
(define-fun eq_33 () Bool (= mul_16 0))
...
(check-sat)
(get-value (___stack0_size0 ___stack0_size1 ___stack0_size2 ___stack0_size3 ___stack0_stride0 ___stack0_stride1 ___stack0_stride2 ___stack0_stride3 ___stack0_storage_offset output0_size0 output0_size1 output0_stride0 output0_stride1 output0_storage_offset))
