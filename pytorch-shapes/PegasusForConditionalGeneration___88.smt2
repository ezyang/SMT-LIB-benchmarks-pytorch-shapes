...
(set-info :example-attention_mask_size2 128)
(declare-const attention_mask_size3 Int)
(set-info :example-attention_mask_size3 128)
(declare-const attention_mask_stride0 Int)
(set-info :example-attention_mask_stride0 16384)
(declare-const attention_mask_stride1 Int)
(set-info :example-attention_mask_stride1 16384)
(declare-const attention_mask_stride2 Int)
(set-info :example-attention_mask_stride2 128)
...
(set-info :example-encoder_hidden_states_stride0 131072)
