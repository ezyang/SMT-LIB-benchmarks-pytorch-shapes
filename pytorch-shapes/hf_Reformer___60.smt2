...
(define-fun eq_17 () Bool (= ___stack0_size2 512))
(assert eq_17)
(define-fun mul_12 () Int (* ___stack0_size1 ___stack0_size0))
(define-fun mul_13 () Int (* ___stack0_size1 sub))
...
(assert not__11)
(define-fun lt_3 () Bool (< ___stack0_size0 0))
(define-fun not__12 () Bool (not lt_3))
(assert not__12)
(define-fun lt_4 () Bool (< ___stack0_size1 1))
(define-fun not__13 () Bool (not lt_4))
(assert not__13)
(define-fun gt () Bool (> ___stack0_size1 1))
(assert gt)
(define-fun lt_5 () Bool (< ___stack0_size2 0))
(define-fun not__14 () Bool (not lt_5))
(assert not__14)
(define-fun eq_19 () Bool (= ___stack0_size0 -1))
(define-fun not__15 () Bool (not eq_19))
(assert not__15)
(define-fun eq_20 () Bool (= ___stack0_size1 -1))
(define-fun not__16 () Bool (not eq_20))
(assert not__16)
(define-fun eq_21 () Bool (= ___stack0_size2 -1))
(define-fun not__17 () Bool (not eq_21))
(assert not__17)
(define-fun lt_6 () Bool (< ___stack0_size1 2))
(define-fun not__18 () Bool (not lt_6))
(assert not__18)
(define-fun lt_7 () Bool (< ___stack0_size0 2))
(define-fun not__19 () Bool (not lt_7))
(assert not__19)
(define-fun lt_8 () Bool (< 1 ___stack0_size1))
(assert lt_8)
(define-fun lt_9 () Bool (< ___stack0_size2 2))
(define-fun not__20 () Bool (not lt_9))
(assert not__20)
(define-fun gt_1 () Bool (> ___stack0_size2 1))
(assert gt_1)
(define-fun eq_22 () Bool (= mul_6 0))
(define-fun not__21 () Bool (not eq_22))
(assert not__21)
(define-fun lt_10 () Bool (< ___stack0_size2 mul_6))
(assert lt_10)
(define-fun eq_23 () Bool (= 0 ___stack0_size2))
(define-fun not__22 () Bool (not eq_23))
(assert not__22)
(define-fun gt_2 () Bool (> mul_5 0))
(assert gt_2)
(define-fun lt_11 () Bool (< mul_5 2))
(define-fun not__23 () Bool (not lt_11))
(assert not__23)
(define-fun eq_24 () Bool (= mul_11 0))
(define-fun not__24 () Bool (not eq_24))
(assert not__24)
(define-fun eq_25 () Bool (= mul_10 0))
...
(check-sat)
(get-value (___stack0_size0 ___stack0_size1 ___stack0_size2 ___stack0_stride0 ___stack0_stride1 ___stack0_stride2 ___stack0_storage_offset output0_size0 output0_size1 output0_size2 output0_stride0 output0_stride1 output0_stride2 output0_storage_offset))
