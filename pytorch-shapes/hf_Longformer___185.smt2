...
(assert eq_52)
(define-fun lt_11 () Bool (< mul_21 768))
(define-fun not__41 () Bool (not lt_11))
(assert not__41)
(define-fun gt_3 () Bool (> mul_23 0))
(assert gt_3)
(define-fun mul_31 () Int (* mul_28 768))
...
(assert not__43)
(define-fun mul_32 () Int (* 768 mul_28))
...
(assert not__44)
(define-fun mul_33 () Int (* 50265 mul_28))
(define-fun sub_5 () Int (- mul_28 1))
(define-fun mul_34 () Int (* 50265 sub_5))
(define-fun add_14 () Int (+ 1 mul_34))
(define-fun add_15 () Int (+ add_14 50264))
(define-fun mul_35 () Int (* 4 add_15))
(define-fun mul_36 () Int (* mul_28 50265))
...
(assert not__47)
(define-fun mul_37 () Int (* mul_22 50265))
...
(define-fun mul_38 () Int (* 50265 floordiv_1))
(define-fun mul_39 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_40 () Int (* mul_39 50265))
...
(define-fun output0_size2 () Int 50265)
(define-fun output0_stride0 () Int mul_38)
(define-fun output0_stride1 () Int 50265)
