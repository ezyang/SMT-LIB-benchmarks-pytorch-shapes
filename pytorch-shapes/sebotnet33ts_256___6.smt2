...
(define-fun mul_40 () Int (* 128 add_26))
...
(set-info :example-self_conv2_kxk_bn_running_mean_size0 128)
...
(set-info :example-self_conv2_kxk_bn_running_var_size0 128)
...
(assert not__63)
(define-fun eq_70 () Bool (= self_conv2_kxk_bn_running_mean_size0 128))
(assert eq_70)
(define-fun eq_71 () Bool (= self_conv2_kxk_bn_running_var_size0 128))
(assert eq_71)
...
(define-fun truediv_2 () Real (/ mul_50 128))
...
(define-fun mul_62 () Int (* 128 x_size0))
(define-fun mul_63 () Int (* 128 sub))
(define-fun add_41 () Int (+ 1 mul_63))
(define-fun add_42 () Int (+ add_41 127))
...
(assert not__74)
(define-fun mul_66 () Int (* 8 x_size0))
(define-fun mul_67 () Int (* 8 sub))
(define-fun add_43 () Int (+ 1 mul_67))
(define-fun add_44 () Int (+ add_43 7))
(define-fun mul_68 () Int (* 4 add_44))
(define-fun mul_69 () Int (* x_size0 8))
(define-fun eq_79 () Bool (= mul_69 0))
(define-fun not__75 () Bool (not eq_79))
(assert not__75)
(define-fun eq_80 () Bool (= mul_69 mul_69))
(assert eq_80)
(define-fun floordiv_11 () Int (div mul_69 x_size0))
(define-fun gt_11 () Bool (> floordiv_11 2147483647))
(define-fun not__76 () Bool (not gt_11))
(assert not__76)
(define-fun eq_81 () Bool (= mul_26 mul_26))
(assert eq_81)
...
(assert not__78)
(define-fun floordiv_12 () Int (div mul_50 x_size0))
(define-fun gt_12 () Bool (> floordiv_12 2147483647))
(define-fun not__79 () Bool (not gt_12))
(assert not__79)
(define-fun floordiv_13 () Int (div sub_19 1))
(define-fun add_45 () Int (+ floordiv_13 1))
(define-fun floordiv_14 () Int (div sub_20 1))
(define-fun add_46 () Int (+ floordiv_14 1))
(define-fun mul_70 () Int (* 512 add_45))
(define-fun mul_71 () Int (* mul_70 add_46))
(define-fun gt_13 () Bool (> mul_71 2147483647))
(define-fun not__80 () Bool (not gt_13))
(assert not__80)
(define-fun sub_24 () Int (- add_28 0))
(define-fun sub_25 () Int (- sub_24 1))
(define-fun floordiv_15 () Int (div sub_25 1))
(define-fun add_47 () Int (+ floordiv_15 1))
(define-fun sub_26 () Int (- add_29 0))
(define-fun sub_27 () Int (- sub_26 1))
(define-fun floordiv_16 () Int (div sub_27 1))
(define-fun add_48 () Int (+ floordiv_16 1))
(define-fun ge_19 () Bool (>= add_47 0))
(assert ge_19)
(define-fun ge_20 () Bool (>= add_48 0))
(assert ge_20)
(define-fun eq_82 () Bool (= add_48 0))
(define-fun not__81 () Bool (not eq_82))
(assert not__81)
(define-fun eq_83 () Bool (= add_47 0))
(define-fun not__82 () Bool (not eq_83))
(assert not__82)
(define-fun mul_72 () Int (* add_48 add_47))
...
(define-fun mul_76 () Int (* mul_72 511))
(define-fun add_50 () Int (+ add_49 mul_76))
(define-fun sub_28 () Int (- add_47 1))
(define-fun mul_77 () Int (* add_48 sub_28))
(define-fun add_51 () Int (+ add_50 mul_77))
(define-fun sub_29 () Int (- add_48 1))
(define-fun add_52 () Int (+ add_51 sub_29))
(define-fun mul_78 () Int (* 4 add_52))
(define-fun mul_79 () Int (* x_size0 512))
(define-fun mul_80 () Int (* mul_79 add_47))
(define-fun mul_81 () Int (* mul_80 add_48))
(define-fun eq_84 () Bool (= mul_81 0))
(define-fun not__83 () Bool (not eq_84))
(assert not__83)
(define-fun eq_85 () Bool (= add_48 1))
(define-fun not__84 () Bool (not eq_85))
(assert not__84)
(define-fun eq_86 () Bool (= add_47 1))
(define-fun not__85 () Bool (not eq_86))
(assert not__85)
...
(assert not__87)
(define-fun lt_37 () Bool (< mul_72 0))
(define-fun not__88 () Bool (not lt_37))
(assert not__88)
(define-fun lt_38 () Bool (< 1 mul_73))
(assert lt_38)
(define-fun gt_14 () Bool (> mul_42 1))
(assert gt_14)
(define-fun gt_15 () Bool (> mul_43 1))
(assert gt_15)
...
(assert ge_21)
(define-fun add_53 () Int (+ self_conv3_1x1_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_82 () Int (* 8 add_53))
(declare-const self_conv3_1x1_bn_running_mean_size0 Int)
(set-info :example-self_conv3_1x1_bn_running_mean_size0 512)
...
(assert ge_22)
(define-fun eq_92 () Bool (= self_conv3_1x1_bn_running_mean_size0 0))
(define-fun not__89 () Bool (not eq_92))
(assert not__89)
(define-fun sub_30 () Int (- self_conv3_1x1_bn_running_mean_size0 1))
(define-fun mul_83 () Int (* self_conv3_1x1_bn_running_mean_stride0 sub_30))
(define-fun add_54 () Int (+ 1 mul_83))
(define-fun mul_84 () Int (* 4 add_54))
(define-fun eq_93 () Bool (= self_conv3_1x1_bn_running_mean_size0 1))
(define-fun not__90 () Bool (not eq_93))
(assert not__90)
(define-fun eq_94 () Bool (= self_conv3_1x1_bn_running_mean_stride0 1))
(assert eq_94)
(define-fun ge_23 () Bool (>= self_conv3_1x1_bn_running_mean_storage_offset 0))
(assert ge_23)
(define-fun add_55 () Int (+ self_conv3_1x1_bn_running_mean_storage_offset add_54))
(define-fun mul_85 () Int (* 4 add_55))
(declare-const self_conv3_1x1_bn_running_var_size0 Int)
(set-info :example-self_conv3_1x1_bn_running_var_size0 512)
...
(assert ge_24)
(define-fun eq_95 () Bool (= self_conv3_1x1_bn_running_var_size0 0))
(define-fun not__91 () Bool (not eq_95))
(assert not__91)
(define-fun sub_31 () Int (- self_conv3_1x1_bn_running_var_size0 1))
(define-fun mul_86 () Int (* self_conv3_1x1_bn_running_var_stride0 sub_31))
(define-fun add_56 () Int (+ 1 mul_86))
(define-fun mul_87 () Int (* 4 add_56))
(define-fun eq_96 () Bool (= self_conv3_1x1_bn_running_var_size0 1))
(define-fun not__92 () Bool (not eq_96))
(assert not__92)
(define-fun eq_97 () Bool (= self_conv3_1x1_bn_running_var_stride0 1))
(assert eq_97)
(define-fun ge_25 () Bool (>= self_conv3_1x1_bn_running_var_storage_offset 0))
(assert ge_25)
(define-fun add_57 () Int (+ self_conv3_1x1_bn_running_var_storage_offset add_56))
(define-fun mul_88 () Int (* 4 add_57))
(define-fun mul_89 () Int (* x_size0 add_47))
(define-fun mul_90 () Int (* mul_89 add_48))
(define-fun eq_98 () Bool (= mul_90 1))
(define-fun not__93 () Bool (not eq_98))
(assert not__93)
(define-fun eq_99 () Bool (= self_conv3_1x1_bn_running_mean_size0 512))
(assert eq_99)
(define-fun eq_100 () Bool (= self_conv3_1x1_bn_running_var_size0 512))
(assert eq_100)
(define-fun lt_39 () Bool (< mul_81 2147483647))
(assert lt_39)
(define-fun sym_float_3 () Real (to_real mul_90))
(define-fun lt_40 () Bool (< add_48 0))
(define-fun not__94 () Bool (not lt_40))
(assert not__94)
(define-fun lt_41 () Bool (< add_47 0))
(define-fun not__95 () Bool (not lt_41))
(assert not__95)
(define-fun eq_101 () Bool (= add_47 add_47))
(assert eq_101)
(define-fun eq_102 () Bool (= add_47 -1))
(define-fun not__96 () Bool (not eq_102))
(assert not__96)
(define-fun eq_103 () Bool (= add_48 -1))
(define-fun not__97 () Bool (not eq_103))
(assert not__97)
(define-fun lt_42 () Bool (< add_47 2))
(define-fun not__98 () Bool (not lt_42))
(assert not__98)
(define-fun lt_43 () Bool (< add_48 2))
(define-fun not__99 () Bool (not lt_43))
(assert not__99)
(define-fun gt_16 () Bool (> add_48 1))
(assert gt_16)
(define-fun lt_44 () Bool (< add_48 mul_72))
(assert lt_44)
(define-fun eq_104 () Bool (= mul_73 0))
(define-fun not__100 () Bool (not eq_104))
(assert not__100)
(define-fun lt_45 () Bool (< mul_72 mul_73))
(assert lt_45)
(define-fun lt_46 () Bool (< self_conv3_1x1_bn_running_mean_size0 0))
(define-fun not__101 () Bool (not lt_46))
(assert not__101)
(define-fun eq_105 () Bool (= self_conv3_1x1_bn_running_mean_size0 self_conv3_1x1_bn_running_mean_size0))
(assert eq_105)
(define-fun add_58 () Int (+ 1 sub_30))
(define-fun mul_91 () Int (* 4 add_58))
(define-fun truediv_4 () Real (/ mul_81 512))
...
(assert not__102)
(define-fun eq_106 () Bool (= self_conv3_1x1_bn_running_var_size0 self_conv3_1x1_bn_running_var_size0))
(assert eq_106)
(define-fun add_59 () Int (+ 1 sub_31))
(define-fun mul_92 () Int (* 4 add_59))
(define-fun floordiv_17 () Int (div sub_2 2))
(define-fun add_60 () Int (+ floordiv_17 1))
(define-fun floordiv_18 () Int (div sub_3 2))
(define-fun add_61 () Int (+ floordiv_18 1))
(define-fun mul_93 () Int (* 512 add_60))
(define-fun mul_94 () Int (* mul_93 add_61))
(define-fun gt_17 () Bool (> mul_94 2147483647))
(define-fun not__103 () Bool (not gt_17))
(assert not__103)
(define-fun floordiv_19 () Int (div sub_5 2))
(define-fun add_62 () Int (+ floordiv_19 1))
(define-fun floordiv_20 () Int (div sub_7 2))
(define-fun add_63 () Int (+ floordiv_20 1))
(define-fun ge_26 () Bool (>= add_62 0))
(assert ge_26)
(define-fun ge_27 () Bool (>= add_63 0))
(assert ge_27)
(define-fun eq_107 () Bool (= add_63 0))
(define-fun not__104 () Bool (not eq_107))
(assert not__104)
(define-fun eq_108 () Bool (= add_62 0))
(define-fun not__105 () Bool (not eq_108))
(assert not__105)
(define-fun mul_95 () Int (* add_63 add_62))
(define-fun mul_96 () Int (* mul_95 512))
(define-fun mul_97 () Int (* mul_96 x_size0))
(define-fun mul_98 () Int (* mul_96 sub))
(define-fun add_64 () Int (+ 1 mul_98))
(define-fun mul_99 () Int (* mul_95 511))
(define-fun add_65 () Int (+ add_64 mul_99))
(define-fun sub_33 () Int (- add_62 1))
(define-fun mul_100 () Int (* add_63 sub_33))
(define-fun add_66 () Int (+ add_65 mul_100))
(define-fun sub_34 () Int (- add_63 1))
(define-fun add_67 () Int (+ add_66 sub_34))
(define-fun mul_101 () Int (* 4 add_67))
(define-fun mul_102 () Int (* mul_79 add_62))
(define-fun mul_103 () Int (* mul_102 add_63))
(define-fun eq_109 () Bool (= mul_103 0))
(define-fun not__106 () Bool (not eq_109))
(assert not__106)
(define-fun eq_110 () Bool (= add_63 1))
(define-fun not__107 () Bool (not eq_110))
(assert not__107)
(define-fun eq_111 () Bool (= add_62 1))
(define-fun not__108 () Bool (not eq_111))
(assert not__108)
(define-fun eq_112 () Bool (= add_63 add_63))
(assert eq_112)
(define-fun eq_113 () Bool (= mul_95 mul_95))
(assert eq_113)
(define-fun eq_114 () Bool (= mul_96 mul_96))
(assert eq_114)
(define-fun eq_115 () Bool (= mul_95 1))
(define-fun not__109 () Bool (not eq_115))
(assert not__109)
(define-fun eq_116 () Bool (= mul_95 0))
(define-fun not__110 () Bool (not eq_116))
(assert not__110)
(define-fun lt_48 () Bool (< mul_95 0))
(define-fun not__111 () Bool (not lt_48))
(assert not__111)
(define-fun lt_49 () Bool (< 1 mul_96))
(assert lt_49)
...
(assert ge_28)
(define-fun add_68 () Int (+ self_shortcut_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_104 () Int (* 8 add_68))
(declare-const self_shortcut_bn_running_mean_size0 Int)
(set-info :example-self_shortcut_bn_running_mean_size0 512)
...
(assert ge_29)
(define-fun eq_117 () Bool (= self_shortcut_bn_running_mean_size0 0))
(define-fun not__112 () Bool (not eq_117))
(assert not__112)
(define-fun sub_35 () Int (- self_shortcut_bn_running_mean_size0 1))
(define-fun mul_105 () Int (* self_shortcut_bn_running_mean_stride0 sub_35))
(define-fun add_69 () Int (+ 1 mul_105))
(define-fun mul_106 () Int (* 4 add_69))
(define-fun eq_118 () Bool (= self_shortcut_bn_running_mean_size0 1))
(define-fun not__113 () Bool (not eq_118))
(assert not__113)
(define-fun eq_119 () Bool (= self_shortcut_bn_running_mean_stride0 1))
(assert eq_119)
(define-fun ge_30 () Bool (>= self_shortcut_bn_running_mean_storage_offset 0))
(assert ge_30)
(define-fun add_70 () Int (+ self_shortcut_bn_running_mean_storage_offset add_69))
(define-fun mul_107 () Int (* 4 add_70))
(declare-const self_shortcut_bn_running_var_size0 Int)
(set-info :example-self_shortcut_bn_running_var_size0 512)
...
(assert ge_31)
(define-fun eq_120 () Bool (= self_shortcut_bn_running_var_size0 0))
(define-fun not__114 () Bool (not eq_120))
(assert not__114)
(define-fun sub_36 () Int (- self_shortcut_bn_running_var_size0 1))
(define-fun mul_108 () Int (* self_shortcut_bn_running_var_stride0 sub_36))
(define-fun add_71 () Int (+ 1 mul_108))
(define-fun mul_109 () Int (* 4 add_71))
(define-fun eq_121 () Bool (= self_shortcut_bn_running_var_size0 1))
(define-fun not__115 () Bool (not eq_121))
(assert not__115)
(define-fun eq_122 () Bool (= self_shortcut_bn_running_var_stride0 1))
(assert eq_122)
(define-fun ge_32 () Bool (>= self_shortcut_bn_running_var_storage_offset 0))
(assert ge_32)
(define-fun add_72 () Int (+ self_shortcut_bn_running_var_storage_offset add_71))
(define-fun mul_110 () Int (* 4 add_72))
(define-fun mul_111 () Int (* x_size0 add_62))
(define-fun mul_112 () Int (* mul_111 add_63))
(define-fun eq_123 () Bool (= mul_112 1))
(define-fun not__116 () Bool (not eq_123))
(assert not__116)
(define-fun eq_124 () Bool (= self_shortcut_bn_running_mean_size0 512))
(assert eq_124)
(define-fun eq_125 () Bool (= self_shortcut_bn_running_var_size0 512))
(assert eq_125)
(define-fun lt_50 () Bool (< mul_103 2147483647))
(assert lt_50)
(define-fun sym_float_4 () Real (to_real mul_112))
(define-fun lt_51 () Bool (< add_63 0))
(define-fun not__117 () Bool (not lt_51))
(assert not__117)
(define-fun lt_52 () Bool (< add_62 0))
(define-fun not__118 () Bool (not lt_52))
(assert not__118)
(define-fun eq_126 () Bool (= add_62 add_62))
(assert eq_126)
(define-fun eq_127 () Bool (= add_62 -1))
(define-fun not__119 () Bool (not eq_127))
(assert not__119)
(define-fun eq_128 () Bool (= add_63 -1))
(define-fun not__120 () Bool (not eq_128))
(assert not__120)
(define-fun lt_53 () Bool (< add_62 2))
(define-fun not__121 () Bool (not lt_53))
(assert not__121)
(define-fun lt_54 () Bool (< add_63 2))
(define-fun not__122 () Bool (not lt_54))
(assert not__122)
(define-fun gt_18 () Bool (> add_63 1))
(assert gt_18)
(define-fun lt_55 () Bool (< add_63 mul_95))
(assert lt_55)
(define-fun eq_129 () Bool (= mul_96 0))
(define-fun not__123 () Bool (not eq_129))
(assert not__123)
(define-fun lt_56 () Bool (< mul_95 mul_96))
(assert lt_56)
(define-fun lt_57 () Bool (< self_shortcut_bn_running_mean_size0 0))
(define-fun not__124 () Bool (not lt_57))
(assert not__124)
(define-fun eq_130 () Bool (= self_shortcut_bn_running_mean_size0 self_shortcut_bn_running_mean_size0))
(assert eq_130)
(define-fun add_73 () Int (+ 1 sub_35))
(define-fun mul_113 () Int (* 4 add_73))
(define-fun truediv_6 () Real (/ mul_103 512))
(define-fun sub_37 () Real (- truediv_6 1))
(define-fun truediv_7 () Real (/ truediv_6 sub_37))
(define-fun lt_58 () Bool (< self_shortcut_bn_running_var_size0 0))
(define-fun not__125 () Bool (not lt_58))
(assert not__125)
(define-fun eq_131 () Bool (= self_shortcut_bn_running_var_size0 self_shortcut_bn_running_var_size0))
(assert eq_131)
(define-fun add_74 () Int (+ 1 sub_36))
(define-fun mul_114 () Int (* 4 add_74))
(define-fun eq_132 () Bool (= add_48 add_63))
(assert eq_132)
(define-fun eq_133 () Bool (= add_47 add_62))
(assert eq_133)
(define-fun eq_134 () Bool (= add_62 add_47))
(assert eq_134)
(define-fun eq_135 () Bool (= add_63 add_48))
(assert eq_135)
(define-fun eq_136 () Bool (= mul_16 0))
(define-fun not__126 () Bool (not eq_136))
(assert not__126)
(define-fun eq_137 () Bool (= mul_29 0))
(define-fun not__127 () Bool (not eq_137))
(assert not__127)
(define-fun eq_138 () Bool (= mul_32 0))
(define-fun not__128 () Bool (not eq_138))
(assert not__128)
(define-fun eq_139 () Bool (= mul_35 0))
(define-fun not__129 () Bool (not eq_139))
(assert not__129)
(define-fun eq_140 () Bool (= mul_51 0))
(define-fun not__130 () Bool (not eq_140))
(assert not__130)
(define-fun eq_141 () Bool (= mul_54 0))
(define-fun not__131 () Bool (not eq_141))
(assert not__131)
(define-fun eq_142 () Bool (= mul_57 0))
(define-fun not__132 () Bool (not eq_142))
(assert not__132)
(define-fun eq_143 () Bool (= mul_82 0))
(define-fun not__133 () Bool (not eq_143))
(assert not__133)
(define-fun eq_144 () Bool (= mul_85 0))
(define-fun not__134 () Bool (not eq_144))
(assert not__134)
(define-fun eq_145 () Bool (= mul_88 0))
(define-fun not__135 () Bool (not eq_145))
(assert not__135)
(define-fun eq_146 () Bool (= mul_104 0))
(define-fun not__136 () Bool (not eq_146))
(assert not__136)
(define-fun eq_147 () Bool (= mul_107 0))
(define-fun not__137 () Bool (not eq_147))
(assert not__137)
(define-fun eq_148 () Bool (= mul_110 0))
(define-fun not__138 () Bool (not eq_148))
(assert not__138)
(define-fun eq_149 () Bool (= mul_78 0))
(define-fun not__139 () Bool (not eq_149))
(assert not__139)
...
(define-fun output8_size1 () Int 512)
(define-fun output8_size2 () Int add_47)
(define-fun output8_size3 () Int add_48)
(define-fun output8_stride0 () Int mul_73)
(define-fun output8_stride1 () Int mul_72)
(define-fun output8_stride2 () Int add_48)
