...
(assert not__34)
(define-fun eq_44 () Bool (= self_conv1_bn_running_mean_size0 128))
(assert eq_44)
(define-fun eq_45 () Bool (= self_conv1_bn_running_var_size0 128))
(assert eq_45)
...
(assert not__63)
(define-fun eq_71 () Bool (= self_conv2_bn_running_mean_size0 128))
(assert eq_71)
(define-fun eq_72 () Bool (= self_conv2_bn_running_var_size0 128))
(assert eq_72)
