...
(set-info :example-attention_mask_size2 1024)
(declare-const attention_mask_size3 Int)
(set-info :example-attention_mask_size3 1024)
(declare-const attention_mask_stride0 Int)
(set-info :example-attention_mask_stride0 1048576)
(declare-const attention_mask_stride1 Int)
(set-info :example-attention_mask_stride1 1048576)
(declare-const attention_mask_stride2 Int)
(set-info :example-attention_mask_stride2 1024)
...
(set-info :example-encoder_hidden_states_size1 1024)
(declare-const encoder_hidden_states_size2 Int)
(set-info :example-encoder_hidden_states_size2 1024)
(declare-const encoder_hidden_states_stride0 Int)
(set-info :example-encoder_hidden_states_stride0 1048576)
(declare-const encoder_hidden_states_stride1 Int)
(set-info :example-encoder_hidden_states_stride1 1024)
...
(check-sat)
(get-value (hidden_states_size0 hidden_states_size1 hidden_states_size2 hidden_states_stride0 hidden_states_stride1 hidden_states_stride2 hidden_states_storage_offset attention_mask_size0 attention_mask_size1 attention_mask_size2 attention_mask_size3 attention_mask_stride0 attention_mask_stride1 attention_mask_stride2 attention_mask_stride3 attention_mask_storage_offset encoder_hidden_states_size0 encoder_hidden_states_size1 encoder_hidden_states_size2 encoder_hidden_states_stride0 encoder_hidden_states_stride1 encoder_hidden_states_stride2 encoder_hidden_states_storage_offset output0_size0 output0_size1 output0_size2 output0_stride0 output0_stride1 output0_stride2 output0_storage_offset))
