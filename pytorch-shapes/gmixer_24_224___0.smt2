...
(assert ge_8)
(define-fun mul_32 () Int (* 384 mul_15))
...
(define-fun mul_35 () Int (* 384 sub_12))
(define-fun add_14 () Int (+ add_13 mul_35))
(define-fun add_15 () Int (+ add_14 383))
...
(assert not__38)
(define-fun gt_6 () Bool (> mul_32 384))
(assert gt_6)
(define-fun lt_16 () Bool (< 1 mul_32))
(assert lt_16)
(define-fun lt_17 () Bool (< 384 mul_32))
(assert lt_17)
...
(assert not__40)
(define-fun eq_46 () Bool (= mul_32 384))
...
(assert eq_49)
(define-fun mul_42 () Int (* 147456 x_size0))
(define-fun mul_43 () Int (* 147456 sub))
(define-fun add_18 () Int (+ 1 mul_43))
(define-fun add_19 () Int (+ add_18 147072))
...
(assert eq_51)
(define-fun mul_46 () Int (* mul_22 192))
(define-fun eq_52 () Bool (= mul_46 0))
(define-fun not__44 () Bool (not eq_52))
(assert not__44)
(define-fun mul_47 () Int (* 73728 x_size0))
(define-fun mul_48 () Int (* 73728 sub))
(define-fun add_21 () Int (+ 1 mul_48))
(define-fun add_22 () Int (+ add_21 73536))
(define-fun add_23 () Int (+ add_22 191))
(define-fun mul_49 () Int (* 4 add_23))
(define-fun eq_53 () Bool (= mul_22 -1))
(define-fun not__45 () Bool (not eq_53))
(assert not__45)
(define-fun ge_9 () Bool (>= mul_22 0))
(assert ge_9)
(define-fun eq_54 () Bool (= mul_46 mul_46))
(assert eq_54)
(define-fun eq_55 () Bool (= x_size0 mul_22))
(define-fun not__46 () Bool (not eq_55))
(assert not__46)
(define-fun eq_56 () Bool (= mul_22 x_size0))
...
(assert eq_58)
(define-fun mul_50 () Int (* 384 x_size0))
(define-fun gt_7 () Bool (> mul_46 0))
(assert gt_7)
(define-fun mul_51 () Int (* mul_50 192))
(define-fun eq_59 () Bool (= mul_51 0))
(define-fun not__49 () Bool (not eq_59))
(assert not__49)
(define-fun eq_60 () Bool (= mul_50 1))
(define-fun not__50 () Bool (not eq_60))
(assert not__50)
(define-fun mul_52 () Int (* 192 mul_50))
(define-fun eq_61 () Bool (= mul_22 mul_22))
(assert eq_61)
(define-fun ge_10 () Bool (>= mul_50 0))
(assert ge_10)
(define-fun eq_62 () Bool (= mul_50 0))
(define-fun not__51 () Bool (not eq_62))
(assert not__51)
(define-fun mul_53 () Int (* 196 mul_50))
(define-fun sub_13 () Int (- mul_50 1))
(define-fun mul_54 () Int (* 196 sub_13))
(define-fun add_24 () Int (+ 1 mul_54))
(define-fun add_25 () Int (+ add_24 195))
(define-fun mul_55 () Int (* 4 add_25))
(define-fun mul_56 () Int (* mul_50 196))
(define-fun eq_63 () Bool (= mul_56 0))
(define-fun not__52 () Bool (not eq_63))
(assert not__52)
(define-fun lt_20 () Bool (< mul_50 0))
(define-fun not__53 () Bool (not lt_20))
(assert not__53)
(define-fun eq_64 () Bool (= mul_50 mul_50))
(assert eq_64)
(define-fun lt_21 () Bool (< mul_50 2))
(define-fun not__54 () Bool (not lt_21))
(assert not__54)
(define-fun mul_57 () Int (* mul_22 196))
(define-fun eq_65 () Bool (= mul_56 mul_57))
(assert eq_65)
(define-fun eq_66 () Bool (= mul_50 x_size0))
(define-fun not__55 () Bool (not eq_66))
(assert not__55)
(define-fun eq_67 () Bool (= x_size0 mul_50))
(define-fun not__56 () Bool (not eq_67))
(assert not__56)
(define-fun mod_4 () Int (mod mul_50 x_size0))
(define-fun eq_68 () Bool (= mod_4 0))
(assert eq_68)
(define-fun floordiv_5 () Int (div mul_50 x_size0))
(define-fun mul_58 () Int (* 196 floordiv_5))
(define-fun mul_59 () Int (* x_size0 floordiv_5))
(define-fun mul_60 () Int (* mul_59 196))
(define-fun eq_69 () Bool (= mul_60 0))
...
(assert eq_71)
(define-fun mul_61 () Int (* mul_58 x_size0))
(define-fun eq_72 () Bool (= floordiv_5 384))
(assert eq_72)
(define-fun mul_62 () Int (* mul_40 floordiv_5))
(define-fun eq_73 () Bool (= mul_62 0))
(define-fun not__59 () Bool (not eq_73))
(assert not__59)
(define-fun lt_22 () Bool (< 1 mul_58))
(assert lt_22)
(define-fun lt_23 () Bool (< floordiv_5 2))
(define-fun not__60 () Bool (not lt_23))
(assert not__60)
(define-fun lt_24 () Bool (< 196 mul_58))
(assert lt_24)
(define-fun eq_74 () Bool (= mul_16 0))
(define-fun not__61 () Bool (not eq_74))
(assert not__61)
(define-fun add_26 () Int (+ add_9 sub_12))
(define-fun add_27 () Int (+ add_26 mul_19))
(define-fun mul_63 () Int (* 4 add_27))
(define-fun eq_75 () Bool (= mul_30 -1))
(define-fun not__62 () Bool (not eq_75))
(assert not__62)
(define-fun ge_11 () Bool (>= mul_30 0))
(assert ge_11)
(define-fun eq_76 () Bool (= mul_31 mul_31))
(assert eq_76)
(define-fun eq_77 () Bool (= x_size0 mul_30))
(define-fun not__63 () Bool (not eq_77))
(assert not__63)
(define-fun eq_78 () Bool (= mul_30 x_size0))
(define-fun not__64 () Bool (not eq_78))
(assert not__64)
(define-fun mod_5 () Int (mod x_size0 mul_30))
(define-fun eq_79 () Bool (= mod_5 0))
(define-fun not__65 () Bool (not eq_79))
(assert not__65)
(define-fun mod_6 () Int (mod mul_30 mul_30))
(define-fun eq_80 () Bool (= mod_6 0))
(assert eq_80)
(define-fun lt_25 () Bool (< mul_32 384))
(define-fun not__66 () Bool (not lt_25))
(assert not__66)
(define-fun gt_8 () Bool (> mul_31 0))
(assert gt_8)
(define-fun mul_64 () Int (* mul_37 384))
(define-fun eq_81 () Bool (= mul_64 0))
(define-fun not__67 () Bool (not eq_81))
(assert not__67)
(define-fun eq_82 () Bool (= mul_37 1))
(define-fun not__68 () Bool (not eq_82))
(assert not__68)
(define-fun mul_65 () Int (* 384 mul_37))
(define-fun eq_83 () Bool (= mul_30 mul_30))
(assert eq_83)
(define-fun ge_12 () Bool (>= mul_37 0))
(assert ge_12)
(define-fun eq_84 () Bool (= mul_37 0))
(define-fun not__69 () Bool (not eq_84))
(assert not__69)
(define-fun mul_66 () Int (* 1536 mul_37))
(define-fun sub_14 () Int (- mul_37 1))
(define-fun mul_67 () Int (* 1536 sub_14))
(define-fun add_28 () Int (+ 1 mul_67))
(define-fun add_29 () Int (+ add_28 1535))
(define-fun mul_68 () Int (* 4 add_29))
(define-fun mul_69 () Int (* mul_37 1536))
(define-fun eq_85 () Bool (= mul_69 0))
(define-fun not__70 () Bool (not eq_85))
(assert not__70)
(define-fun lt_26 () Bool (< mul_37 0))
(define-fun not__71 () Bool (not lt_26))
(assert not__71)
(define-fun eq_86 () Bool (= mul_37 mul_37))
(assert eq_86)
(define-fun lt_27 () Bool (< mul_37 2))
(define-fun not__72 () Bool (not lt_27))
(assert not__72)
(define-fun mul_70 () Int (* mul_30 1536))
(define-fun eq_87 () Bool (= mul_69 mul_70))
(assert eq_87)
(define-fun eq_88 () Bool (= mul_37 x_size0))
(define-fun not__73 () Bool (not eq_88))
(assert not__73)
(define-fun eq_89 () Bool (= x_size0 mul_37))
(define-fun not__74 () Bool (not eq_89))
(assert not__74)
(define-fun mod_7 () Int (mod mul_37 x_size0))
(define-fun eq_90 () Bool (= mod_7 0))
(assert eq_90)
(define-fun floordiv_6 () Int (div mul_37 x_size0))
(define-fun mul_71 () Int (* 1536 floordiv_6))
(define-fun mul_72 () Int (* x_size0 floordiv_6))
(define-fun mul_73 () Int (* mul_72 1536))
(define-fun eq_91 () Bool (= mul_73 0))
(define-fun not__75 () Bool (not eq_91))
(assert not__75)
(define-fun eq_92 () Bool (= floordiv_6 1))
(define-fun not__76 () Bool (not eq_92))
(assert not__76)
(define-fun eq_93 () Bool (= mul_71 mul_71))
(assert eq_93)
(define-fun mul_74 () Int (* mul_71 x_size0))
(define-fun eq_94 () Bool (= mul_15 floordiv_6))
(assert eq_94)
(define-fun mul_75 () Int (* mul_72 768))
...
(assert not__78)
(define-fun lt_29 () Bool (< 1536 mul_71))
(assert lt_29)
(define-fun eq_96 () Bool (= floordiv_6 floordiv_6))
(assert eq_96)
(define-fun eq_97 () Bool (= mul_71 0))
(define-fun not__79 () Bool (not eq_97))
(assert not__79)
(define-fun gt_9 () Bool (> mul_71 1536))
(assert gt_9)
(define-fun ge_13 () Bool (>= floordiv_6 0))
(assert ge_13)
(define-fun eq_98 () Bool (= floordiv_6 0))
(define-fun not__80 () Bool (not eq_98))
(assert not__80)
(define-fun mul_76 () Int (* 768 floordiv_6))
(define-fun mul_77 () Int (* mul_76 x_size0))
(define-fun mul_78 () Int (* mul_76 sub))
(define-fun add_30 () Int (+ 1 mul_78))
(define-fun sub_15 () Int (- floordiv_6 1))
(define-fun mul_79 () Int (* 768 sub_15))
(define-fun add_31 () Int (+ add_30 mul_79))
(define-fun add_32 () Int (+ add_31 767))
(define-fun mul_80 () Int (* 4 add_32))
(define-fun eq_99 () Bool (= mul_76 mul_76))
(assert eq_99)
(define-fun eq_100 () Bool (= mul_76 0))
(define-fun not__81 () Bool (not eq_100))
(assert not__81)
(define-fun gt_10 () Bool (> mul_76 768))
(assert gt_10)
(define-fun lt_30 () Bool (< floordiv_6 0))
(define-fun not__82 () Bool (not lt_30))
(assert not__82)
(define-fun eq_101 () Bool (= mul_72 -1))
(define-fun not__83 () Bool (not eq_101))
(assert not__83)
(define-fun ge_14 () Bool (>= mul_72 0))
(assert ge_14)
(define-fun eq_102 () Bool (= mul_75 mul_75))
(assert eq_102)
(define-fun eq_103 () Bool (= x_size0 mul_72))
(define-fun not__84 () Bool (not eq_103))
(assert not__84)
(define-fun eq_104 () Bool (= mul_72 x_size0))
(define-fun not__85 () Bool (not eq_104))
(assert not__85)
(define-fun mod_8 () Int (mod x_size0 mul_72))
(define-fun eq_105 () Bool (= mod_8 0))
(define-fun not__86 () Bool (not eq_105))
(assert not__86)
(define-fun mod_9 () Int (mod mul_72 mul_72))
(define-fun eq_106 () Bool (= mod_9 0))
(assert eq_106)
(define-fun mul_81 () Int (* floordiv_6 x_size0))
(define-fun lt_31 () Bool (< mul_76 768))
(define-fun not__87 () Bool (not lt_31))
(assert not__87)
(define-fun gt_11 () Bool (> mul_75 0))
(assert gt_11)
(define-fun mul_82 () Int (* mul_81 768))
(define-fun eq_107 () Bool (= mul_82 0))
(define-fun not__88 () Bool (not eq_107))
(assert not__88)
(define-fun eq_108 () Bool (= mul_81 1))
(define-fun not__89 () Bool (not eq_108))
(assert not__89)
(define-fun mul_83 () Int (* 768 mul_81))
(define-fun eq_109 () Bool (= mul_72 mul_72))
(assert eq_109)
...
(assert not__90)
(define-fun mul_84 () Int (* 384 mul_81))
(define-fun sub_16 () Int (- mul_81 1))
(define-fun mul_85 () Int (* 384 sub_16))
(define-fun add_33 () Int (+ 1 mul_85))
(define-fun add_34 () Int (+ add_33 383))
(define-fun mul_86 () Int (* 4 add_34))
(define-fun mul_87 () Int (* mul_81 384))
(define-fun eq_111 () Bool (= mul_87 0))
(define-fun not__91 () Bool (not eq_111))
(assert not__91)
(define-fun lt_32 () Bool (< mul_81 0))
(define-fun not__92 () Bool (not lt_32))
(assert not__92)
(define-fun eq_112 () Bool (= mul_81 mul_81))
(assert eq_112)
(define-fun lt_33 () Bool (< mul_81 2))
(define-fun not__93 () Bool (not lt_33))
(assert not__93)
(define-fun eq_113 () Bool (= floordiv_6 -1))
(define-fun not__94 () Bool (not eq_113))
(assert not__94)
(define-fun mul_88 () Int (* mul_72 384))
(define-fun eq_114 () Bool (= mul_87 mul_88))
(assert eq_114)
(define-fun eq_115 () Bool (= mul_81 x_size0))
(define-fun not__95 () Bool (not eq_115))
(assert not__95)
(define-fun eq_116 () Bool (= x_size0 mul_81))
(define-fun not__96 () Bool (not eq_116))
(assert not__96)
(define-fun mod_10 () Int (mod mul_81 x_size0))
(define-fun eq_117 () Bool (= mod_10 0))
(assert eq_117)
(define-fun floordiv_7 () Int (div mul_81 x_size0))
(define-fun mul_89 () Int (* 384 floordiv_7))
(define-fun mul_90 () Int (* x_size0 floordiv_7))
(define-fun mul_91 () Int (* mul_90 384))
(define-fun eq_118 () Bool (= mul_91 0))
(define-fun not__97 () Bool (not eq_118))
(assert not__97)
(define-fun eq_119 () Bool (= floordiv_7 1))
(define-fun not__98 () Bool (not eq_119))
(assert not__98)
(define-fun eq_120 () Bool (= mul_89 mul_89))
(assert eq_120)
(define-fun mul_92 () Int (* mul_89 x_size0))
(define-fun eq_121 () Bool (= floordiv_6 floordiv_7))
(assert eq_121)
(define-fun eq_122 () Bool (= mul_15 floordiv_7))
(assert eq_122)
(define-fun eq_123 () Bool (= floordiv_7 mul_15))
(assert eq_123)
(define-fun mul_93 () Int (* 384 sub))
(define-fun add_35 () Int (+ 1 mul_93))
(define-fun add_36 () Int (+ add_35 383))
(define-fun mul_94 () Int (* 4 add_36))
(define-fun eq_124 () Bool (= mul_22 0))
(define-fun not__99 () Bool (not eq_124))
(assert not__99)
(define-fun sym_float () Real (to_real mul_15))
(define-fun mul_95 () Int (* 1000 x_size0))
(define-fun mul_96 () Int (* 1000 sub))
(define-fun add_37 () Int (+ 1 mul_96))
(define-fun add_38 () Int (+ add_37 999))
(define-fun mul_97 () Int (* 4 add_38))
(define-fun mul_98 () Int (* x_size0 1000))
(define-fun eq_125 () Bool (= mul_98 0))
(define-fun not__100 () Bool (not eq_125))
(assert not__100)
(define-fun eq_126 () Bool (= mul_12 0))
