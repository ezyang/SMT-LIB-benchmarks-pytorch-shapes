...
(define-fun eq_26 () Bool (= x_size1 128))
(assert eq_26)
...
(define-fun mul_17 () Int (* 256 add_11))
...
(set-info :example-self_conv_down_bn_running_mean_size0 256)
...
(set-info :example-self_conv_down_bn_running_var_size0 256)
...
(assert not__34)
(define-fun eq_44 () Bool (= self_conv_down_bn_running_mean_size0 256))
(assert eq_44)
(define-fun eq_45 () Bool (= self_conv_down_bn_running_var_size0 256))
(assert eq_45)
...
(set-info :example-self_conv_exp_bn_running_mean_size0 256)
...
(set-info :example-self_conv_exp_bn_running_var_size0 256)
...
(assert not__63)
(define-fun eq_71 () Bool (= self_conv_exp_bn_running_mean_size0 256))
(assert eq_71)
(define-fun eq_72 () Bool (= self_conv_exp_bn_running_var_size0 256))
(assert eq_72)
