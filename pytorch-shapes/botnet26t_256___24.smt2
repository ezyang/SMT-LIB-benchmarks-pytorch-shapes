...
(set-info :example-___stack0_stride1 31)
(declare-const ___stack0_stride2 Int)
(set-info :example-___stack0_stride2 527)
...
(set-info :example-rel_logits_w__base_size0 512)
(declare-const rel_logits_w__base_size1 Int)
(set-info :example-rel_logits_w__base_size1 527)
(declare-const rel_logits_w__base_stride0 Int)
(set-info :example-rel_logits_w__base_stride0 527)
...
(set-info :example-rel_logits_w_size1 16)
(declare-const rel_logits_w_size2 Int)
(set-info :example-rel_logits_w_size2 16)
(declare-const rel_logits_w_size3 Int)
(set-info :example-rel_logits_w_size3 16)
(declare-const rel_logits_w_size4 Int)
(set-info :example-rel_logits_w_size4 16)
(declare-const rel_logits_w_stride0 Int)
(set-info :example-rel_logits_w_stride0 8432)
(declare-const rel_logits_w_stride1 Int)
(set-info :example-rel_logits_w_stride1 527)
(declare-const rel_logits_w_stride2 Int)
(set-info :example-rel_logits_w_stride2 31)
...
(set-info :example-rel_logits_w_storage_offset 15)
...
(assert eq_77)
(define-fun eq_78 () Bool (= mul_9 2097152))
(assert eq_78)
(define-fun lt_39 () Bool (< 1 mul_22))
(assert lt_39)
(define-fun lt_40 () Bool (< 256 mul_22))
(define-fun not__68 () Bool (not lt_40))
(assert not__68)
(define-fun eq_79 () Bool (= 256 mul_22))
(assert eq_79)
...
(assert lt_41)
(define-fun lt_42 () Bool (< 256 ___stack0_size2))
(define-fun not__70 () Bool (not lt_42))
(assert not__70)
(define-fun eq_81 () Bool (= 256 ___stack0_size2))
...
(assert lt_46)
(define-fun eq_94 () Bool (= mul_39 256))
(assert eq_94)
(define-fun eq_95 () Bool (= ___stack0_size3 256))
(define-fun not__81 () Bool (not eq_95))
(assert not__81)
(define-fun mod_2 () Int (mod ___stack0_size3 256))
(define-fun eq_96 () Bool (= mod_2 0))
(define-fun not__82 () Bool (not eq_96))
(assert not__82)
(define-fun mul_46 () Int (* ___stack0_size3 ___stack0_size4))
(define-fun mod_3 () Int (mod mul_46 256))
...
(assert not__84)
(define-fun eq_99 () Bool (= mul_46 256))
(assert eq_99)
(define-fun lt_48 () Bool (< 1 mul_34))
(assert lt_48)
(define-fun lt_49 () Bool (< 256 mul_34))
(assert lt_49)
(define-fun lt_50 () Bool (< 65536 mul_34))
(assert lt_50)
(define-fun eq_100 () Bool (= 2097152 mul_34))
(assert eq_100)
