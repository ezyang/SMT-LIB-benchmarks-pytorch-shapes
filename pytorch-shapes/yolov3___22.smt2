...
(define-fun eq_104 () Bool (= x_size1 outputs_8__size1))
(assert eq_104)
(define-fun lt_28 () Bool (< x_size3 0))
(define-fun not__72 () Bool (not lt_28))
(assert not__72)
(define-fun lt_29 () Bool (< x_size2 0))
(define-fun not__73 () Bool (not lt_29))
(assert not__73)
(define-fun lt_30 () Bool (< x_size1 0))
(define-fun not__74 () Bool (not lt_30))
(assert not__74)
(define-fun lt_31 () Bool (< x_size0 0))
(define-fun not__75 () Bool (not lt_31))
(assert not__75)
(define-fun eq_105 () Bool (= x_size3 outputs_8__size3))
(assert eq_105)
(define-fun eq_106 () Bool (= x_size2 outputs_8__size2))
(assert eq_106)
(define-fun eq_107 () Bool (= x_size0 outputs_8__size0))
(assert eq_107)
(define-fun eq_108 () Bool (= outputs_8__size0 x_size0))
(assert eq_108)
(define-fun eq_109 () Bool (= outputs_8__size1 x_size1))
(assert eq_109)
(define-fun eq_110 () Bool (= outputs_8__size2 x_size2))
(assert eq_110)
(define-fun eq_111 () Bool (= outputs_8__size3 x_size3))
(assert eq_111)
(define-fun eq_112 () Bool (= mul_16 0))
(define-fun not__76 () Bool (not eq_112))
(assert not__76)
(define-fun eq_113 () Bool (= mul_67 0))
(define-fun not__77 () Bool (not eq_113))
(assert not__77)
(define-fun eq_114 () Bool (= mul_15 0))
(define-fun not__78 () Bool (not eq_114))
(assert not__78)
