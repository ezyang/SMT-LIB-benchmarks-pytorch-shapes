...
(assert eq_53)
(define-fun mul_34 () Int (* 32005 floordiv))
(define-fun mul_35 () Int (* 32005 sub_5))
(define-fun add_17 () Int (+ 1 mul_35))
(define-fun add_18 () Int (+ add_17 32004))
(define-fun mul_36 () Int (* 4 add_18))
(define-fun mul_37 () Int (* floordiv 32005))
(define-fun eq_54 () Bool (= mul_37 0))
(define-fun not__41 () Bool (not eq_54))
(assert not__41)
(define-fun mul_38 () Int (* mul_24 32005))
...
(define-fun mul_39 () Int (* 32005 floordiv_1))
(define-fun mul_40 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_41 () Int (* mul_40 32005))
...
(assert eq_61)
(define-fun eq_62 () Bool (= mul_41 32005))
(define-fun not__46 () Bool (not eq_62))
(assert not__46)
(define-fun mod_6 () Int (mod mul_41 32005))
(define-fun eq_63 () Bool (= mod_6 0))
(assert eq_63)
(define-fun floordiv_2 () Int (div mul_41 32005))
...
(assert not__50)
(define-fun mul_42 () Int (* floordiv_1 32005))
...
(assert not__58)
(define-fun mul_44 () Int (* 32005 sub_6))
(define-fun add_20 () Int (+ 1 mul_44))
(define-fun add_21 () Int (+ add_20 32004))
...
(define-fun output1_size2 () Int 32005)
(define-fun output1_stride0 () Int mul_39)
(define-fun output1_stride1 () Int 32005)
