...
(assert not__63)
(define-fun eq_71 () Bool (= self_conv2_kxk_bn_running_mean_size0 256))
(assert eq_71)
(define-fun eq_72 () Bool (= self_conv2_kxk_bn_running_var_size0 256))
(assert eq_72)
...
(define-fun mul_62 () Int (* 1024 add_41))
...
(define-fun mul_71 () Int (* x_size0 1024))
...
(assert not__89)
(define-fun eq_97 () Bool (= self_conv3_1x1_bn_running_mean_size0 1024))
(assert eq_97)
(define-fun eq_98 () Bool (= self_conv3_1x1_bn_running_var_size0 1024))
(assert eq_98)
...
(define-fun truediv_4 () Real (/ mul_73 1024))
...
(define-fun mul_85 () Int (* 1024 add_56))
...
(assert not__112)
(define-fun eq_122 () Bool (= self_shortcut_bn_running_mean_size0 1024))
(assert eq_122)
(define-fun eq_123 () Bool (= self_shortcut_bn_running_var_size0 1024))
(assert eq_123)
...
(define-fun truediv_6 () Real (/ mul_95 1024))
