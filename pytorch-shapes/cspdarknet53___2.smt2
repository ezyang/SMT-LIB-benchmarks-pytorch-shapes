...
(set-info :example-x_stride0 2097152)
...
(define-fun eq_26 () Bool (= x_size1 32))
(assert eq_26)
...
(assert gt_3)
(declare-const self_conv_down_bn_num_batches_tracked_storage_offset Int)
(set-info :example-self_conv_down_bn_num_batches_tracked_storage_offset 0)
(define-fun ge_7 () Bool (>= self_conv_down_bn_num_batches_tracked_storage_offset 0))
(assert ge_7)
(define-fun add_19 () Int (+ self_conv_down_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_29 () Int (* 8 add_19))
(declare-const self_conv_down_bn_running_mean_size0 Int)
(set-info :example-self_conv_down_bn_running_mean_size0 64)
(declare-const self_conv_down_bn_running_mean_stride0 Int)
(set-info :example-self_conv_down_bn_running_mean_stride0 1)
(declare-const self_conv_down_bn_running_mean_storage_offset Int)
(set-info :example-self_conv_down_bn_running_mean_storage_offset 0)
(define-fun ge_8 () Bool (>= self_conv_down_bn_running_mean_size0 0))
(assert ge_8)
(define-fun eq_37 () Bool (= self_conv_down_bn_running_mean_size0 0))
(define-fun not__30 () Bool (not eq_37))
(assert not__30)
(define-fun sub_12 () Int (- self_conv_down_bn_running_mean_size0 1))
(define-fun mul_30 () Int (* self_conv_down_bn_running_mean_stride0 sub_12))
(define-fun add_20 () Int (+ 1 mul_30))
(define-fun mul_31 () Int (* 4 add_20))
(define-fun eq_38 () Bool (= self_conv_down_bn_running_mean_size0 1))
(define-fun not__31 () Bool (not eq_38))
(assert not__31)
(define-fun eq_39 () Bool (= self_conv_down_bn_running_mean_stride0 1))
(assert eq_39)
(define-fun ge_9 () Bool (>= self_conv_down_bn_running_mean_storage_offset 0))
(assert ge_9)
(define-fun add_21 () Int (+ self_conv_down_bn_running_mean_storage_offset add_20))
(define-fun mul_32 () Int (* 4 add_21))
(declare-const self_conv_down_bn_running_var_size0 Int)
(set-info :example-self_conv_down_bn_running_var_size0 64)
(declare-const self_conv_down_bn_running_var_stride0 Int)
(set-info :example-self_conv_down_bn_running_var_stride0 1)
(declare-const self_conv_down_bn_running_var_storage_offset Int)
(set-info :example-self_conv_down_bn_running_var_storage_offset 0)
(define-fun ge_10 () Bool (>= self_conv_down_bn_running_var_size0 0))
(assert ge_10)
(define-fun eq_40 () Bool (= self_conv_down_bn_running_var_size0 0))
(define-fun not__32 () Bool (not eq_40))
(assert not__32)
(define-fun sub_13 () Int (- self_conv_down_bn_running_var_size0 1))
(define-fun mul_33 () Int (* self_conv_down_bn_running_var_stride0 sub_13))
(define-fun add_22 () Int (+ 1 mul_33))
(define-fun mul_34 () Int (* 4 add_22))
(define-fun eq_41 () Bool (= self_conv_down_bn_running_var_size0 1))
(define-fun not__33 () Bool (not eq_41))
(assert not__33)
(define-fun eq_42 () Bool (= self_conv_down_bn_running_var_stride0 1))
(assert eq_42)
(define-fun ge_11 () Bool (>= self_conv_down_bn_running_var_storage_offset 0))
(assert ge_11)
(define-fun add_23 () Int (+ self_conv_down_bn_running_var_storage_offset add_22))
(define-fun mul_35 () Int (* 4 add_23))
(define-fun mul_36 () Int (* x_size0 add_13))
(define-fun mul_37 () Int (* mul_36 add_14))
(define-fun eq_43 () Bool (= mul_37 1))
(define-fun not__34 () Bool (not eq_43))
(assert not__34)
(define-fun eq_44 () Bool (= self_conv_down_bn_running_mean_size0 64))
(assert eq_44)
(define-fun eq_45 () Bool (= self_conv_down_bn_running_var_size0 64))
(assert eq_45)
...
(assert not__38)
(define-fun eq_48 () Bool (= add_13 -1))
(define-fun not__39 () Bool (not eq_48))
(assert not__39)
(define-fun eq_49 () Bool (= add_14 -1))
...
(assert lt_19)
(define-fun lt_20 () Bool (< self_conv_down_bn_running_mean_size0 0))
(define-fun not__45 () Bool (not lt_20))
(assert not__45)
(define-fun eq_51 () Bool (= self_conv_down_bn_running_mean_size0 self_conv_down_bn_running_mean_size0))
(assert eq_51)
(define-fun add_24 () Int (+ 1 sub_12))
...
(define-fun lt_21 () Bool (< self_conv_down_bn_running_var_size0 0))
(define-fun not__46 () Bool (not lt_21))
(assert not__46)
(define-fun eq_52 () Bool (= self_conv_down_bn_running_var_size0 self_conv_down_bn_running_var_size0))
(assert eq_52)
(define-fun add_25 () Int (+ 1 sub_13))
(define-fun mul_39 () Int (* 4 add_25))
(define-fun eq_53 () Bool (= mul_28 mul_28))
(assert eq_53)
(define-fun lt_22 () Bool (< add_13 1))
(define-fun not__47 () Bool (not lt_22))
(assert not__47)
(define-fun lt_23 () Bool (< add_14 1))
...
(define-fun eq_56 () Bool (= mul_51 0))
...
(assert gt_8)
(declare-const self_conv_exp_bn_num_batches_tracked_storage_offset Int)
(set-info :example-self_conv_exp_bn_num_batches_tracked_storage_offset 0)
(define-fun ge_14 () Bool (>= self_conv_exp_bn_num_batches_tracked_storage_offset 0))
(assert ge_14)
(define-fun add_34 () Int (+ self_conv_exp_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_52 () Int (* 8 add_34))
(declare-const self_conv_exp_bn_running_mean_size0 Int)
(set-info :example-self_conv_exp_bn_running_mean_size0 128)
(declare-const self_conv_exp_bn_running_mean_stride0 Int)
(set-info :example-self_conv_exp_bn_running_mean_stride0 1)
(declare-const self_conv_exp_bn_running_mean_storage_offset Int)
(set-info :example-self_conv_exp_bn_running_mean_storage_offset 0)
(define-fun ge_15 () Bool (>= self_conv_exp_bn_running_mean_size0 0))
(assert ge_15)
(define-fun eq_64 () Bool (= self_conv_exp_bn_running_mean_size0 0))
(define-fun not__59 () Bool (not eq_64))
(assert not__59)
(define-fun sub_21 () Int (- self_conv_exp_bn_running_mean_size0 1))
(define-fun mul_53 () Int (* self_conv_exp_bn_running_mean_stride0 sub_21))
(define-fun add_35 () Int (+ 1 mul_53))
(define-fun mul_54 () Int (* 4 add_35))
(define-fun eq_65 () Bool (= self_conv_exp_bn_running_mean_size0 1))
(define-fun not__60 () Bool (not eq_65))
(assert not__60)
(define-fun eq_66 () Bool (= self_conv_exp_bn_running_mean_stride0 1))
(assert eq_66)
(define-fun ge_16 () Bool (>= self_conv_exp_bn_running_mean_storage_offset 0))
(assert ge_16)
(define-fun add_36 () Int (+ self_conv_exp_bn_running_mean_storage_offset add_35))
(define-fun mul_55 () Int (* 4 add_36))
(declare-const self_conv_exp_bn_running_var_size0 Int)
(set-info :example-self_conv_exp_bn_running_var_size0 128)
(declare-const self_conv_exp_bn_running_var_stride0 Int)
(set-info :example-self_conv_exp_bn_running_var_stride0 1)
(declare-const self_conv_exp_bn_running_var_storage_offset Int)
(set-info :example-self_conv_exp_bn_running_var_storage_offset 0)
(define-fun ge_17 () Bool (>= self_conv_exp_bn_running_var_size0 0))
(assert ge_17)
(define-fun eq_67 () Bool (= self_conv_exp_bn_running_var_size0 0))
(define-fun not__61 () Bool (not eq_67))
(assert not__61)
(define-fun sub_22 () Int (- self_conv_exp_bn_running_var_size0 1))
(define-fun mul_56 () Int (* self_conv_exp_bn_running_var_stride0 sub_22))
(define-fun add_37 () Int (+ 1 mul_56))
(define-fun mul_57 () Int (* 4 add_37))
(define-fun eq_68 () Bool (= self_conv_exp_bn_running_var_size0 1))
(define-fun not__62 () Bool (not eq_68))
(assert not__62)
(define-fun eq_69 () Bool (= self_conv_exp_bn_running_var_stride0 1))
(assert eq_69)
(define-fun ge_18 () Bool (>= self_conv_exp_bn_running_var_storage_offset 0))
(assert ge_18)
(define-fun add_38 () Int (+ self_conv_exp_bn_running_var_storage_offset add_37))
(define-fun mul_58 () Int (* 4 add_38))
(define-fun mul_59 () Int (* x_size0 add_28))
(define-fun mul_60 () Int (* mul_59 add_29))
(define-fun eq_70 () Bool (= mul_60 1))
(define-fun not__63 () Bool (not eq_70))
(assert not__63)
(define-fun eq_71 () Bool (= self_conv_exp_bn_running_mean_size0 128))
(assert eq_71)
(define-fun eq_72 () Bool (= self_conv_exp_bn_running_var_size0 128))
(assert eq_72)
(define-fun lt_26 () Bool (< mul_51 2147483647))
(assert lt_26)
(define-fun sym_float_1 () Real (to_real mul_60))
...
(assert lt_32)
(define-fun lt_33 () Bool (< self_conv_exp_bn_running_mean_size0 0))
(define-fun not__71 () Bool (not lt_33))
(assert not__71)
(define-fun eq_77 () Bool (= self_conv_exp_bn_running_mean_size0 self_conv_exp_bn_running_mean_size0))
(assert eq_77)
(define-fun add_39 () Int (+ 1 sub_21))
(define-fun mul_61 () Int (* 4 add_39))
(define-fun truediv_2 () Real (/ mul_51 128))
(define-fun sub_23 () Real (- truediv_2 1))
(define-fun truediv_3 () Real (/ truediv_2 sub_23))
(define-fun lt_34 () Bool (< self_conv_exp_bn_running_var_size0 0))
(define-fun not__72 () Bool (not lt_34))
(assert not__72)
(define-fun eq_78 () Bool (= self_conv_exp_bn_running_var_size0 self_conv_exp_bn_running_var_size0))
(assert eq_78)
(define-fun add_40 () Int (+ 1 sub_22))
(define-fun mul_62 () Int (* 4 add_40))
(define-fun eq_79 () Bool (= mul_51 mul_51))
(assert eq_79)
(define-fun eq_80 () Bool (= mul_16 0))
(define-fun not__73 () Bool (not eq_80))
(assert not__73)
(define-fun eq_81 () Bool (= mul_29 0))
(define-fun not__74 () Bool (not eq_81))
(assert not__74)
(define-fun eq_82 () Bool (= mul_32 0))
(define-fun not__75 () Bool (not eq_82))
(assert not__75)
(define-fun eq_83 () Bool (= mul_35 0))
...
(assert not__78)
(define-fun eq_86 () Bool (= mul_58 0))
...
(check-sat)
(get-value (x_size0 x_size1 x_size2 x_size3 x_stride0 x_stride1 x_stride2 x_stride3 x_storage_offset self_conv_down_bn_num_batches_tracked_storage_offset self_conv_down_bn_running_mean_size0 self_conv_down_bn_running_mean_stride0 self_conv_down_bn_running_mean_storage_offset self_conv_down_bn_running_var_size0 self_conv_down_bn_running_var_stride0 self_conv_down_bn_running_var_storage_offset self_conv_exp_bn_num_batches_tracked_storage_offset self_conv_exp_bn_running_mean_size0 self_conv_exp_bn_running_mean_stride0 self_conv_exp_bn_running_mean_storage_offset self_conv_exp_bn_running_var_size0 self_conv_exp_bn_running_var_stride0 self_conv_exp_bn_running_var_storage_offset output0_size0 output0_stride0 output0_storage_offset output1_size0 output1_stride0 output1_storage_offset output2_size0 output2_stride0 output2_storage_offset output3_size0 output3_stride0 output3_storage_offset output4_size0 output4_size1 output4_size2 output4_size3 output4_stride0 output4_stride1 output4_stride2 output4_stride3 output4_storage_offset output5_storage_offset output6_storage_offset))
