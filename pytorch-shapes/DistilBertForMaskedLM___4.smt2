...
(set-info :example-___stack0_last_hidden_state_stride0 98304)
...
(assert eq_61)
(define-fun eq_62 () Bool (= mul_41 30522))
(define-fun not__46 () Bool (not eq_62))
(assert not__46)
(define-fun mod_6 () Int (mod mul_41 30522))
(define-fun eq_63 () Bool (= mod_6 0))
(assert eq_63)
(define-fun floordiv_2 () Int (div mul_41 30522))
...
(assert not__50)
(define-fun mul_42 () Int (* floordiv_1 30522))
...
(assert not__58)
(define-fun mul_44 () Int (* 30522 sub_6))
