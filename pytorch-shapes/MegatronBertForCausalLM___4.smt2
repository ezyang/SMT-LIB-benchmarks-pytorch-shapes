...
(set-info :example-___stack0_last_hidden_state_stride0 524288)
...
(assert eq_29)
(define-fun eq_30 () Bool (= ___stack0_last_hidden_state_size2 1024))
(assert eq_30)
(define-fun mul_18 () Int (* 1024 ___stack0_last_hidden_state_size1))
(define-fun mul_19 () Int (* 1024 sub_1))
(define-fun add_10 () Int (+ 1 mul_19))
(define-fun add_11 () Int (+ add_10 1023))
(define-fun mul_20 () Int (* 4 add_11))
(define-fun mul_21 () Int (* ___stack0_last_hidden_state_size1 1024))
...
(assert not__23)
(define-fun mul_22 () Int (* mul_4 1024))
...
(define-fun mul_23 () Int (* 1024 floordiv))
(define-fun mul_24 () Int (* ___stack0_last_hidden_state_size0 floordiv))
(define-fun mul_25 () Int (* mul_24 1024))
...
(assert not__30)
(define-fun gt () Bool (> mul_23 1024))
(assert gt)
...
(define-fun mul_28 () Int (* 1024 sub_5))
(define-fun add_13 () Int (+ add_12 mul_28))
(define-fun add_14 () Int (+ add_13 1023))
...
(define-fun eq_44 () Bool (= mul_24 0))
...
(define-fun mul_39 () Int (* 29056 floordiv_1))
(define-fun mul_40 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_41 () Int (* mul_40 29056))
...
(assert eq_61)
(define-fun eq_62 () Bool (= ___stack0_last_hidden_state_size0 9223372036854775807))
(define-fun not__46 () Bool (not eq_62))
(assert not__46)
(define-fun le () Bool (<= ___stack0_last_hidden_state_size0 0))
(define-fun not__47 () Bool (not le))
(assert not__47)
(define-fun le_1 () Bool (<= ___stack0_last_hidden_state_size0 9223372036854775807))
(assert le_1)
(define-fun mul_42 () Int (* 0 mul_39))
(define-fun sub_6 () Int (- ___stack0_last_hidden_state_size0 0))
(define-fun add_19 () Int (+ sub_6 1))
(define-fun sub_7 () Int (- add_19 1))
(define-fun floordiv_2 () Int (div sub_7 1))
(define-fun mul_43 () Int (* floordiv_2 floordiv_1))
(define-fun mul_44 () Int (* mul_43 29056))
(define-fun eq_63 () Bool (= mul_44 0))
(define-fun not__48 () Bool (not eq_63))
(assert not__48)
(define-fun eq_64 () Bool (= floordiv_2 1))
(assert eq_64)
(define-fun eq_65 () Bool (= floordiv_1 -1))
(define-fun not__49 () Bool (not eq_65))
(assert not__49)
(define-fun add_20 () Int (+ -1 floordiv_1))
(define-fun le_2 () Bool (<= floordiv_1 0))
(define-fun not__50 () Bool (not le_2))
(assert not__50)
(define-fun lt_9 () Bool (< add_20 0))
(define-fun not__51 () Bool (not lt_9))
(assert not__51)
(define-fun ge_10 () Bool (>= add_20 floordiv_1))
(define-fun not__52 () Bool (not ge_10))
(assert not__52)
(define-fun sub_8 () Int (- add_20 0))
(define-fun add_21 () Int (+ sub_8 1))
(define-fun sub_9 () Int (- add_21 1))
(define-fun floordiv_3 () Int (div sub_9 1))
(define-fun mul_45 () Int (* floordiv_2 floordiv_3))
(define-fun mul_46 () Int (* mul_45 29056))
(define-fun eq_66 () Bool (= mul_46 0))
(define-fun not__53 () Bool (not eq_66))
(assert not__53)
(define-fun eq_67 () Bool (= floordiv_3 1))
(define-fun not__54 () Bool (not eq_67))
(assert not__54)
(define-fun mul_47 () Int (* 29056 floordiv_3))
(define-fun eq_68 () Bool (= labels_size0 9223372036854775807))
(define-fun not__55 () Bool (not eq_68))
(assert not__55)
(define-fun le_3 () Bool (<= labels_size0 0))
(define-fun not__56 () Bool (not le_3))
(assert not__56)
(define-fun le_4 () Bool (<= labels_size0 9223372036854775807))
(assert le_4)
(define-fun mul_48 () Int (* 0 labels_stride0))
(define-fun add_22 () Int (+ labels_storage_offset mul_48))
(define-fun sub_10 () Int (- labels_size0 0))
(define-fun add_23 () Int (+ sub_10 1))
(define-fun sub_11 () Int (- add_23 1))
(define-fun floordiv_4 () Int (div sub_11 1))
(define-fun mul_49 () Int (* floordiv_4 labels_size1))
(define-fun eq_69 () Bool (= mul_49 0))
(define-fun not__57 () Bool (not eq_69))
(assert not__57)
(define-fun eq_70 () Bool (= floordiv_4 1))
(assert eq_70)
(define-fun le_5 () Bool (<= labels_size1 1))
(define-fun not__58 () Bool (not le_5))
(assert not__58)
(define-fun le_6 () Bool (<= labels_size1 9223372036854775807))
(assert le_6)
(define-fun add_24 () Int (+ add_22 labels_stride1))
(define-fun add_25 () Int (+ sub_4 1))
(define-fun sub_12 () Int (- add_25 1))
(define-fun floordiv_5 () Int (div sub_12 1))
(define-fun mul_50 () Int (* floordiv_4 floordiv_5))
(define-fun eq_71 () Bool (= mul_50 0))
(define-fun not__59 () Bool (not eq_71))
(assert not__59)
(define-fun eq_72 () Bool (= floordiv_5 1))
(define-fun not__60 () Bool (not eq_72))
(assert not__60)
(define-fun eq_73 () Bool (= mul_46 29056))
(define-fun not__61 () Bool (not eq_73))
(assert not__61)
(define-fun mod_6 () Int (mod mul_46 29056))
(define-fun eq_74 () Bool (= mod_6 0))
(assert eq_74)
(define-fun floordiv_6 () Int (div mul_46 29056))
(define-fun eq_75 () Bool (= floordiv_2 floordiv_6))
(define-fun not__62 () Bool (not eq_75))
(assert not__62)
(define-fun eq_76 () Bool (= floordiv_6 floordiv_2))
(define-fun not__63 () Bool (not eq_76))
(assert not__63)
(define-fun mod_7 () Int (mod floordiv_2 floordiv_6))
(define-fun eq_77 () Bool (= mod_7 0))
(define-fun not__64 () Bool (not eq_77))
(assert not__64)
(define-fun mod_8 () Int (mod mul_45 floordiv_6))
(define-fun eq_78 () Bool (= mod_8 0))
(assert eq_78)
(define-fun eq_79 () Bool (= floordiv_2 0))
(define-fun not__65 () Bool (not eq_79))
(assert not__65)
(define-fun eq_80 () Bool (= floordiv_3 0))
(define-fun not__66 () Bool (not eq_80))
(assert not__66)
(define-fun mul_51 () Int (* floordiv_3 29056))
(define-fun eq_81 () Bool (= mul_51 0))
(define-fun not__67 () Bool (not eq_81))
(assert not__67)
(define-fun eq_82 () Bool (= mul_45 floordiv_6))
(assert eq_82)
(define-fun eq_83 () Bool (= mul_50 1))
(define-fun not__68 () Bool (not eq_83))
(assert not__68)
(define-fun mod_9 () Int (mod mul_50 1))
(define-fun eq_84 () Bool (= mod_9 0))
(assert eq_84)
(define-fun floordiv_7 () Int (div mul_50 1))
(define-fun eq_85 () Bool (= floordiv_4 floordiv_7))
(define-fun not__69 () Bool (not eq_85))
(assert not__69)
(define-fun eq_86 () Bool (= floordiv_7 floordiv_4))
(define-fun not__70 () Bool (not eq_86))
(assert not__70)
(define-fun mod_10 () Int (mod floordiv_4 floordiv_7))
(define-fun eq_87 () Bool (= mod_10 0))
(define-fun not__71 () Bool (not eq_87))
(assert not__71)
(define-fun mod_11 () Int (mod mul_50 floordiv_7))
(define-fun eq_88 () Bool (= mod_11 0))
(assert eq_88)
(define-fun eq_89 () Bool (= floordiv_4 0))
(define-fun not__72 () Bool (not eq_89))
(assert not__72)
(define-fun eq_90 () Bool (= floordiv_5 0))
(define-fun not__73 () Bool (not eq_90))
(assert not__73)
(define-fun eq_91 () Bool (= mul_50 floordiv_7))
(assert eq_91)
(define-fun ge_11 () Bool (>= floordiv_3 0))
(assert ge_11)
(define-fun sub_13 () Int (- floordiv_3 1))
(define-fun add_26 () Int (+ 1 sub_13))
(define-fun mul_52 () Int (* 4 add_26))
(define-fun eq_92 () Bool (= floordiv_3 floordiv_3))
(assert eq_92)
(define-fun lt_10 () Bool (< floordiv_3 0))
(define-fun not__74 () Bool (not lt_10))
(assert not__74)
(define-fun eq_93 () Bool (= floordiv_3 -1))
(define-fun not__75 () Bool (not eq_93))
(assert not__75)
(define-fun lt_11 () Bool (< floordiv_3 2))
(define-fun not__76 () Bool (not lt_11))
(assert not__76)
(define-fun mul_53 () Int (* 29056 sub_13))
(define-fun add_27 () Int (+ 1 mul_53))
(define-fun add_28 () Int (+ add_27 29055))
(define-fun mul_54 () Int (* 4 add_28))
(define-fun lt_12 () Bool (< floordiv_3 1))
(define-fun not__77 () Bool (not lt_12))
(assert not__77)
(define-fun eq_94 () Bool (= mul_51 mul_51))
(assert eq_94)
(define-fun eq_95 () Bool (= floordiv_3 floordiv_5))
(assert eq_95)
(define-fun eq_96 () Bool (= floordiv_5 floordiv_5))
(assert eq_96)
(define-fun le_7 () Bool (<= floordiv_5 floordiv_3))
(assert le_7)
(define-fun ge_12 () Bool (>= floordiv_5 0))
(assert ge_12)
(define-fun sub_14 () Int (- floordiv_5 1))
(define-fun add_29 () Int (+ 1 sub_14))
(define-fun mul_55 () Int (* 4 add_29))
(define-fun mul_56 () Real (* 1.0 floordiv_5))
(define-fun sym_float () Real (to_real floordiv_5))
(define-fun eq_97 () Bool (= mul_11 0))
(define-fun not__78 () Bool (not eq_97))
(assert not__78)
(define-fun eq_98 () Bool (= mul_16 0))
(define-fun not__79 () Bool (not eq_98))
(assert not__79)
(define-fun eq_99 () Bool (= mul_36 0))
(define-fun not__80 () Bool (not eq_99))
(assert not__80)
(define-fun output0_storage_offset () Int 0)
(define-fun output1_size0 () Int ___stack0_last_hidden_state_size0)
(define-fun output1_size1 () Int floordiv_1)
(define-fun output1_size2 () Int 29056)
(define-fun output1_stride0 () Int mul_39)
(define-fun output1_stride1 () Int 29056)
