...
(set-info :example-___stack0_stride1 2079)
(declare-const ___stack0_stride2 Int)
(set-info :example-___stack0_stride2 63)
...
(assert eq_78)
(define-fun eq_79 () Bool (= q_size3 32))
(assert eq_79)
...
(assert not__78)
(define-fun mul_45 () Int (* 63 mul_42))
(define-fun sub_9 () Int (- mul_42 1))
(define-fun mul_46 () Int (* 63 sub_9))
(define-fun add_11 () Int (+ 1 mul_46))
(define-fun add_12 () Int (+ add_11 62))
(define-fun mul_47 () Int (* 4 add_12))
(define-fun mul_48 () Int (* mul_42 63))
...
(assert not__82)
(define-fun mul_49 () Int (* mul_29 63))
...
(define-fun mul_50 () Int (* 63 floordiv))
...
(define-fun mul_54 () Int (* 63 floordiv_1))
(define-fun mul_55 () Int (* mul_28 floordiv_1))
(define-fun mul_56 () Int (* mul_55 63))
...
(define-fun mul_67 () Int (* mul_66 63))
...
(assert eq_115)
(define-fun eq_116 () Bool (= sub_10 63))
(assert eq_116)
...
(assert not__104)
(define-fun mul_69 () Int (* 64 floordiv_1))
...
(assert not__107)
(define-fun gt_7 () Bool (> mul_69 64))
(assert gt_7)
...
(assert not__109)
(define-fun lt_46 () Bool (< 64 mul_69))
(assert lt_46)
(define-fun eq_124 () Bool (= mul_67 mul_67))
(assert eq_124)
(define-fun mul_75 () Int (* floordiv_1 64))
