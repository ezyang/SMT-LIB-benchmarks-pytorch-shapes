...
(set-info :example-x__base_size1 1024)
(declare-const x__base_size2 Int)
(set-info :example-x__base_size2 8)
(declare-const x__base_size3 Int)
(set-info :example-x__base_size3 8)
(declare-const x__base_stride0 Int)
(set-info :example-x__base_stride0 65536)
(declare-const x__base_stride1 Int)
(set-info :example-x__base_stride1 64)
(declare-const x__base_stride2 Int)
(set-info :example-x__base_stride2 8)
...
(set-info :example-x_storage_offset 32768)
...
(set-info :example-self_conv1_bn_running_mean_size0 512)
...
(set-info :example-self_conv1_bn_running_var_size0 512)
...
(assert not__50)
(define-fun eq_58 () Bool (= self_conv1_bn_running_mean_size0 512))
(assert eq_58)
(define-fun eq_59 () Bool (= self_conv1_bn_running_var_size0 512))
(assert eq_59)
...
(define-fun mul_46 () Int (* 512 add_26))
...
(set-info :example-self_conv2_bn_running_mean_size0 512)
...
(set-info :example-self_conv2_bn_running_var_size0 512)
...
(assert not__78)
(define-fun eq_86 () Bool (= self_conv2_bn_running_mean_size0 512))
(assert eq_86)
(define-fun eq_87 () Bool (= self_conv2_bn_running_var_size0 512))
(assert eq_87)
...
(define-fun truediv_2 () Real (/ mul_56 512))
