...
(set-info :example-trg_seq_size0 4)
(declare-const trg_seq_size1 Int)
(set-info :example-trg_seq_size1 26)
(declare-const trg_seq_stride0 Int)
(set-info :example-trg_seq_stride0 1)
(declare-const trg_seq_stride1 Int)
(set-info :example-trg_seq_stride1 4)
(declare-const trg_seq_storage_offset Int)
(set-info :example-trg_seq_storage_offset 0)
