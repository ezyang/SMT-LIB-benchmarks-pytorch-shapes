...
(assert ge_4)
(define-fun mul_13 () Int (* q_size0 8))
(define-fun mul_14 () Int (* mul_13 8))
...
(assert lt_8)
(define-fun lt_9 () Bool (< 8 q_size1))
(assert lt_9)
(define-fun mul_17 () Int (* 8 q_stride1))
(define-fun lt_10 () Bool (< 64 q_size1))
(define-fun not__25 () Bool (not lt_10))
(assert not__25)
(define-fun eq_32 () Bool (= 64 q_size1))
(assert eq_32)
...
(assert eq_35)
(define-fun eq_36 () Bool (= q_size1 8))
(define-fun not__27 () Bool (not eq_36))
(assert not__27)
(define-fun mod_1 () Int (mod q_size1 8))
(define-fun eq_37 () Bool (= mod_1 0))
(assert eq_37)
(define-fun floordiv_1 () Int (div q_size1 8))
...
(assert eq_40)
(define-fun mul_22 () Int (* floordiv_1 8))
...
(assert not__33)
(define-fun mul_25 () Int (* mul_19 8))
...
(assert lt_18)
(define-fun eq_46 () Bool (= floordiv_1 8))
(assert eq_46)
...
(assert eq_68)
(define-fun eq_69 () Bool (= q_size2 16))
(assert eq_69)
...
(assert not__58)
(define-fun mul_43 () Int (* mul_20 15))
...
(define-fun mul_44 () Int (* 15 floordiv_2))
(define-fun mul_45 () Int (* q_size0 floordiv_2))
(define-fun mul_46 () Int (* mul_45 15))
...
(define-fun eq_80 () Bool (= floordiv_2 8))
(define-fun not__63 () Bool (not eq_80))
(assert not__63)
(define-fun mod_6 () Int (mod floordiv_2 8))
(define-fun eq_81 () Bool (= mod_6 0))
(assert eq_81)
(define-fun floordiv_3 () Int (div floordiv_2 8))
(define-fun mul_48 () Int (* 15 floordiv_3))
(define-fun mul_49 () Int (* mul_13 floordiv_3))
(define-fun mul_50 () Int (* mul_49 15))
...
(assert eq_84)
(define-fun mul_51 () Int (* mul_48 8))
...
(assert eq_99)
(define-fun mul_59 () Int (* 8 q_size0))
...
(define-fun mul_61 () Int (* mul_60 15))
...
(assert eq_102)
(define-fun eq_103 () Bool (= sub_7 15))
(assert eq_103)
...
(assert not__79)
(define-fun mul_63 () Int (* 16 floordiv_3))
...
(assert not__82)
(define-fun gt_5 () Bool (> mul_63 16))
(assert gt_5)
...
(assert not__84)
(define-fun lt_33 () Bool (< 16 mul_63))
(assert lt_33)
(define-fun eq_111 () Bool (= mul_61 mul_61))
(assert eq_111)
(define-fun mul_69 () Int (* floordiv_3 16))
