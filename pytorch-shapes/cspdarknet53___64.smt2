...
(define-fun mul_26 () Int (* x_size0 1024))
...
(set-info :example-self_conv_down_bn_running_mean_size0 1024)
...
(set-info :example-self_conv_down_bn_running_var_size0 1024)
...
(assert not__34)
(define-fun eq_44 () Bool (= self_conv_down_bn_running_mean_size0 1024))
(assert eq_44)
(define-fun eq_45 () Bool (= self_conv_down_bn_running_var_size0 1024))
(assert eq_45)
...
(define-fun mul_40 () Int (* 1024 add_26))
...
(set-info :example-self_conv_exp_bn_running_mean_size0 1024)
...
(set-info :example-self_conv_exp_bn_running_var_size0 1024)
...
(assert not__63)
(define-fun eq_71 () Bool (= self_conv_exp_bn_running_mean_size0 1024))
(assert eq_71)
(define-fun eq_72 () Bool (= self_conv_exp_bn_running_var_size0 1024))
(assert eq_72)
...
(define-fun truediv_2 () Real (/ mul_50 1024))
