...
(set-info :example-query_stride1 768)
...
(set-info :example-key__base_size1 768)
(declare-const key__base_stride0 Int)
(set-info :example-key__base_stride0 768)
(declare-const key__base_stride1 Int)
(set-info :example-key__base_stride1 1)
...
(set-info :example-key_stride1 768)
...
(assert not__34)
(check-sat)
(get-value (query__base_size0 query__base_size1 query__base_size2 query__base_stride0 query__base_stride1 query__base_stride2 query__base_storage_offset query_size0 query_size1 query_size2 query_size3 query_stride0 query_stride1 query_stride2 query_stride3 query_storage_offset key__base_size0 key__base_size1 key__base_stride0 key__base_stride1 key__base_storage_offset key_size0 key_size1 key_size2 key_size3 key_stride0 key_stride1 key_stride2 key_stride3 key_storage_offset))
