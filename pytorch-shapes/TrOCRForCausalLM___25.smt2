...
(set-info :example-___stack0_0___base_size0 256)
...
(set-info :example-___stack0_2__0__size2 256)
...
(set-info :example-___stack0_2__0__stride0 262144)
(declare-const ___stack0_2__0__stride1 Int)
(set-info :example-___stack0_2__0__stride1 16384)
...
(set-info :example-___stack0_2__1__size2 256)
...
(set-info :example-___stack0_2__1__stride0 262144)
(declare-const ___stack0_2__1__stride1 Int)
(set-info :example-___stack0_2__1__stride1 16384)
...
(assert eq_85)
(define-fun eq_86 () Bool (= residual_size2 1024))
(assert eq_86)
...
(assert eq_100)
(define-fun mul_61 () Int (* 4096 residual_size1))
(define-fun mul_62 () Int (* 4096 sub_11))
(define-fun add_32 () Int (+ 1 mul_62))
(define-fun add_33 () Int (+ add_32 4095))
(define-fun mul_63 () Int (* 4 add_33))
(define-fun mul_64 () Int (* residual_size1 4096))
(define-fun eq_101 () Bool (= mul_64 0))
(define-fun not__71 () Bool (not eq_101))
(assert not__71)
(define-fun mul_65 () Int (* mul_49 4096))
...
(define-fun mul_66 () Int (* 4096 floordiv))
(define-fun mul_67 () Int (* residual_size0 floordiv))
(define-fun mul_68 () Int (* mul_67 4096))
...
(assert not__77)
(define-fun gt_4 () Bool (> mul_66 4096))
(assert gt_4)
...
(define-fun mul_71 () Int (* 4096 sub_13))
...
(assert eq_117)
(define-fun mul_73 () Int (* floordiv 4096))
(define-fun eq_118 () Bool (= mul_73 0))
(define-fun not__83 () Bool (not eq_118))
(assert not__83)
(define-fun eq_119 () Bool (= mul_67 mul_67))
(assert eq_119)
(define-fun mul_74 () Int (* 1024 floordiv))
(define-fun mul_75 () Int (* 1024 sub_13))
(define-fun add_37 () Int (+ 1 mul_75))
(define-fun add_38 () Int (+ add_37 1023))
(define-fun mul_76 () Int (* 4 add_38))
(define-fun mul_77 () Int (* floordiv 1024))
...
(assert not__86)
(define-fun mul_78 () Int (* mul_67 1024))
...
(define-fun mul_79 () Int (* 1024 floordiv_1))
(define-fun mul_80 () Int (* residual_size0 floordiv_1))
(define-fun mul_81 () Int (* mul_80 1024))
