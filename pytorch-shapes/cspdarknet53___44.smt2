...
(set-info :example-x_storage_offset 65536)
...
(define-fun mul_23 () Int (* 256 add_9))
...
(define-fun mul_26 () Int (* mul_25 256))
...
(define-fun mul_29 () Int (* mul_25 255))
...
(define-fun mul_32 () Int (* x_size0 256))
...
(set-info :example-self_conv1_bn_running_mean_size0 256)
...
(set-info :example-self_conv1_bn_running_var_size0 256)
...
(assert not__50)
(define-fun eq_58 () Bool (= self_conv1_bn_running_mean_size0 256))
(assert eq_58)
(define-fun eq_59 () Bool (= self_conv1_bn_running_var_size0 256))
(assert eq_59)
...
(define-fun truediv () Real (/ mul_34 256))
...
(define-fun mul_46 () Int (* 256 add_26))
...
(set-info :example-self_conv2_bn_running_mean_size0 256)
...
(set-info :example-self_conv2_bn_running_var_size0 256)
...
(assert not__78)
(define-fun eq_86 () Bool (= self_conv2_bn_running_mean_size0 256))
(assert eq_86)
(define-fun eq_87 () Bool (= self_conv2_bn_running_var_size0 256))
(assert eq_87)
...
(define-fun truediv_2 () Real (/ mul_56 256))
