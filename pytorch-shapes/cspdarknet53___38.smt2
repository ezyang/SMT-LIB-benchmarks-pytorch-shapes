...
(set-info :example-self_bn_running_mean_size0 128)
...
(set-info :example-self_bn_running_var_size0 128)
...
(assert not__34)
(define-fun eq_44 () Bool (= self_bn_running_mean_size0 128))
(assert eq_44)
(define-fun eq_45 () Bool (= self_bn_running_var_size0 128))
(assert eq_45)
