...
(assert not__25)
(define-fun eq_30 () Bool (= mul_9 0))
(define-fun not__26 () Bool (not eq_30))
(assert not__26)
(define-fun eq_31 () Bool (= mul_23 0))
...
(define-fun output0_stride0 () Int mul_5)
...
(define-fun output1_stride0 () Int mul_11)
(define-fun output1_stride1 () Int mul_11)
(define-fun output1_stride2 () Int input_ids_size1)
(define-fun output1_stride3 () Int 1)
(define-fun output1_storage_offset () Int 0)
(check-sat)
(get-value (input_ids_size0 input_ids_size1 input_ids_stride0 input_ids_stride1 input_ids_storage_offset output0_size0 output0_size1 output0_size2 output0_stride0 output0_stride1 output0_stride2 output0_storage_offset output1_size0 output1_size1 output1_size2 output1_size3 output1_stride0 output1_stride1 output1_stride2 output1_stride3 output1_storage_offset))
