...
(define-fun eq_78 () Bool (= x_size1 outputs_5__size1))
(assert eq_78)
(define-fun lt_21 () Bool (< x_size3 0))
(define-fun not__54 () Bool (not lt_21))
(assert not__54)
(define-fun lt_22 () Bool (< x_size2 0))
(define-fun not__55 () Bool (not lt_22))
(assert not__55)
(define-fun lt_23 () Bool (< x_size1 0))
(define-fun not__56 () Bool (not lt_23))
(assert not__56)
(define-fun lt_24 () Bool (< x_size0 0))
(define-fun not__57 () Bool (not lt_24))
(assert not__57)
(define-fun eq_79 () Bool (= x_size3 outputs_5__size3))
(assert eq_79)
(define-fun eq_80 () Bool (= x_size2 outputs_5__size2))
(assert eq_80)
(define-fun eq_81 () Bool (= x_size0 outputs_5__size0))
(assert eq_81)
(define-fun eq_82 () Bool (= outputs_5__size0 x_size0))
(assert eq_82)
(define-fun eq_83 () Bool (= outputs_5__size1 x_size1))
(assert eq_83)
(define-fun eq_84 () Bool (= outputs_5__size2 x_size2))
(assert eq_84)
(define-fun eq_85 () Bool (= outputs_5__size3 x_size3))
(assert eq_85)
(define-fun eq_86 () Bool (= mul_16 0))
(define-fun not__58 () Bool (not eq_86))
(assert not__58)
(define-fun eq_87 () Bool (= mul_50 0))
(define-fun not__59 () Bool (not eq_87))
(assert not__59)
(define-fun eq_88 () Bool (= mul_15 0))
