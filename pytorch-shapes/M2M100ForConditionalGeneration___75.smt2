...
(assert not__34)
(define-fun eq_45 () Bool (= mul_21 0))
(define-fun not__35 () Bool (not eq_45))
(assert not__35)
(define-fun eq_46 () Bool (= mul_35 0))
...
(define-fun output1_size2 () Int input_ids_size1)
(define-fun output1_size3 () Int input_ids_size1)
(define-fun output1_stride0 () Int mul_23)
(define-fun output1_stride1 () Int mul_23)
(define-fun output1_stride2 () Int input_ids_size1)
(define-fun output1_stride3 () Int 1)
(define-fun output1_storage_offset () Int 0)
(check-sat)
(get-value (input_ids_size0 input_ids_size1 input_ids_stride0 input_ids_stride1 input_ids_storage_offset encoder_hidden_states_size0 encoder_hidden_states_size1 encoder_hidden_states_size2 encoder_hidden_states_stride0 encoder_hidden_states_stride1 encoder_hidden_states_stride2 encoder_hidden_states_storage_offset output0_size0 output0_size1 output0_size2 output0_stride0 output0_stride1 output0_stride2 output0_storage_offset output1_size0 output1_size1 output1_size2 output1_size3 output1_stride0 output1_stride1 output1_stride2 output1_stride3 output1_storage_offset))
