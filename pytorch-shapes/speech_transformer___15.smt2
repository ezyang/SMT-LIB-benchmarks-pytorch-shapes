...
(set-info :example-___stack0_size1 22)
...
(set-info :example-ys_in_pad_size0 10)
(declare-const ys_in_pad_size1 Int)
(set-info :example-ys_in_pad_size1 22)
(declare-const ys_in_pad_stride0 Int)
(set-info :example-ys_in_pad_stride0 22)
(declare-const ys_in_pad_stride1 Int)
(set-info :example-ys_in_pad_stride1 1)
(declare-const ys_in_pad_storage_offset Int)
(set-info :example-ys_in_pad_storage_offset 0)
