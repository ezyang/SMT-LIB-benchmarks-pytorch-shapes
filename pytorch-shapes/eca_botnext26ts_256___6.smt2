...
(define-fun eq_81 () Bool (= floordiv_10 128))
(assert eq_81)
...
(assert not__77)
(define-fun mod_2 () Int (mod 128 floordiv_10))
...
(define-fun mul_66 () Int (* 512 add_43))
...
(define-fun mul_75 () Int (* x_size0 512))
...
(assert not__94)
(define-fun eq_103 () Bool (= self_conv3_1x1_bn_running_mean_size0 512))
(assert eq_103)
(define-fun eq_104 () Bool (= self_conv3_1x1_bn_running_var_size0 512))
(assert eq_104)
...
(define-fun truediv_4 () Real (/ mul_77 512))
...
(define-fun mul_89 () Int (* 512 add_58))
...
(assert not__117)
(define-fun eq_128 () Bool (= self_shortcut_bn_running_mean_size0 512))
(assert eq_128)
(define-fun eq_129 () Bool (= self_shortcut_bn_running_var_size0 512))
(assert eq_129)
...
(define-fun truediv_6 () Real (/ mul_99 512))
