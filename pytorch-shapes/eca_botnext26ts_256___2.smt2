...
(define-fun mul_89 () Int (* 256 add_9))
(define-fun mul_90 () Int (* mul_89 add_10))
(define-fun gt_16 () Bool (> mul_90 2147483647))
(define-fun not__104 () Bool (not gt_16))
(assert not__104)
(define-fun mul_91 () Int (* mul_19 256))
(define-fun mul_92 () Int (* mul_91 x_size0))
(define-fun mul_93 () Int (* mul_91 sub))
(define-fun add_58 () Int (+ 1 mul_93))
(define-fun mul_94 () Int (* mul_19 255))
(define-fun add_59 () Int (+ add_58 mul_94))
(define-fun add_60 () Int (+ add_59 mul_24))
(define-fun add_61 () Int (+ add_60 sub_9))
(define-fun mul_95 () Int (* 4 add_61))
(define-fun mul_96 () Int (* mul_75 add_11))
(define-fun mul_97 () Int (* mul_96 add_12))
(define-fun eq_111 () Bool (= mul_97 0))
(define-fun not__105 () Bool (not eq_111))
(assert not__105)
(define-fun eq_112 () Bool (= mul_91 mul_91))
(assert eq_112)
...
(assert ge_26)
(define-fun add_62 () Int (+ self_shortcut_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_98 () Int (* 8 add_62))
...
(assert ge_27)
(define-fun eq_113 () Bool (= self_shortcut_bn_running_mean_size0 0))
(define-fun not__106 () Bool (not eq_113))
(assert not__106)
(define-fun sub_33 () Int (- self_shortcut_bn_running_mean_size0 1))
(define-fun mul_99 () Int (* self_shortcut_bn_running_mean_stride0 sub_33))
(define-fun add_63 () Int (+ 1 mul_99))
(define-fun mul_100 () Int (* 4 add_63))
(define-fun eq_114 () Bool (= self_shortcut_bn_running_mean_size0 1))
(define-fun not__107 () Bool (not eq_114))
(assert not__107)
(define-fun eq_115 () Bool (= self_shortcut_bn_running_mean_stride0 1))
(assert eq_115)
(define-fun ge_28 () Bool (>= self_shortcut_bn_running_mean_storage_offset 0))
(assert ge_28)
(define-fun add_64 () Int (+ self_shortcut_bn_running_mean_storage_offset add_63))
(define-fun mul_101 () Int (* 4 add_64))
...
(assert ge_29)
(define-fun eq_116 () Bool (= self_shortcut_bn_running_var_size0 0))
(define-fun not__108 () Bool (not eq_116))
(assert not__108)
(define-fun sub_34 () Int (- self_shortcut_bn_running_var_size0 1))
(define-fun mul_102 () Int (* self_shortcut_bn_running_var_stride0 sub_34))
(define-fun add_65 () Int (+ 1 mul_102))
(define-fun mul_103 () Int (* 4 add_65))
(define-fun eq_117 () Bool (= self_shortcut_bn_running_var_size0 1))
(define-fun not__109 () Bool (not eq_117))
(assert not__109)
(define-fun eq_118 () Bool (= self_shortcut_bn_running_var_stride0 1))
(assert eq_118)
(define-fun ge_30 () Bool (>= self_shortcut_bn_running_var_storage_offset 0))
(assert ge_30)
(define-fun add_66 () Int (+ self_shortcut_bn_running_var_storage_offset add_65))
(define-fun mul_104 () Int (* 4 add_66))
(define-fun eq_119 () Bool (= self_shortcut_bn_running_mean_size0 256))
(assert eq_119)
(define-fun eq_120 () Bool (= self_shortcut_bn_running_var_size0 256))
(assert eq_120)
(define-fun lt_50 () Bool (< mul_97 2147483647))
(assert lt_50)
(define-fun eq_121 () Bool (= mul_91 0))
(define-fun not__110 () Bool (not eq_121))
(assert not__110)
(define-fun lt_51 () Bool (< mul_19 mul_91))
(assert lt_51)
(define-fun lt_52 () Bool (< self_shortcut_bn_running_mean_size0 0))
(define-fun not__111 () Bool (not lt_52))
(assert not__111)
(define-fun eq_122 () Bool (= self_shortcut_bn_running_mean_size0 self_shortcut_bn_running_mean_size0))
(assert eq_122)
(define-fun add_67 () Int (+ 1 sub_33))
(define-fun mul_105 () Int (* 4 add_67))
(define-fun truediv_6 () Real (/ mul_97 256))
(define-fun sub_35 () Real (- truediv_6 1))
(define-fun truediv_7 () Real (/ truediv_6 sub_35))
(define-fun lt_53 () Bool (< self_shortcut_bn_running_var_size0 0))
(define-fun not__112 () Bool (not lt_53))
(assert not__112)
(define-fun eq_123 () Bool (= self_shortcut_bn_running_var_size0 self_shortcut_bn_running_var_size0))
(assert eq_123)
(define-fun add_68 () Int (+ 1 sub_34))
(define-fun mul_106 () Int (* 4 add_68))
(define-fun eq_124 () Bool (= add_46 add_12))
(assert eq_124)
(define-fun eq_125 () Bool (= add_45 add_11))
(assert eq_125)
(define-fun eq_126 () Bool (= add_11 add_45))
(assert eq_126)
(define-fun eq_127 () Bool (= add_12 add_46))
(assert eq_127)
(define-fun eq_128 () Bool (= mul_16 0))
(define-fun not__113 () Bool (not eq_128))
(assert not__113)
(define-fun eq_129 () Bool (= mul_29 0))
(define-fun not__114 () Bool (not eq_129))
(assert not__114)
(define-fun eq_130 () Bool (= mul_32 0))
(define-fun not__115 () Bool (not eq_130))
(assert not__115)
(define-fun eq_131 () Bool (= mul_35 0))
(define-fun not__116 () Bool (not eq_131))
(assert not__116)
(define-fun eq_132 () Bool (= mul_51 0))
(define-fun not__117 () Bool (not eq_132))
(assert not__117)
(define-fun eq_133 () Bool (= mul_54 0))
(define-fun not__118 () Bool (not eq_133))
(assert not__118)
(define-fun eq_134 () Bool (= mul_57 0))
(define-fun not__119 () Bool (not eq_134))
(assert not__119)
(define-fun eq_135 () Bool (= mul_78 0))
(define-fun not__120 () Bool (not eq_135))
(assert not__120)
(define-fun eq_136 () Bool (= mul_81 0))
(define-fun not__121 () Bool (not eq_136))
(assert not__121)
(define-fun eq_137 () Bool (= mul_84 0))
...
(assert not__124)
(define-fun eq_140 () Bool (= mul_104 0))
(define-fun not__125 () Bool (not eq_140))
(assert not__125)
(define-fun eq_141 () Bool (= mul_74 0))
