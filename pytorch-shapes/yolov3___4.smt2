...
(define-fun eq_26 () Bool (= input_size1 64))
(assert eq_26)
...
(define-fun mul_26 () Int (* input_size0 32))
...
(assert gt_3)
(define-fun mul_29 () Int (* input_size0 add_11))
(define-fun mul_30 () Int (* mul_29 add_12))
...
(assert lt_19)
(define-fun truediv () Real (/ mul_28 32))
