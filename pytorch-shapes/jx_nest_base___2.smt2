...
(check-sat)
(get-value (pred_size0 pred_size1 pred_stride0 pred_stride1 pred_storage_offset self_target_size0 self_target_stride0 self_target_storage_offset output0_storage_offset))
