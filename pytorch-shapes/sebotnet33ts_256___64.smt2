...
(define-fun mul_71 () Int (* 1536 add_43))
...
(define-fun mul_80 () Int (* shortcut_size0 1536))
...
(set-info :example-self_shortcut_bn_running_mean_size0 1536)
...
(set-info :example-self_shortcut_bn_running_var_size0 1536)
...
(assert not__100)
(define-fun eq_116 () Bool (= self_shortcut_bn_running_mean_size0 1536))
(assert eq_116)
(define-fun eq_117 () Bool (= self_shortcut_bn_running_var_size0 1536))
(assert eq_117)
...
(define-fun truediv_4 () Real (/ mul_82 1536))
