...
(set-info :example-___stack0_size1 4)
(declare-const ___stack0_size2 Int)
(set-info :example-___stack0_size2 474)
(declare-const ___stack0_size3 Int)
(set-info :example-___stack0_size3 768)
(declare-const ___stack0_stride0 Int)
(set-info :example-___stack0_stride0 1456128)
(declare-const ___stack0_stride1 Int)
(set-info :example-___stack0_stride1 364032)
(declare-const ___stack0_stride2 Int)
(set-info :example-___stack0_stride2 768)
...
(assert not__17)
(check-sat)
(get-value (___stack0_size0 ___stack0_size1 ___stack0_size2 ___stack0_size3 ___stack0_stride0 ___stack0_stride1 ___stack0_stride2 ___stack0_stride3 ___stack0_storage_offset))
