...
(define-fun mul_70 () Int (* 256 add_45))
...
(define-fun mul_79 () Int (* x_size0 256))
...
(assert not__93)
(define-fun eq_99 () Bool (= self_conv3_1x1_bn_running_mean_size0 256))
(assert eq_99)
(define-fun eq_100 () Bool (= self_conv3_1x1_bn_running_var_size0 256))
(assert eq_100)
...
(define-fun truediv_4 () Real (/ mul_81 256))
...
(define-fun mul_93 () Int (* 256 add_9))
(define-fun mul_94 () Int (* mul_93 add_10))
(define-fun gt_17 () Bool (> mul_94 2147483647))
(define-fun not__103 () Bool (not gt_17))
(assert not__103)
(define-fun mul_95 () Int (* mul_19 256))
(define-fun mul_96 () Int (* mul_95 x_size0))
(define-fun mul_97 () Int (* mul_95 sub))
(define-fun add_60 () Int (+ 1 mul_97))
(define-fun mul_98 () Int (* mul_19 255))
(define-fun add_61 () Int (+ add_60 mul_98))
(define-fun add_62 () Int (+ add_61 mul_24))
(define-fun add_63 () Int (+ add_62 sub_9))
(define-fun mul_99 () Int (* 4 add_63))
(define-fun mul_100 () Int (* mul_79 add_11))
(define-fun mul_101 () Int (* mul_100 add_12))
(define-fun eq_107 () Bool (= mul_101 0))
(define-fun not__104 () Bool (not eq_107))
(assert not__104)
(define-fun eq_108 () Bool (= mul_95 mul_95))
(assert eq_108)
(define-fun lt_48 () Bool (< 1 mul_95))
(assert lt_48)
...
(assert ge_26)
(define-fun add_64 () Int (+ self_shortcut_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_102 () Int (* 8 add_64))
...
(define-fun mul_103 () Int (* self_shortcut_bn_running_mean_stride0 sub_33))
(define-fun add_65 () Int (+ 1 mul_103))
(define-fun mul_104 () Int (* 4 add_65))
...
(assert ge_28)
(define-fun add_66 () Int (+ self_shortcut_bn_running_mean_storage_offset add_65))
(define-fun mul_105 () Int (* 4 add_66))
...
(define-fun mul_106 () Int (* self_shortcut_bn_running_var_stride0 sub_34))
(define-fun add_67 () Int (+ 1 mul_106))
(define-fun mul_107 () Int (* 4 add_67))
...
(assert ge_30)
(define-fun add_68 () Int (+ self_shortcut_bn_running_var_storage_offset add_67))
(define-fun mul_108 () Int (* 4 add_68))
(define-fun eq_115 () Bool (= self_shortcut_bn_running_mean_size0 256))
(assert eq_115)
(define-fun eq_116 () Bool (= self_shortcut_bn_running_var_size0 256))
(assert eq_116)
(define-fun lt_49 () Bool (< mul_101 2147483647))
(assert lt_49)
(define-fun eq_117 () Bool (= mul_95 0))
(define-fun not__109 () Bool (not eq_117))
(assert not__109)
(define-fun lt_50 () Bool (< mul_19 mul_95))
(assert lt_50)
(define-fun lt_51 () Bool (< self_shortcut_bn_running_mean_size0 0))
(define-fun not__110 () Bool (not lt_51))
(assert not__110)
(define-fun eq_118 () Bool (= self_shortcut_bn_running_mean_size0 self_shortcut_bn_running_mean_size0))
(assert eq_118)
(define-fun add_69 () Int (+ 1 sub_33))
(define-fun mul_109 () Int (* 4 add_69))
(define-fun truediv_6 () Real (/ mul_101 256))
...
(define-fun not__111 () Bool (not lt_52))
(assert not__111)
(define-fun eq_119 () Bool (= self_shortcut_bn_running_var_size0 self_shortcut_bn_running_var_size0))
(assert eq_119)
(define-fun add_70 () Int (+ 1 sub_34))
(define-fun mul_110 () Int (* 4 add_70))
(define-fun eq_120 () Bool (= add_48 add_12))
(assert eq_120)
(define-fun eq_121 () Bool (= add_47 add_11))
(assert eq_121)
(define-fun eq_122 () Bool (= add_11 add_47))
(assert eq_122)
(define-fun eq_123 () Bool (= add_12 add_48))
(assert eq_123)
(define-fun eq_124 () Bool (= mul_16 0))
(define-fun not__112 () Bool (not eq_124))
(assert not__112)
(define-fun eq_125 () Bool (= mul_29 0))
(define-fun not__113 () Bool (not eq_125))
(assert not__113)
(define-fun eq_126 () Bool (= mul_32 0))
(define-fun not__114 () Bool (not eq_126))
(assert not__114)
(define-fun eq_127 () Bool (= mul_35 0))
(define-fun not__115 () Bool (not eq_127))
(assert not__115)
(define-fun eq_128 () Bool (= mul_51 0))
(define-fun not__116 () Bool (not eq_128))
(assert not__116)
(define-fun eq_129 () Bool (= mul_54 0))
(define-fun not__117 () Bool (not eq_129))
(assert not__117)
(define-fun eq_130 () Bool (= mul_57 0))
(define-fun not__118 () Bool (not eq_130))
(assert not__118)
(define-fun eq_131 () Bool (= mul_82 0))
(define-fun not__119 () Bool (not eq_131))
(assert not__119)
(define-fun eq_132 () Bool (= mul_85 0))
(define-fun not__120 () Bool (not eq_132))
(assert not__120)
(define-fun eq_133 () Bool (= mul_88 0))
(define-fun not__121 () Bool (not eq_133))
(assert not__121)
(define-fun eq_134 () Bool (= mul_102 0))
(define-fun not__122 () Bool (not eq_134))
(assert not__122)
(define-fun eq_135 () Bool (= mul_105 0))
(define-fun not__123 () Bool (not eq_135))
(assert not__123)
(define-fun eq_136 () Bool (= mul_108 0))
(define-fun not__124 () Bool (not eq_136))
(assert not__124)
(define-fun eq_137 () Bool (= mul_78 0))
