...
(set-info :example-x_size2 1024)
(declare-const x_stride0 Int)
(set-info :example-x_stride0 1024)
...
(assert eq_6)
(define-fun eq_7 () Bool (= x_size0 1))
(define-fun not__5 () Bool (not eq_7))
(assert not__5)
(define-fun eq_8 () Bool (= x_stride0 x_size2))
(assert eq_8)
(define-fun mul_6 () Int (* x_size2 x_size0))
...
(assert le_1)
(define-fun mul_13 () Int (* 0 x_stride0))
(define-fun add_7 () Int (+ x_storage_offset mul_13))
...
(define-fun mul_14 () Int (* floordiv x_size1))
(define-fun mul_15 () Int (* mul_14 x_size2))
(define-fun eq_17 () Bool (= mul_15 0))
(define-fun not__14 () Bool (not eq_17))
(assert not__14)
(define-fun eq_18 () Bool (= floordiv 1))
(define-fun not__15 () Bool (not eq_18))
(assert not__15)
(define-fun mul_16 () Int (* x_size2 floordiv))
(define-fun gt_2 () Bool (> x_size1 0))
(assert gt_2)
(define-fun lt_3 () Bool (< x_size1 0))
(define-fun not__16 () Bool (not lt_3))
(assert not__16)
(define-fun le_2 () Bool (<= x_size1 0))
(define-fun not__17 () Bool (not le_2))
(assert not__17)
(define-fun mul_17 () Int (* 0 x_stride1))
(define-fun add_9 () Int (+ add_7 mul_17))
(define-fun mul_18 () Int (* floordiv x_size2))
(define-fun eq_19 () Bool (= mul_18 0))
(define-fun not__18 () Bool (not eq_19))
(assert not__18)
(define-fun eq_20 () Bool (= x_size2 1024))
(assert eq_20)
(define-fun ge_4 () Bool (>= floordiv 0))
(assert ge_4)
(define-fun eq_21 () Bool (= floordiv 0))
(define-fun not__19 () Bool (not eq_21))
(assert not__19)
(define-fun mul_19 () Int (* 1000 floordiv))
(define-fun sub_5 () Int (- floordiv 1))
(define-fun mul_20 () Int (* 1000 sub_5))
(define-fun add_10 () Int (+ 1 mul_20))
(define-fun add_11 () Int (+ add_10 999))
(define-fun mul_21 () Int (* 4 add_11))
(define-fun mul_22 () Int (* floordiv 1000))
(define-fun eq_22 () Bool (= mul_22 0))
(define-fun not__20 () Bool (not eq_22))
(assert not__20)
(define-fun lt_4 () Bool (< floordiv 0))
(define-fun not__21 () Bool (not lt_4))
(assert not__21)
(define-fun eq_23 () Bool (= floordiv floordiv))
(assert eq_23)
...
(check-sat)
(get-value (x_size0 x_size1 x_size2 x_stride0 x_stride1 x_stride2 x_storage_offset output0_size0 output0_size1 output0_stride0 output0_stride1 output0_storage_offset))
