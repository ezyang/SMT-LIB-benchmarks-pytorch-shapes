...
(set-info :example-v_size2 64)
(declare-const v_stride0 Int)
(set-info :example-v_stride0 16384)
...
(assert lt_29)
(define-fun eq_89 () Bool (= mul_52 524288))
(assert eq_89)
...
(assert not__64)
(define-fun lt_32 () Bool (< 256 v_size2))
(define-fun not__65 () Bool (not lt_32))
(assert not__65)
(define-fun eq_93 () Bool (= 256 v_size2))
...
(define-fun eq_109 () Bool (= mul_64 256))
(assert eq_109)
...
(assert lt_37)
(define-fun lt_38 () Bool (< 16 mul_55))
(assert lt_38)
(define-fun lt_39 () Bool (< 256 mul_55))
(assert lt_39)
(define-fun lt_40 () Bool (< 65536 mul_55))
(assert lt_40)
(define-fun eq_120 () Bool (= 524288 mul_55))
(assert eq_120)
...
(define-fun output0_size2 () Int 16)
