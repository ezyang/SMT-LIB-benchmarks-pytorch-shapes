...
(assert eq_23)
(define-fun eq_24 () Bool (= hidden_states_size2 512))
(assert eq_24)
(define-fun mul_13 () Int (* 512 hidden_states_size1))
(define-fun mul_14 () Int (* 512 sub_1))
(define-fun add_7 () Int (+ 1 mul_14))
(define-fun add_8 () Int (+ add_7 511))
(define-fun mul_15 () Int (* 4 add_8))
(define-fun mul_16 () Int (* hidden_states_size1 512))
...
(assert not__19)
(define-fun mul_17 () Int (* mul_4 512))
...
(define-fun mul_18 () Int (* 512 floordiv))
...
(define-fun mul_23 () Int (* 512 sub_3))
...
(assert not__32)
(define-fun mul_31 () Int (* 32 floordiv))
...
(define-fun mul_36 () Int (* 32 sub_3))
...
(define-fun mul_41 () Int (* mul_40 32))
...
(assert lt_11)
(define-fun lt_12 () Bool (< 32 mul_31))
(assert lt_12)
...
(define-fun output0_stride1 () Int 32)
