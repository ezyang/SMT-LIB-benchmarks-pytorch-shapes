...
(set-info :example-self_bn_running_mean_size0 512)
...
(set-info :example-self_bn_running_var_size0 512)
...
(assert not__34)
(define-fun eq_44 () Bool (= self_bn_running_mean_size0 512))
(assert eq_44)
(define-fun eq_45 () Bool (= self_bn_running_var_size0 512))
(assert eq_45)
