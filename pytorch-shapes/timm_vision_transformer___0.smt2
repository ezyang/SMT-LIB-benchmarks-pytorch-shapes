...
(assert not__36)
(define-fun mul_32 () Int (* 384 add_13))
...
(assert not__40)
(define-fun eq_45 () Bool (= add_13 197))
(assert eq_45)
...
(assert not__44)
(define-fun gt_5 () Bool (> mul_32 384))
(assert gt_5)
...
(assert eq_56)
(define-fun lt_19 () Bool (< mul_32 384))
(define-fun not__51 () Bool (not lt_19))
(assert not__51)
(define-fun gt_7 () Bool (> mul_38 0))
(assert gt_7)
(define-fun mul_42 () Int (* mul_39 384))
...
(assert not__53)
(define-fun mul_43 () Int (* 384 mul_39))
...
(assert not__54)
(define-fun mul_44 () Int (* 1152 mul_39))
(define-fun sub_13 () Int (- mul_39 1))
(define-fun mul_45 () Int (* 1152 sub_13))
(define-fun add_19 () Int (+ 1 mul_45))
(define-fun add_20 () Int (+ add_19 1151))
(define-fun mul_46 () Int (* 4 add_20))
(define-fun mul_47 () Int (* mul_39 1152))
...
(assert not__57)
(define-fun mul_48 () Int (* mul_37 1152))
...
(define-fun mul_49 () Int (* 1152 floordiv_5))
(define-fun mul_50 () Int (* x_size0 floordiv_5))
(define-fun mul_51 () Int (* mul_50 1152))
...
(define-fun mul_54 () Int (* mul_53 6))
...
(assert lt_23)
(define-fun lt_24 () Bool (< 384 mul_52))
(assert lt_24)
(define-fun lt_25 () Bool (< 1152 mul_52))
(assert lt_25)
(define-fun mul_56 () Int (* 1152 add_13))
...
(define-fun mul_59 () Int (* mul_58 384))
...
(assert lt_27)
(define-fun mul_60 () Int (* mul_58 6))
...
(define-fun mul_63 () Int (* mul_62 6))
...
(assert eq_85)
(define-fun mul_71 () Int (* floordiv_5 1152))
...
(assert eq_97)
(define-fun mul_79 () Int (* 6 x_size0))
...
(assert lt_42)
(define-fun eq_123 () Bool (= floordiv_6 6))
(assert eq_123)
...
(define-fun eq_126 () Bool (= floordiv_5 197))
(assert eq_126)
...
(define-fun eq_141 () Bool (= 1152 mul_120))
...
(assert not__141)
(define-fun eq_170 () Bool (= mul_145 384))
(assert eq_170)
...
(assert eq_180)
(define-fun eq_181 () Bool (= mul_138 384))
(assert eq_181)
...
(assert not__150)
(define-fun mul_150 () Int (* 384 mul_147))
(define-fun sub_19 () Int (- mul_147 1))
(define-fun mul_151 () Int (* 384 sub_19))
(define-fun add_50 () Int (+ 1 mul_151))
(define-fun add_51 () Int (+ add_50 383))
(define-fun mul_152 () Int (* 4 add_51))
(define-fun mul_153 () Int (* mul_147 384))
...
(assert not__153)
(define-fun mul_154 () Int (* mul_50 384))
...
(define-fun mul_155 () Int (* 384 floordiv_8))
(define-fun mul_156 () Int (* x_size0 floordiv_8))
(define-fun mul_157 () Int (* mul_156 384))
...
(assert eq_194)
(define-fun mul_159 () Int (* 1536 mul_39))
(define-fun mul_160 () Int (* 1536 sub_13))
(define-fun add_52 () Int (+ 1 mul_160))
(define-fun add_53 () Int (+ add_52 1535))
(define-fun mul_161 () Int (* 4 add_53))
(define-fun mul_162 () Int (* mul_39 1536))
(define-fun eq_195 () Bool (= mul_162 0))
(define-fun not__158 () Bool (not eq_195))
(assert not__158)
(define-fun mul_163 () Int (* mul_37 1536))
(define-fun eq_196 () Bool (= mul_162 mul_163))
(assert eq_196)
(define-fun mul_164 () Int (* 1536 floordiv_5))
(define-fun mul_165 () Int (* mul_50 1536))
...
(define-fun mul_174 () Int (* mul_173 384))
...
(assert not__167)
(define-fun mul_176 () Int (* floordiv_9 384))
(define-fun eq_205 () Bool (= mul_176 0))
(define-fun not__168 () Bool (not eq_205))
(assert not__168)
(define-fun eq_206 () Bool (= mul_32 384))
...
(assert eq_209)
(define-fun lt_74 () Bool (< 1 mul_74))
(assert lt_74)
(define-fun lt_75 () Bool (< 64 mul_74))
(assert lt_75)
(define-fun lt_76 () Bool (< mul_72 mul_74))
(assert lt_76)
(define-fun mul_181 () Int (* mul_72 mul_66))
(define-fun eq_210 () Bool (= mul_181 mul_74))
(assert eq_210)
(define-fun lt_77 () Bool (< 1 mul_86))
(assert lt_77)
(define-fun lt_78 () Bool (< floordiv_5 mul_86))
(assert lt_78)
(define-fun lt_79 () Bool (< mul_84 mul_86))
(assert lt_79)
...
(assert lt_80)
(define-fun lt_81 () Bool (< 64 mul_123))
(assert lt_81)
(define-fun lt_82 () Bool (< mul_72 mul_123))
(assert lt_82)
...
(assert lt_83)
(define-fun lt_84 () Bool (< 384 mul_140))
(assert lt_84)
(define-fun lt_85 () Bool (< mul_32 mul_140))
(assert lt_85)
...
(define-fun not__175 () Bool (not eq_215))
(assert not__175)
