...
(set-info :example-___stack0_last_hidden_state_size0 4)
...
(assert eq_27)
(define-fun eq_28 () Bool (= ___stack0_last_hidden_state_size2 1024))
(assert eq_28)
...
(assert not__30)
(define-fun gt_1 () Bool (> mul_21 1024))
(assert gt_1)
...
(define-fun mul_26 () Int (* 1024 sub_4))
...
(assert lt_10)
(define-fun eq_47 () Bool (= mul_22 -1))
(define-fun not__37 () Bool (not eq_47))
(assert not__37)
(define-fun ge_7 () Bool (>= mul_22 0))
(assert ge_7)
(define-fun eq_48 () Bool (= mul_23 mul_23))
(assert eq_48)
...
(assert eq_52)
(define-fun lt_11 () Bool (< mul_21 1024))
(define-fun not__41 () Bool (not lt_11))
(assert not__41)
(define-fun gt_3 () Bool (> mul_23 0))
(assert gt_3)
(define-fun mul_31 () Int (* mul_28 1024))
...
(assert not__43)
(define-fun mul_32 () Int (* 1024 mul_28))
...
(assert not__44)
(define-fun mul_33 () Int (* 30522 mul_28))
(define-fun sub_5 () Int (- mul_28 1))
(define-fun mul_34 () Int (* 30522 sub_5))
(define-fun add_14 () Int (+ 1 mul_34))
(define-fun add_15 () Int (+ add_14 30521))
(define-fun mul_35 () Int (* 4 add_15))
(define-fun mul_36 () Int (* mul_28 30522))
...
(assert not__47)
(define-fun mul_37 () Int (* mul_22 30522))
...
(define-fun mul_38 () Int (* 30522 floordiv_1))
(define-fun mul_39 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_40 () Int (* mul_39 30522))
