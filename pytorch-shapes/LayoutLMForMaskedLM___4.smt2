...
(assert lt_9)
(define-fun eq_56 () Bool (= mul_32 -1))
...
(assert eq_63)
(define-fun mul_42 () Int (* 30522 floordiv))
(define-fun mul_43 () Int (* 30522 sub_7))
(define-fun add_22 () Int (+ 1 mul_43))
(define-fun add_23 () Int (+ add_22 30521))
(define-fun mul_44 () Int (* 4 add_23))
(define-fun mul_45 () Int (* floordiv 30522))
(define-fun eq_64 () Bool (= mul_45 0))
(define-fun not__47 () Bool (not eq_64))
(assert not__47)
(define-fun mul_46 () Int (* mul_32 30522))
...
(define-fun mul_47 () Int (* 30522 floordiv_1))
(define-fun mul_48 () Int (* ___stack0_last_hidden_state_size0 floordiv_1))
(define-fun mul_49 () Int (* mul_48 30522))
...
(assert eq_71)
(define-fun eq_72 () Bool (= mul_49 30522))
(define-fun not__52 () Bool (not eq_72))
(assert not__52)
(define-fun mod_6 () Int (mod mul_49 30522))
(define-fun eq_73 () Bool (= mod_6 0))
(assert eq_73)
(define-fun floordiv_2 () Int (div mul_49 30522))
...
(assert not__56)
(define-fun mul_50 () Int (* floordiv_1 30522))
...
(assert not__64)
(define-fun mul_52 () Int (* 30522 sub_8))
(define-fun add_25 () Int (+ 1 mul_52))
(define-fun add_26 () Int (+ add_25 30521))
