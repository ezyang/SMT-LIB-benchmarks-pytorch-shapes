...
(set-info :example-___stack0_size1 1536)
...
(define-fun eq_26 () Bool (= ___stack0_size1 1536))
(assert eq_26)
(define-fun lt_7 () Bool (< ___stack0_size2 1))
(define-fun not__18 () Bool (not lt_7))
(assert not__18)
(define-fun lt_8 () Bool (< ___stack0_size3 1))
...
(define-fun mul_20 () Int (* mul_19 1280))
(define-fun mul_21 () Int (* mul_20 ___stack0_size0))
(define-fun mul_22 () Int (* mul_20 sub))
(define-fun add_13 () Int (+ 1 mul_22))
(define-fun mul_23 () Int (* mul_19 1279))
...
(define-fun mul_26 () Int (* ___stack0_size0 1280))
...
(assert lt_10)
(define-fun gt_3 () Bool (> ___stack0_stride1 1))
(assert gt_3)
...
(define-fun ge_7 () Bool (>= self_final_conv_bn_num_batches_tracked_storage_offset 0))
(assert ge_7)
(define-fun add_17 () Int (+ self_final_conv_bn_num_batches_tracked_storage_offset 1))
(define-fun mul_29 () Int (* 8 add_17))
(declare-const self_final_conv_bn_running_mean_size0 Int)
(set-info :example-self_final_conv_bn_running_mean_size0 1280)
...
(define-fun ge_8 () Bool (>= self_final_conv_bn_running_mean_size0 0))
(assert ge_8)
(define-fun eq_37 () Bool (= self_final_conv_bn_running_mean_size0 0))
(define-fun not__30 () Bool (not eq_37))
(assert not__30)
(define-fun sub_10 () Int (- self_final_conv_bn_running_mean_size0 1))
(define-fun mul_30 () Int (* self_final_conv_bn_running_mean_stride0 sub_10))
(define-fun add_18 () Int (+ 1 mul_30))
(define-fun mul_31 () Int (* 4 add_18))
(define-fun eq_38 () Bool (= self_final_conv_bn_running_mean_size0 1))
(define-fun not__31 () Bool (not eq_38))
(assert not__31)
(define-fun eq_39 () Bool (= self_final_conv_bn_running_mean_stride0 1))
(assert eq_39)
(define-fun ge_9 () Bool (>= self_final_conv_bn_running_mean_storage_offset 0))
(assert ge_9)
(define-fun add_19 () Int (+ self_final_conv_bn_running_mean_storage_offset add_18))
(define-fun mul_32 () Int (* 4 add_19))
(declare-const self_final_conv_bn_running_var_size0 Int)
(set-info :example-self_final_conv_bn_running_var_size0 1280)
...
(define-fun ge_10 () Bool (>= self_final_conv_bn_running_var_size0 0))
(assert ge_10)
(define-fun eq_40 () Bool (= self_final_conv_bn_running_var_size0 0))
(define-fun not__32 () Bool (not eq_40))
(assert not__32)
(define-fun sub_11 () Int (- self_final_conv_bn_running_var_size0 1))
(define-fun mul_33 () Int (* self_final_conv_bn_running_var_stride0 sub_11))
(define-fun add_20 () Int (+ 1 mul_33))
(define-fun mul_34 () Int (* 4 add_20))
(define-fun eq_41 () Bool (= self_final_conv_bn_running_var_size0 1))
(define-fun not__33 () Bool (not eq_41))
(assert not__33)
(define-fun eq_42 () Bool (= self_final_conv_bn_running_var_stride0 1))
(assert eq_42)
(define-fun ge_11 () Bool (>= self_final_conv_bn_running_var_storage_offset 0))
(assert ge_11)
(define-fun add_21 () Int (+ self_final_conv_bn_running_var_storage_offset add_20))
(define-fun mul_35 () Int (* 4 add_21))
(define-fun mul_36 () Int (* ___stack0_size0 add_11))
(define-fun mul_37 () Int (* mul_36 add_12))
(define-fun eq_43 () Bool (= mul_37 1))
(define-fun not__34 () Bool (not eq_43))
(assert not__34)
(define-fun eq_44 () Bool (= self_final_conv_bn_running_mean_size0 1280))
(assert eq_44)
(define-fun eq_45 () Bool (= self_final_conv_bn_running_var_size0 1280))
(assert eq_45)
...
(assert not__36)
(define-fun lt_14 () Bool (< ___stack0_size0 0))
(define-fun not__37 () Bool (not lt_14))
(assert not__37)
(define-fun eq_46 () Bool (= add_11 add_11))
(assert eq_46)
(define-fun eq_47 () Bool (= ___stack0_size0 -1))
...
(assert not__40)
(define-fun lt_15 () Bool (< ___stack0_size0 2))
...
(assert lt_19)
(define-fun lt_20 () Bool (< self_final_conv_bn_running_mean_size0 0))
(define-fun not__45 () Bool (not lt_20))
(assert not__45)
(define-fun eq_51 () Bool (= self_final_conv_bn_running_mean_size0 self_final_conv_bn_running_mean_size0))
(assert eq_51)
(define-fun add_22 () Int (+ 1 sub_10))
(define-fun mul_38 () Int (* 4 add_22))
(define-fun truediv () Real (/ mul_28 1280))
(define-fun sub_12 () Real (- truediv 1))
(define-fun truediv_1 () Real (/ truediv sub_12))
(define-fun lt_21 () Bool (< self_final_conv_bn_running_var_size0 0))
(define-fun not__46 () Bool (not lt_21))
(assert not__46)
(define-fun eq_52 () Bool (= self_final_conv_bn_running_var_size0 self_final_conv_bn_running_var_size0))
(assert eq_52)
(define-fun add_23 () Int (+ 1 sub_11))
(define-fun mul_39 () Int (* 4 add_23))
(define-fun eq_53 () Bool (= mul_16 0))
...
(assert not__49)
(define-fun eq_56 () Bool (= mul_35 0))
(define-fun not__50 () Bool (not eq_56))
(assert not__50)
(define-fun eq_57 () Bool (= mul_25 0))
(define-fun not__51 () Bool (not eq_57))
(assert not__51)
(define-fun output0_size0 () Int 1280)
(define-fun output0_stride0 () Int 1)
(define-fun output0_storage_offset () Int 0)
(define-fun output1_size0 () Int 1280)
(define-fun output1_stride0 () Int 1)
(define-fun output1_storage_offset () Int 0)
(define-fun output2_size0 () Int ___stack0_size0)
(define-fun output2_size1 () Int 1280)
