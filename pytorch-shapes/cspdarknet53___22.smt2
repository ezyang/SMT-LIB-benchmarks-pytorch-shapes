...
(set-info :example-x__base_size1 256)
(declare-const x__base_size2 Int)
(set-info :example-x__base_size2 32)
(declare-const x__base_size3 Int)
(set-info :example-x__base_size3 32)
(declare-const x__base_stride0 Int)
(set-info :example-x__base_stride0 262144)
(declare-const x__base_stride1 Int)
(set-info :example-x__base_stride1 1024)
(declare-const x__base_stride2 Int)
(set-info :example-x__base_stride2 32)
...
(set-info :example-x_storage_offset 131072)
...
(set-info :example-self_conv1_bn_running_mean_size0 128)
...
(set-info :example-self_conv1_bn_running_var_size0 128)
...
(set-info :example-self_conv2_bn_running_mean_size0 128)
...
(set-info :example-self_conv2_bn_running_var_size0 128)
