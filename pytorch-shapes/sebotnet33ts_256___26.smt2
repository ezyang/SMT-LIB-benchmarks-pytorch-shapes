...
(set-info :example-shortcut_size1 512)
(declare-const shortcut_size2 Int)
(set-info :example-shortcut_size2 32)
(declare-const shortcut_size3 Int)
(set-info :example-shortcut_size3 32)
(declare-const shortcut_stride0 Int)
(set-info :example-shortcut_stride0 524288)
(declare-const shortcut_stride1 Int)
(set-info :example-shortcut_stride1 1024)
(declare-const shortcut_stride2 Int)
(set-info :example-shortcut_stride2 32)
...
(set-info :example-self_post_attn_running_mean_size0 128)
...
(set-info :example-self_post_attn_running_var_size0 128)
...
(assert eq_60)
(define-fun eq_61 () Bool (= 128 ___stack0_size1))
(assert eq_61)
...
(assert eq_71)
(define-fun eq_72 () Bool (= ___stack0_size1 128))
(assert eq_72)
...
(define-fun mul_48 () Int (* 512 add_28))
...
(define-fun mul_57 () Int (* ___stack0_size0 512))
...
(assert not__74)
(define-fun eq_90 () Bool (= self_conv3_1x1_bn_running_mean_size0 512))
(assert eq_90)
(define-fun eq_91 () Bool (= self_conv3_1x1_bn_running_var_size0 512))
(assert eq_91)
...
(define-fun truediv_2 () Real (/ mul_59 512))
...
(define-fun eq_98 () Bool (= add_31 shortcut_size3))
(assert eq_98)
(define-fun eq_99 () Bool (= add_30 shortcut_size2))
(assert eq_99)
(define-fun eq_100 () Bool (= shortcut_size1 512))
(assert eq_100)
(define-fun eq_101 () Bool (= ___stack0_size0 shortcut_size0))
(assert eq_101)
(define-fun eq_102 () Bool (= shortcut_size0 ___stack0_size0))
(assert eq_102)
(define-fun eq_103 () Bool (= shortcut_size2 add_30))
(assert eq_103)
(define-fun eq_104 () Bool (= shortcut_size3 add_31))
(assert eq_104)
(define-fun eq_105 () Bool (= mul_16 0))
(define-fun not__84 () Bool (not eq_105))
(assert not__84)
(define-fun eq_106 () Bool (= mul_33 0))
(define-fun not__85 () Bool (not eq_106))
(assert not__85)
(define-fun eq_107 () Bool (= mul_34 0))
(define-fun not__86 () Bool (not eq_107))
(assert not__86)
(define-fun eq_108 () Bool (= mul_37 0))
(define-fun not__87 () Bool (not eq_108))
(assert not__87)
(define-fun eq_109 () Bool (= mul_40 0))
(define-fun not__88 () Bool (not eq_109))
(assert not__88)
(define-fun eq_110 () Bool (= mul_60 0))
(define-fun not__89 () Bool (not eq_110))
(assert not__89)
(define-fun eq_111 () Bool (= mul_63 0))
(define-fun not__90 () Bool (not eq_111))
(assert not__90)
(define-fun eq_112 () Bool (= mul_66 0))
(define-fun not__91 () Bool (not eq_112))
(assert not__91)
