...
(define-fun mul_5 () Int (* input_ids_size1 input_ids_size0))
(define-fun eq_6 () Bool (= mul_5 0))
(define-fun not__4 () Bool (not eq_6))
(assert not__4)
(define-fun lt () Bool (< input_ids_size0 0))
(define-fun not__5 () Bool (not lt))
(assert not__5)
(define-fun lt_1 () Bool (< input_ids_size1 0))
(define-fun not__6 () Bool (not lt_1))
(assert not__6)
(define-fun eq_7 () Bool (= input_ids_size1 input_ids_size1))
(assert eq_7)
(define-fun eq_8 () Bool (= input_ids_size0 input_ids_size0))
(assert eq_8)
(define-fun mul_6 () Int (* 1024 input_ids_size0))
(define-fun mul_7 () Int (* mul_6 input_ids_size1))
(define-fun mul_8 () Int (* mul_6 sub_1))
(define-fun add_3 () Int (+ 1 mul_8))
(define-fun mul_9 () Int (* 1024 sub))
(define-fun add_4 () Int (+ add_3 mul_9))
(define-fun add_5 () Int (+ add_4 1023))
(define-fun mul_10 () Int (* 4 add_5))
(define-fun mul_11 () Int (* mul_5 1024))
(define-fun eq_9 () Bool (= mul_11 0))
(define-fun not__7 () Bool (not eq_9))
(assert not__7)
(define-fun eq_10 () Bool (= mul_6 1024))
(assert eq_10)
(define-fun mul_12 () Int (* 1024 input_ids_size1))
(define-fun eq_11 () Bool (= mul_4 0))
(define-fun not__8 () Bool (not eq_11))
(assert not__8)
(define-fun eq_12 () Bool (= mul_10 0))
(define-fun not__9 () Bool (not eq_12))
(assert not__9)
(define-fun output0_size0 () Int input_ids_size1)
(define-fun output0_size1 () Int input_ids_size0)
