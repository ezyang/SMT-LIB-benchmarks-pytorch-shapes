...
(set-info :example-padded_input_size2 512)
(declare-const padded_input_stride0 Int)
(set-info :example-padded_input_stride0 104448)
(declare-const padded_input_stride1 Int)
(set-info :example-padded_input_stride1 512)
...
(set-info :example-input_lengths_size0 10)
