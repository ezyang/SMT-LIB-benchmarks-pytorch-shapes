...
(assert not__74)
(define-fun eq_90 () Bool (= self_conv3_1x1_bn_running_mean_size0 1024))
(assert eq_90)
(define-fun eq_91 () Bool (= self_conv3_1x1_bn_running_var_size0 1024))
(assert eq_91)
...
(assert eq_99)
(define-fun eq_100 () Bool (= shortcut_size1 1024))
(assert eq_100)
