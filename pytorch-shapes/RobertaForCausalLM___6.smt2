...
(assert eq_29)
(define-fun eq_30 () Bool (= ___stack0_last_hidden_state_size2 768))
(assert eq_30)
(define-fun mul_18 () Int (* 768 ___stack0_last_hidden_state_size1))
...
(define-fun mul_21 () Int (* ___stack0_last_hidden_state_size1 768))
...
(define-fun mul_28 () Int (* 768 sub_5))
...
(assert eq_51)
(define-fun mul_33 () Int (* floordiv 768))
