...
(set-info :example-shortcut_size1 2048)
(declare-const shortcut_size2 Int)
(set-info :example-shortcut_size2 8)
(declare-const shortcut_size3 Int)
(set-info :example-shortcut_size3 8)
(declare-const shortcut_stride0 Int)
(set-info :example-shortcut_stride0 131072)
(declare-const shortcut_stride1 Int)
(set-info :example-shortcut_stride1 64)
(declare-const shortcut_stride2 Int)
(set-info :example-shortcut_stride2 8)
...
(assert eq_100)
(define-fun eq_101 () Bool (= shortcut_size1 2048))
(assert eq_101)
...
(define-fun output4_size1 () Int 2048)
