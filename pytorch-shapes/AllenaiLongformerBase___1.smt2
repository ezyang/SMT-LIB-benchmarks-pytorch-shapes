...
(set-info :example-___stack0_2__size0 1)
...
(assert ge_4)
(define-fun eq_6 () Bool (= ___stack0_2__size0 0))
(define-fun not__4 () Bool (not eq_6))
(assert not__4)
(define-fun sub_2 () Int (- ___stack0_2__size0 1))
(define-fun mul_5 () Int (* ___stack0_2__stride0 sub_2))
(define-fun add_3 () Int (+ 1 mul_5))
(define-fun eq_7 () Bool (= ___stack0_2__size1 0))
(define-fun not__5 () Bool (not eq_7))
(assert not__5)
(define-fun sub_3 () Int (- ___stack0_2__size1 1))
(define-fun mul_6 () Int (* ___stack0_2__stride1 sub_3))
(define-fun add_4 () Int (+ add_3 mul_6))
(define-fun mul_7 () Int (* 4 add_4))
(define-fun mul_8 () Int (* ___stack0_2__size0 ___stack0_2__size1))
(define-fun eq_8 () Bool (= mul_8 0))
(define-fun not__6 () Bool (not eq_8))
(assert not__6)
(define-fun eq_9 () Bool (= ___stack0_2__size1 1))
(define-fun not__7 () Bool (not eq_9))
(assert not__7)
(define-fun eq_10 () Bool (= ___stack0_2__stride1 1))
(assert eq_10)
(define-fun eq_11 () Bool (= ___stack0_2__size0 1))
(assert eq_11)
...
(set-info :example-___stack0_3__size0 1)
...
(assert ge_7)
(define-fun eq_12 () Bool (= ___stack0_3__size0 0))
(define-fun not__8 () Bool (not eq_12))
(assert not__8)
(define-fun sub_4 () Int (- ___stack0_3__size0 1))
(define-fun mul_10 () Int (* ___stack0_3__stride0 sub_4))
(define-fun add_6 () Int (+ 1 mul_10))
(define-fun eq_13 () Bool (= ___stack0_3__size1 0))
(define-fun not__9 () Bool (not eq_13))
(assert not__9)
(define-fun sub_5 () Int (- ___stack0_3__size1 1))
(define-fun mul_11 () Int (* ___stack0_3__stride1 sub_5))
(define-fun add_7 () Int (+ add_6 mul_11))
(define-fun mul_12 () Int (* 8 add_7))
(define-fun mul_13 () Int (* ___stack0_3__size0 ___stack0_3__size1))
(define-fun eq_14 () Bool (= mul_13 0))
(define-fun not__10 () Bool (not eq_14))
(assert not__10)
(define-fun eq_15 () Bool (= ___stack0_3__size1 1))
(define-fun not__11 () Bool (not eq_15))
(assert not__11)
(define-fun eq_16 () Bool (= ___stack0_3__stride1 1))
(assert eq_16)
(define-fun eq_17 () Bool (= ___stack0_3__size0 1))
(assert eq_17)
...
(define-fun eq_18 () Bool (= ___stack0_2__size0 9223372036854775807))
(define-fun not__12 () Bool (not eq_18))
(assert not__12)
(define-fun le () Bool (<= ___stack0_2__size0 0))
(define-fun not__13 () Bool (not le))
(assert not__13)
(define-fun le_1 () Bool (<= ___stack0_2__size0 9223372036854775807))
(assert le_1)
(define-fun mul_15 () Int (* 0 ___stack0_2__stride0))
(define-fun add_9 () Int (+ ___stack0_2__storage_offset mul_15))
...
(define-fun mul_16 () Int (* floordiv ___stack0_2__size1))
(define-fun eq_19 () Bool (= mul_16 0))
(define-fun not__14 () Bool (not eq_19))
(assert not__14)
(define-fun eq_20 () Bool (= floordiv 1))
(assert eq_20)
(define-fun eq_21 () Bool (= ___stack0_2__size1 ___stack0_2__size1))
(assert eq_21)
(define-fun eq_22 () Bool (= floordiv floordiv))
(assert eq_22)
(define-fun mul_17 () Int (* ___stack0_2__stride1 ___stack0_2__size1))
(define-fun eq_23 () Bool (= mul_17 0))
(define-fun not__15 () Bool (not eq_23))
(assert not__15)
(define-fun lt () Bool (< mul_17 0))
(define-fun not__16 () Bool (not lt))
(assert not__16)
(define-fun lt_1 () Bool (< ___stack0_2__stride1 mul_17))
(assert lt_1)
(define-fun eq_24 () Bool (= ___stack0_2__size1 9223372036854775807))
(define-fun not__17 () Bool (not eq_24))
(assert not__17)
(define-fun le_2 () Bool (<= ___stack0_2__size1 0))
(define-fun not__18 () Bool (not le_2))
(assert not__18)
(define-fun le_3 () Bool (<= ___stack0_2__size1 9223372036854775807))
(assert le_3)
(define-fun mul_18 () Int (* 0 ___stack0_2__stride1))
(define-fun add_11 () Int (+ add_9 mul_18))
...
(define-fun mul_19 () Int (* floordiv floordiv_1))
(define-fun eq_25 () Bool (= mul_19 0))
(define-fun not__19 () Bool (not eq_25))
(assert not__19)
(define-fun eq_26 () Bool (= floordiv_1 1))
(define-fun not__20 () Bool (not eq_26))
(assert not__20)
(define-fun eq_27 () Bool (= floordiv_1 0))
...
(assert not__23)
(define-fun eq_28 () Bool (= floordiv_1 floordiv_1))
(assert eq_28)
(define-fun eq_29 () Bool (= ___stack0_2__stride1 0))
(define-fun not__24 () Bool (not eq_29))
(assert not__24)
(define-fun lt_4 () Bool (< mul_17 mul_17))
(define-fun not__25 () Bool (not lt_4))
(assert not__25)
(define-fun gt () Bool (> mul_17 mul_17))
(define-fun not__26 () Bool (not gt))
(assert not__26)
(define-fun eq_30 () Bool (= ___stack0_2__stride0 0))
(define-fun not__27 () Bool (not eq_30))
(assert not__27)
(define-fun lt_5 () Bool (< mul_17 ___stack0_2__stride0))
(define-fun not__28 () Bool (not lt_5))
(assert not__28)
(define-fun gt_1 () Bool (> mul_17 ___stack0_2__stride0))
(define-fun not__29 () Bool (not gt_1))
(assert not__29)
...
(assert ge_10)
(define-fun eq_31 () Bool (= floordiv 0))
(define-fun not__31 () Bool (not eq_31))
(assert not__31)
(define-fun mul_20 () Int (* floordiv_1 floordiv))
(define-fun sub_10 () Int (- floordiv 1))
(define-fun mul_21 () Int (* floordiv_1 sub_10))
(define-fun add_13 () Int (+ 1 mul_21))
(define-fun mul_22 () Int (* floordiv_1 0))
(define-fun add_14 () Int (+ add_13 mul_22))
(define-fun add_15 () Int (+ add_14 mul_22))
(define-fun sub_11 () Int (- floordiv_1 1))
(define-fun add_16 () Int (+ add_15 sub_11))
(define-fun mul_23 () Int (* 4 add_16))
...
(assert not__33)
(define-fun eq_32 () Bool (= floordiv 9223372036854775807))
(define-fun not__34 () Bool (not eq_32))
(assert not__34)
(define-fun le_4 () Bool (<= floordiv 0))
(define-fun not__35 () Bool (not le_4))
(assert not__35)
(define-fun le_5 () Bool (<= floordiv 9223372036854775807))
(assert le_5)
(define-fun mul_24 () Int (* 0 floordiv_1))
...
(define-fun mul_25 () Int (* floordiv_2 floordiv_1))
(define-fun eq_33 () Bool (= mul_25 0))
(define-fun not__36 () Bool (not eq_33))
(assert not__36)
(define-fun eq_34 () Bool (= floordiv_2 1))
(assert eq_34)
(define-fun add_18 () Int (+ mul_24 mul_24))
(define-fun add_19 () Int (+ add_18 mul_24))
(define-fun eq_35 () Bool (= floordiv_1 9223372036854775807))
(define-fun not__37 () Bool (not eq_35))
(assert not__37)
(define-fun le_6 () Bool (<= floordiv_1 0))
(define-fun not__38 () Bool (not le_6))
(assert not__38)
...
(define-fun mul_26 () Int (* floordiv_2 floordiv_3))
(define-fun eq_36 () Bool (= mul_26 0))
(define-fun not__39 () Bool (not eq_36))
(assert not__39)
(define-fun eq_37 () Bool (= floordiv_3 1))
...
(assert not__43)
(define-fun eq_41 () Bool (= ___stack0_1__stride0 0))
(define-fun not__44 () Bool (not eq_41))
(assert not__44)
(define-fun lt_12 () Bool (< ___stack0_1__stride1 ___stack0_1__stride0))
(assert lt_12)
(define-fun mul_27 () Int (* ___stack0_1__size1 ___stack0_1__size0))
(define-fun mul_28 () Int (* ___stack0_1__size1 sub))
...
(assert not__45)
(define-fun mul_29 () Int (* 4 add_22))
(define-fun add_23 () Int (+ 1 sub_1))
(define-fun mul_30 () Int (* 8 add_23))
(define-fun eq_42 () Bool (= ___stack0_1__size1 -1))
(define-fun not__46 () Bool (not eq_42))
(assert not__46)
(define-fun mul_31 () Int (* ___stack0_1__size1 ___stack0_1__size1))
...
(assert not__48)
(define-fun eq_44 () Bool (= 0 ___stack0_1__size1))
(define-fun not__49 () Bool (not eq_44))
(assert not__49)
(define-fun mul_32 () Int (* ___stack0_1__size1 sub_1))
(define-fun add_24 () Int (+ 1 mul_32))
(define-fun add_25 () Int (+ add_24 sub_1))
(define-fun mul_33 () Int (* mul_3 ___stack0_1__size1))
(define-fun eq_45 () Bool (= mul_33 0))
(define-fun not__50 () Bool (not eq_45))
(assert not__50)
(define-fun eq_46 () Bool (= ___stack0_1__size0 -1))
...
(assert gt_4)
(define-fun lt_16 () Bool (< ___stack0_1__size1 mul_31))
(assert lt_16)
(define-fun mul_34 () Int (* mul_31 ___stack0_1__size0))
(define-fun mul_35 () Int (* mul_31 sub))
(define-fun add_26 () Int (+ 1 mul_35))
(define-fun add_27 () Int (+ add_26 mul_32))
(define-fun add_28 () Int (+ add_27 sub_1))
(define-fun mul_36 () Int (* 4 add_28))
(define-fun lt_17 () Bool (< mul_33 2))
(define-fun not__52 () Bool (not lt_17))
(assert not__52)
(define-fun mul_37 () Int (* 8 add_28))
(define-fun mul_38 () Int (* 8 add_22))
(define-fun mul_39 () Int (* 768 ___stack0_1__size1))
(define-fun mul_40 () Int (* mul_39 ___stack0_1__size0))
(define-fun mul_41 () Int (* mul_39 sub))
(define-fun add_29 () Int (+ 1 mul_41))
(define-fun mul_42 () Int (* 768 sub_1))
(define-fun add_30 () Int (+ add_29 mul_42))
(define-fun add_31 () Int (+ add_30 767))
(define-fun mul_43 () Int (* 4 add_31))
(define-fun mul_44 () Int (* mul_3 768))
...
(assert not__55)
(define-fun eq_48 () Bool (= ___stack0_3__size0 ___stack0_3__size0))
(assert eq_48)
(define-fun eq_49 () Bool (= ___stack0_3__size1 ___stack0_3__size1))
(assert eq_49)
(define-fun mul_45 () Int (* 768 ___stack0_3__size1))
(define-fun mul_46 () Int (* mul_45 ___stack0_3__size0))
(define-fun mul_47 () Int (* mul_45 sub_4))
(define-fun add_32 () Int (+ 1 mul_47))
(define-fun mul_48 () Int (* 768 sub_5))
(define-fun add_33 () Int (+ add_32 mul_48))
(define-fun add_34 () Int (+ add_33 767))
(define-fun mul_49 () Int (* 4 add_34))
(define-fun mul_50 () Int (* mul_13 768))
(define-fun eq_50 () Bool (= mul_50 0))
(define-fun not__56 () Bool (not eq_50))
(assert not__56)
(define-fun eq_51 () Bool (= mul_39 0))
(define-fun not__57 () Bool (not eq_51))
(assert not__57)
(define-fun gt_5 () Bool (> mul_39 768))
(assert gt_5)
(define-fun eq_52 () Bool (= ___stack0_1__size1 ___stack0_3__size1))
(assert eq_52)
(define-fun eq_53 () Bool (= ___stack0_1__size0 ___stack0_3__size0))
(assert eq_53)
(define-fun eq_54 () Bool (= ___stack0_3__size1 ___stack0_1__size1))
(assert eq_54)
...
(assert not__60)
(define-fun eq_55 () Bool (= floordiv_2 floordiv_2))
(assert eq_55)
(define-fun eq_56 () Bool (= floordiv_3 floordiv_3))
(assert eq_56)
(define-fun ge_11 () Bool (>= floordiv_2 0))
(assert ge_11)
(define-fun ge_12 () Bool (>= floordiv_3 0))
(assert ge_12)
(define-fun eq_57 () Bool (= floordiv_3 0))
(define-fun not__61 () Bool (not eq_57))
(assert not__61)
(define-fun eq_58 () Bool (= floordiv_2 0))
(define-fun not__62 () Bool (not eq_58))
(assert not__62)
(define-fun mul_51 () Int (* floordiv_3 floordiv_2))
(define-fun sub_16 () Int (- floordiv_2 1))
(define-fun mul_52 () Int (* floordiv_3 sub_16))
(define-fun add_35 () Int (+ 1 mul_52))
(define-fun sub_17 () Int (- floordiv_3 1))
(define-fun add_36 () Int (+ add_35 sub_17))
(define-fun eq_59 () Bool (= mul_26 -1))
(define-fun not__63 () Bool (not eq_59))
(assert not__63)
(define-fun ge_13 () Bool (>= mul_26 0))
(assert ge_13)
(define-fun eq_60 () Bool (= mul_26 mul_26))
(assert eq_60)
(define-fun lt_23 () Bool (< 1 mul_51))
(assert lt_23)
(define-fun eq_61 () Bool (= mul_26 mul_51))
(assert eq_61)
(define-fun eq_62 () Bool (= floordiv_2 mul_26))
(define-fun not__64 () Bool (not eq_62))
(assert not__64)
(define-fun eq_63 () Bool (= mul_26 floordiv_2))
(define-fun not__65 () Bool (not eq_63))
(assert not__65)
(define-fun mod () Int (mod floordiv_2 mul_26))
(define-fun eq_64 () Bool (= mod 0))
(define-fun not__66 () Bool (not eq_64))
(assert not__66)
...
(assert not__67)
(define-fun add_37 () Int (+ 1 sub_17))
(define-fun mul_53 () Int (* 8 add_37))
(define-fun eq_66 () Bool (= mul_4 0))
(define-fun not__68 () Bool (not eq_66))
(assert not__68)
(define-fun eq_67 () Bool (= mul_9 0))
(define-fun not__69 () Bool (not eq_67))
(assert not__69)
(define-fun eq_68 () Bool (= mul_14 0))
(define-fun not__70 () Bool (not eq_68))
(assert not__70)
(define-fun eq_69 () Bool (= mul_43 0))
(define-fun not__71 () Bool (not eq_69))
(assert not__71)
(define-fun eq_70 () Bool (= mul_23 0))
