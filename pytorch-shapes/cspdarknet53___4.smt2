...
(set-info :example-x__base_size2 128)
(declare-const x__base_size3 Int)
(set-info :example-x__base_size3 128)
(declare-const x__base_stride0 Int)
(set-info :example-x__base_stride0 2097152)
(declare-const x__base_stride1 Int)
(set-info :example-x__base_stride1 16384)
(declare-const x__base_stride2 Int)
(set-info :example-x__base_stride2 128)
...
(set-info :example-x_storage_offset 1048576)
...
(define-fun mul_23 () Int (* 32 add_9))
...
(define-fun mul_26 () Int (* mul_25 32))
...
(define-fun mul_29 () Int (* mul_25 31))
...
(define-fun mul_32 () Int (* x_size0 32))
...
(set-info :example-self_conv1_bn_running_mean_size0 32)
...
(set-info :example-self_conv1_bn_running_var_size0 32)
...
(assert not__50)
(define-fun eq_58 () Bool (= self_conv1_bn_running_mean_size0 32))
(assert eq_58)
(define-fun eq_59 () Bool (= self_conv1_bn_running_var_size0 32))
(assert eq_59)
...
(define-fun truediv () Real (/ mul_34 32))
...
(define-fun mul_55 () Int (* x_size0 64))
(define-fun mul_56 () Int (* mul_55 add_28))
(define-fun mul_57 () Int (* mul_56 add_29))
(define-fun eq_71 () Bool (= mul_57 0))
...
(define-fun mul_58 () Int (* 8 add_34))
...
(define-fun mul_59 () Int (* self_conv2_bn_running_mean_stride0 sub_24))
(define-fun add_35 () Int (+ 1 mul_59))
(define-fun mul_60 () Int (* 4 add_35))
...
(define-fun mul_62 () Int (* self_conv2_bn_running_var_stride0 sub_25))
(define-fun add_37 () Int (+ 1 mul_62))
(define-fun mul_63 () Int (* 4 add_37))
...
(define-fun mul_64 () Int (* 4 add_38))
(define-fun mul_65 () Int (* x_size0 add_28))
(define-fun mul_66 () Int (* mul_65 add_29))
(define-fun eq_85 () Bool (= mul_66 1))
...
(define-fun mul_67 () Int (* 4 add_39))
...
(define-fun mul_68 () Int (* 4 add_40))
(define-fun eq_94 () Bool (= mul_57 mul_57))
(assert eq_94)
