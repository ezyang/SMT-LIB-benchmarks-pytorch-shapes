...
(set-info :example-value_layer__base_size0 1)
(declare-const value_layer__base_size1 Int)
(set-info :example-value_layer__base_size1 24)
(declare-const value_layer__base_size2 Int)
(set-info :example-value_layer__base_size2 512)
(declare-const value_layer__base_size3 Int)
(set-info :example-value_layer__base_size3 64)
(declare-const value_layer__base_stride0 Int)
(set-info :example-value_layer__base_stride0 786432)
(declare-const value_layer__base_stride1 Int)
(set-info :example-value_layer__base_stride1 32768)
(declare-const value_layer__base_stride2 Int)
(set-info :example-value_layer__base_stride2 64)
(declare-const value_layer__base_stride3 Int)
(set-info :example-value_layer__base_stride3 1)
(declare-const value_layer__base_storage_offset Int)
(set-info :example-value_layer__base_storage_offset 0)
...
(set-info :example-value_layer_size0 24)
(declare-const value_layer_size1 Int)
(set-info :example-value_layer_size1 512)
(declare-const value_layer_size2 Int)
(set-info :example-value_layer_size2 64)
(declare-const value_layer_stride0 Int)
(set-info :example-value_layer_stride0 32768)
(declare-const value_layer_stride1 Int)
(set-info :example-value_layer_stride1 64)
(declare-const value_layer_stride2 Int)
(set-info :example-value_layer_stride2 1)
(declare-const value_layer_storage_offset Int)
(set-info :example-value_layer_storage_offset 0)
...
(check-sat)
(get-value (___stack0_size0 ___stack0_size1 ___stack0_size2 ___stack0_size3 ___stack0_stride0 ___stack0_stride1 ___stack0_stride2 ___stack0_stride3 ___stack0_storage_offset value_layer__base_size0 value_layer__base_size1 value_layer__base_size2 value_layer__base_size3 value_layer__base_stride0 value_layer__base_stride1 value_layer__base_stride2 value_layer__base_stride3 value_layer__base_storage_offset value_layer_size0 value_layer_size1 value_layer_size2 value_layer_stride0 value_layer_stride1 value_layer_stride2 value_layer_storage_offset output0_size0 output0_size1 output0_size2 output0_stride0 output0_stride1 output0_stride2 output0_storage_offset))
