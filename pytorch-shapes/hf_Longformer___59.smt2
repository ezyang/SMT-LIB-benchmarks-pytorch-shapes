...
(assert ge_7)
(define-fun eq_17 () Bool (= attention_mask__base_size0 0))
...
(define-fun eq_18 () Bool (= attention_mask__base_size1 0))
...
(define-fun eq_19 () Bool (= attention_mask__base_size2 0))
...
(define-fun eq_20 () Bool (= attention_mask__base_size3 0))
...
(assert not__14)
(define-fun eq_22 () Bool (= attention_mask__base_size3 1))
(define-fun not__15 () Bool (not eq_22))
(assert not__15)
(define-fun eq_23 () Bool (= attention_mask__base_stride3 1))
(assert eq_23)
(define-fun eq_24 () Bool (= attention_mask__base_size2 1))
(assert eq_24)
(define-fun eq_25 () Bool (= attention_mask__base_size1 1))
(assert eq_25)
(define-fun eq_26 () Bool (= attention_mask__base_size0 1))
(define-fun not__16 () Bool (not eq_26))
(assert not__16)
(define-fun eq_27 () Bool (= attention_mask__base_stride0 attention_mask__base_size3))
(assert eq_27)
(define-fun mul_20 () Int (* attention_mask__base_size3 attention_mask__base_size0))
(define-fun eq_28 () Bool (= attention_mask__base_stride1 0))
...
(define-fun mul_22 () Int (* attention_mask_size0 attention_mask_size1))
(define-fun eq_29 () Bool (= mul_22 0))
(define-fun not__20 () Bool (not eq_29))
(assert not__20)
(define-fun eq_30 () Bool (= attention_mask_size1 1))
(define-fun not__21 () Bool (not eq_30))
(assert not__21)
(define-fun eq_31 () Bool (= attention_mask_stride1 1))
(assert eq_31)
(define-fun eq_32 () Bool (= attention_mask_size0 1))
(define-fun not__22 () Bool (not eq_32))
(assert not__22)
(define-fun eq_33 () Bool (= attention_mask_stride0 attention_mask_size1))
(assert eq_33)
(define-fun mul_23 () Int (* attention_mask_size1 attention_mask_size0))
...
(assert ge_10)
(define-fun eq_34 () Bool (= is_index_masked_size0 0))
(define-fun not__23 () Bool (not eq_34))
(assert not__23)
(define-fun sub_7 () Int (- is_index_masked_size0 1))
(define-fun mul_24 () Int (* is_index_masked_stride0 sub_7))
(define-fun add_12 () Int (+ 1 mul_24))
(define-fun eq_35 () Bool (= is_index_masked_size1 0))
(define-fun not__24 () Bool (not eq_35))
(assert not__24)
(define-fun sub_8 () Int (- is_index_masked_size1 1))
(define-fun mul_25 () Int (* is_index_masked_stride1 sub_8))
(define-fun add_13 () Int (+ add_12 mul_25))
(define-fun mul_26 () Int (* is_index_masked_size0 is_index_masked_size1))
(define-fun eq_36 () Bool (= mul_26 0))
(define-fun not__25 () Bool (not eq_36))
(assert not__25)
(define-fun eq_37 () Bool (= is_index_masked_size1 1))
(define-fun not__26 () Bool (not eq_37))
(assert not__26)
(define-fun eq_38 () Bool (= is_index_masked_stride1 1))
(assert eq_38)
(define-fun eq_39 () Bool (= is_index_masked_size0 1))
(define-fun not__27 () Bool (not eq_39))
(assert not__27)
(define-fun eq_40 () Bool (= is_index_masked_stride0 is_index_masked_size1))
(assert eq_40)
(define-fun mul_27 () Int (* is_index_masked_size1 is_index_masked_size0))
...
(assert ge_13)
(define-fun eq_41 () Bool (= is_index_global_attn_size0 0))
(define-fun not__28 () Bool (not eq_41))
(assert not__28)
(define-fun sub_9 () Int (- is_index_global_attn_size0 1))
(define-fun mul_28 () Int (* is_index_global_attn_stride0 sub_9))
(define-fun add_15 () Int (+ 1 mul_28))
(define-fun eq_42 () Bool (= is_index_global_attn_size1 0))
(define-fun not__29 () Bool (not eq_42))
(assert not__29)
(define-fun sub_10 () Int (- is_index_global_attn_size1 1))
(define-fun mul_29 () Int (* is_index_global_attn_stride1 sub_10))
(define-fun add_16 () Int (+ add_15 mul_29))
(define-fun mul_30 () Int (* is_index_global_attn_size0 is_index_global_attn_size1))
(define-fun eq_43 () Bool (= mul_30 0))
(define-fun not__30 () Bool (not eq_43))
(assert not__30)
(define-fun eq_44 () Bool (= is_index_global_attn_size1 1))
(define-fun not__31 () Bool (not eq_44))
(assert not__31)
(define-fun eq_45 () Bool (= is_index_global_attn_stride1 1))
(assert eq_45)
(define-fun eq_46 () Bool (= is_index_global_attn_size0 1))
(define-fun not__32 () Bool (not eq_46))
(assert not__32)
(define-fun eq_47 () Bool (= is_index_global_attn_stride0 is_index_global_attn_size1))
(assert eq_47)
(define-fun mul_31 () Int (* is_index_global_attn_size1 is_index_global_attn_size0))
...
(define-fun mul_32 () Int (* hidden_states_size1 hidden_states_size0))
(define-fun mul_33 () Int (* mul_32 hidden_states_size2))
(define-fun eq_48 () Bool (= mul_33 0))
(define-fun not__33 () Bool (not eq_48))
(assert not__33)
(define-fun eq_49 () Bool (= hidden_states_stride0 hidden_states_size2))
(define-fun not__34 () Bool (not eq_49))
(assert not__34)
(define-fun lt_4 () Bool (< hidden_states_size0 2))
(define-fun not__35 () Bool (not lt_4))
(assert not__35)
(define-fun lt_5 () Bool (< hidden_states_size1 2))
(define-fun not__36 () Bool (not lt_5))
(assert not__36)
(define-fun lt_6 () Bool (< hidden_states_stride0 hidden_states_stride1))
(define-fun not__37 () Bool (not lt_6))
(assert not__37)
(define-fun lt_7 () Bool (< hidden_states_size2 2))
(define-fun not__38 () Bool (not lt_7))
(assert not__38)
(define-fun eq_50 () Bool (= mul_32 -1))
(define-fun not__39 () Bool (not eq_50))
(assert not__39)
(define-fun ge_15 () Bool (>= mul_32 0))
(assert ge_15)
...
(assert eq_52)
(define-fun mul_34 () Int (* hidden_states_size2 hidden_states_stride2))
(define-fun eq_53 () Bool (= hidden_states_stride0 mul_34))
(define-fun not__41 () Bool (not eq_53))
(assert not__41)
(define-fun lt_8 () Bool (< 1 hidden_states_size2))
(assert lt_8)
(define-fun lt_9 () Bool (< hidden_states_size2 hidden_states_size2))
(define-fun not__42 () Bool (not lt_9))
(assert not__42)
(define-fun eq_54 () Bool (= mul_32 1))
(define-fun not__43 () Bool (not eq_54))
(assert not__43)
(define-fun mul_35 () Int (* hidden_states_size0 hidden_states_stride0))
(define-fun eq_55 () Bool (= hidden_states_stride1 mul_35))
(define-fun not__44 () Bool (not eq_55))
(assert not__44)
(define-fun lt_10 () Bool (< 1 hidden_states_size0))
(assert lt_10)
(define-fun eq_56 () Bool (= mul_32 hidden_states_size0))
(define-fun not__45 () Bool (not eq_56))
(assert not__45)
(define-fun mul_36 () Int (* hidden_states_size2 hidden_states_size0))
(define-fun mul_37 () Int (* mul_36 hidden_states_size1))
(define-fun mul_38 () Int (* mul_36 sub_1))
(define-fun add_18 () Int (+ 1 mul_38))
(define-fun mul_39 () Int (* hidden_states_size2 sub))
(define-fun add_19 () Int (+ add_18 mul_39))
(define-fun add_20 () Int (+ add_19 sub_2))
(define-fun mul_40 () Int (* 4 add_20))
(define-fun eq_57 () Bool (= mul_36 mul_36))
(assert eq_57)
(define-fun eq_58 () Bool (= hidden_states_size1 mul_32))
(define-fun not__46 () Bool (not eq_58))
(assert not__46)
(define-fun eq_59 () Bool (= mul_32 hidden_states_size1))
(define-fun not__47 () Bool (not eq_59))
(assert not__47)
(define-fun mod () Int (mod hidden_states_size1 mul_32))
(define-fun eq_60 () Bool (= mod 0))
(define-fun not__48 () Bool (not eq_60))
(assert not__48)
(define-fun mod_1 () Int (mod mul_32 mul_32))
(define-fun eq_61 () Bool (= mod_1 0))
(assert eq_61)
(define-fun lt_11 () Bool (< mul_36 hidden_states_size2))
(define-fun not__49 () Bool (not lt_11))
(assert not__49)
(define-fun gt_1 () Bool (> mul_33 0))
(assert gt_1)
(define-fun eq_62 () Bool (= mul_4 1))
(define-fun not__50 () Bool (not eq_62))
(assert not__50)
(define-fun mul_41 () Int (* hidden_states_size2 mul_4))
(define-fun eq_63 () Bool (= mul_32 mul_32))
(assert eq_63)
(define-fun eq_64 () Bool (= hidden_states_size2 768))
(assert eq_64)
(define-fun ge_16 () Bool (>= mul_4 0))
(assert ge_16)
(define-fun eq_65 () Bool (= mul_4 0))
(define-fun not__51 () Bool (not eq_65))
(assert not__51)
(define-fun mul_42 () Int (* 768 mul_4))
(define-fun sub_11 () Int (- mul_4 1))
(define-fun mul_43 () Int (* 768 sub_11))
(define-fun add_21 () Int (+ 1 mul_43))
(define-fun add_22 () Int (+ add_21 767))
(define-fun mul_44 () Int (* 4 add_22))
(define-fun mul_45 () Int (* mul_4 768))
(define-fun eq_66 () Bool (= mul_45 0))
(define-fun not__52 () Bool (not eq_66))
(assert not__52)
(define-fun eq_67 () Bool (= hidden_states_size1 -1))
(define-fun not__53 () Bool (not eq_67))
(assert not__53)
(define-fun eq_68 () Bool (= hidden_states_size0 -1))
(define-fun not__54 () Bool (not eq_68))
(assert not__54)
(define-fun mul_46 () Int (* mul_32 768))
(define-fun eq_69 () Bool (= mul_45 mul_46))
(assert eq_69)
(define-fun eq_70 () Bool (= mul_4 hidden_states_size1))
(define-fun not__55 () Bool (not eq_70))
(assert not__55)
(define-fun eq_71 () Bool (= hidden_states_size1 mul_4))
(define-fun not__56 () Bool (not eq_71))
(assert not__56)
(define-fun mod_2 () Int (mod mul_4 hidden_states_size1))
(define-fun eq_72 () Bool (= mod_2 0))
(assert eq_72)
(define-fun floordiv () Int (div mul_4 hidden_states_size1))
(define-fun mul_47 () Int (* 768 floordiv))
(define-fun mul_48 () Int (* hidden_states_size1 floordiv))
(define-fun mul_49 () Int (* mul_48 768))
(define-fun eq_73 () Bool (= mul_49 0))
(define-fun not__57 () Bool (not eq_73))
(assert not__57)
(define-fun eq_74 () Bool (= floordiv 1))
(define-fun not__58 () Bool (not eq_74))
(assert not__58)
(define-fun eq_75 () Bool (= mul_47 mul_47))
(assert eq_75)
(define-fun mul_50 () Int (* mul_47 hidden_states_size1))
(define-fun eq_76 () Bool (= hidden_states_size0 floordiv))
(assert eq_76)
(define-fun lt_12 () Bool (< floordiv 0))
(define-fun not__59 () Bool (not lt_12))
(assert not__59)
(define-fun lt_13 () Bool (< hidden_states_size1 0))
...
(assert not__62)
(define-fun gt_2 () Bool (> mul_47 768))
(assert gt_2)
(define-fun eq_79 () Bool (= floordiv 0))
(define-fun not__63 () Bool (not eq_79))
(assert not__63)
(define-fun mul_51 () Int (* mul_47 sub_1))
(define-fun add_23 () Int (+ 1 mul_51))
(define-fun sub_12 () Int (- floordiv 1))
(define-fun mul_52 () Int (* 768 sub_12))
(define-fun add_24 () Int (+ add_23 mul_52))
(define-fun add_25 () Int (+ add_24 767))
(define-fun mul_53 () Int (* 4 add_25))
(define-fun mul_54 () Int (* mul_32 12))
(define-fun mul_55 () Int (* mul_54 64))
(define-fun eq_80 () Bool (= mul_49 mul_55))
(assert eq_80)
(define-fun eq_81 () Bool (= floordiv hidden_states_size0))
(assert eq_81)
(define-fun mul_56 () Int (* mul_48 12))
...
(assert lt_15)
(define-fun mul_58 () Int (* floordiv hidden_states_size1))
(define-fun mul_59 () Int (* mul_58 12))
(define-fun mul_60 () Int (* mul_59 64))
(define-fun eq_83 () Bool (= mul_60 0))
(define-fun not__65 () Bool (not eq_83))
(assert not__65)
(define-fun eq_84 () Bool (= mul_47 768))
(define-fun not__66 () Bool (not eq_84))
(assert not__66)
(define-fun eq_85 () Bool (= mul_47 1))
(define-fun not__67 () Bool (not eq_85))
(assert not__67)
(define-fun lt_16 () Bool (< mul_47 768))
(define-fun not__68 () Bool (not lt_16))
(assert not__68)
(define-fun lt_17 () Bool (< mul_47 0))
(define-fun not__69 () Bool (not lt_17))
(assert not__69)
(define-fun gt_4 () Bool (> hidden_states_size1 1))
(assert gt_4)
(define-fun lt_18 () Bool (< 1 mul_50))
(assert lt_18)
(define-fun mod_3 () Int (mod hidden_states_size1 512))
(define-fun eq_86 () Bool (= mod_3 0))
(assert eq_86)
(define-fun lt_19 () Bool (< 1 mul_37))
(assert lt_19)
(define-fun lt_20 () Bool (< hidden_states_size2 mul_37))
(assert lt_20)
(define-fun mul_61 () Int (* hidden_states_size2 mul_32))
(define-fun eq_87 () Bool (= mul_61 mul_37))
(assert eq_87)
(define-fun eq_88 () Bool (= mul_11 0))
...
(define-fun output0_stride1 () Int mul_47)
...
(define-fun output1_stride1 () Int mul_47)
