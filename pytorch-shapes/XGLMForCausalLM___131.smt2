...
(assert eq_35)
(define-fun eq_36 () Bool (= hidden_states_size2 1024))
(assert eq_36)
(define-fun mul_23 () Int (* 1024 hidden_states_size1))
(define-fun mul_24 () Int (* 1024 sub_1))
(define-fun add_12 () Int (+ 1 mul_24))
(define-fun add_13 () Int (+ add_12 1023))
(define-fun mul_25 () Int (* 4 add_13))
(define-fun mul_26 () Int (* hidden_states_size1 1024))
...
(assert not__29)
(define-fun mul_27 () Int (* mul_4 1024))
...
(define-fun mul_28 () Int (* 1024 floordiv))
(define-fun mul_29 () Int (* hidden_states_size0 floordiv))
(define-fun mul_30 () Int (* mul_29 1024))
...
(assert not__36)
(define-fun gt_1 () Bool (> mul_28 1024))
(assert gt_1)
...
(define-fun mul_33 () Int (* 1024 sub_7))
(define-fun add_15 () Int (+ add_14 mul_33))
(define-fun add_16 () Int (+ add_15 1023))
