...
(define-fun mul_17 () Int (* 128 add_11))
...
(set-info :example-self_conv_down_bn_running_mean_size0 128)
...
(set-info :example-self_conv_down_bn_running_var_size0 128)
...
(assert not__34)
(define-fun eq_44 () Bool (= self_conv_down_bn_running_mean_size0 128))
(assert eq_44)
(define-fun eq_45 () Bool (= self_conv_down_bn_running_var_size0 128))
(assert eq_45)
...
(define-fun mul_52 () Int (* self_conv_exp_bn_running_mean_stride0 sub_21))
...
(define-fun mul_55 () Int (* self_conv_exp_bn_running_var_stride0 sub_22))
