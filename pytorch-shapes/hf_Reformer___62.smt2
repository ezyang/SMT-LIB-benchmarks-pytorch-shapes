...
(set-info :example-___stack0_last_hidden_state_size1 4096)
(declare-const ___stack0_last_hidden_state_size2 Int)
(set-info :example-___stack0_last_hidden_state_size2 512)
...
(set-info :example-___stack0_last_hidden_state_stride1 512)
...
(assert eq_27)
(define-fun eq_28 () Bool (= ___stack0_last_hidden_state_size2 512))
(assert eq_28)
...
(assert not__18)
(define-fun mul_16 () Int (* 320 mul_12))
(define-fun sub_3 () Int (- mul_12 1))
(define-fun mul_17 () Int (* 320 sub_3))
(define-fun add_7 () Int (+ 1 mul_17))
(define-fun add_8 () Int (+ add_7 319))
(define-fun mul_18 () Int (* 4 add_8))
(define-fun mul_19 () Int (* mul_12 320))
...
(assert not__23)
(define-fun mul_20 () Int (* mul_4 320))
...
(define-fun mul_21 () Int (* 320 floordiv))
(define-fun mul_22 () Int (* ___stack0_last_hidden_state_size0 floordiv))
(define-fun mul_23 () Int (* mul_22 320))
...
(assert eq_41)
(define-fun eq_42 () Bool (= mul_11 0))
(define-fun not__28 () Bool (not eq_42))
(assert not__28)
(define-fun eq_43 () Bool (= mul_18 0))
...
(define-fun output0_size2 () Int 320)
(define-fun output0_stride0 () Int mul_21)
(define-fun output0_stride1 () Int 320)
