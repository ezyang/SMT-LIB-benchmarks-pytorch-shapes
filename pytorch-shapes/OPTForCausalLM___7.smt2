...
(assert eq_85)
(define-fun eq_86 () Bool (= residual_size2 -1))
(define-fun not__57 () Bool (not eq_86))
(assert not__57)
(define-fun eq_87 () Bool (= mul_50 residual_size2))
(define-fun not__58 () Bool (not eq_87))
(assert not__58)
(define-fun gt_2 () Bool (> residual_size2 0))
(assert gt_2)
(define-fun mod () Int (mod mul_50 residual_size2))
(define-fun eq_88 () Bool (= mod 0))
(assert eq_88)
(define-fun floordiv () Int (div mul_50 residual_size2))
(define-fun lt_21 () Bool (< 1 mul_52))
(assert lt_21)
(define-fun lt_22 () Bool (< residual_size2 mul_52))
(assert lt_22)
(define-fun mul_57 () Int (* residual_size2 floordiv))
(define-fun eq_89 () Bool (= mul_57 mul_52))
(assert eq_89)
...
(assert ge_17)
(define-fun mul_58 () Int (* floordiv residual_size2))
(define-fun eq_91 () Bool (= mul_50 mul_58))
(assert eq_91)
(define-fun eq_92 () Bool (= residual_size0 floordiv))
(define-fun not__60 () Bool (not eq_92))
(assert not__60)
(define-fun eq_93 () Bool (= floordiv residual_size0))
(define-fun not__61 () Bool (not eq_93))
(assert not__61)
(define-fun mod_1 () Int (mod residual_size0 floordiv))
(define-fun eq_94 () Bool (= mod_1 0))
(define-fun not__62 () Bool (not eq_94))
(assert not__62)
(define-fun mod_2 () Int (mod mul_49 floordiv))
(define-fun eq_95 () Bool (= mod_2 0))
(assert eq_95)
(define-fun mul_59 () Int (* residual_size1 residual_size2))
(define-fun eq_96 () Bool (= mul_59 0))
(define-fun not__63 () Bool (not eq_96))
(assert not__63)
(define-fun eq_97 () Bool (= mul_49 floordiv))
(assert eq_97)
(define-fun eq_98 () Bool (= residual_size2 768))
(assert eq_98)
(define-fun add_30 () Int (+ 1 sub_11))
...
(assert not__64)
(define-fun eq_99 () Bool (= residual_size1 -1))
(define-fun not__65 () Bool (not eq_99))
(assert not__65)
(define-fun lt_24 () Bool (< residual_size2 2))
(define-fun not__66 () Bool (not lt_24))
(assert not__66)
(define-fun lt_25 () Bool (< residual_size1 2))
(define-fun not__67 () Bool (not lt_25))
(assert not__67)
(define-fun gt_3 () Bool (> residual_size2 1))
(assert gt_3)
(define-fun add_31 () Int (+ 1 mul_54))
(define-fun add_32 () Int (+ add_31 sub_12))
(define-fun mul_61 () Int (* 4 add_32))
(define-fun eq_100 () Bool (= 0 residual_size2))
(define-fun not__68 () Bool (not eq_100))
(assert not__68)
(define-fun mul_62 () Int (* 3072 residual_size1))
(define-fun mul_63 () Int (* 3072 sub_11))
(define-fun add_33 () Int (+ 1 mul_63))
(define-fun add_34 () Int (+ add_33 3071))
(define-fun mul_64 () Int (* 4 add_34))
(define-fun mul_65 () Int (* residual_size1 3072))
(define-fun eq_101 () Bool (= mul_65 0))
(define-fun not__69 () Bool (not eq_101))
(assert not__69)
(define-fun eq_102 () Bool (= mul_65 mul_65))
(assert eq_102)
(define-fun mul_66 () Int (* 768 residual_size1))
(define-fun mul_67 () Int (* 768 sub_11))
(define-fun add_35 () Int (+ 1 mul_67))
(define-fun add_36 () Int (+ add_35 767))
(define-fun mul_68 () Int (* 4 add_36))
(define-fun mul_69 () Int (* residual_size1 768))
(define-fun eq_103 () Bool (= mul_69 0))
(define-fun not__70 () Bool (not eq_103))
(assert not__70)
(define-fun eq_104 () Bool (= residual_size0 -1))
(define-fun not__71 () Bool (not eq_104))
(assert not__71)
(define-fun eq_105 () Bool (= mul_59 mul_50))
(assert eq_105)
(define-fun eq_106 () Bool (= residual_size1 residual_size0))
(define-fun not__72 () Bool (not eq_106))
(assert not__72)
(define-fun eq_107 () Bool (= residual_size0 residual_size1))
...
(define-fun mul_70 () Int (* residual_size2 floordiv_1))
(define-fun mul_71 () Int (* residual_size0 floordiv_1))
(define-fun mul_72 () Int (* mul_71 residual_size2))
(define-fun eq_109 () Bool (= mul_72 0))
(define-fun not__74 () Bool (not eq_109))
(assert not__74)
(define-fun eq_110 () Bool (= floordiv_1 1))
(define-fun not__75 () Bool (not eq_110))
(assert not__75)
(define-fun eq_111 () Bool (= residual_size1 floordiv_1))
(assert eq_111)
(define-fun eq_112 () Bool (= mul_7 0))
(define-fun not__76 () Bool (not eq_112))
(assert not__76)
(define-fun eq_113 () Bool (= mul_56 0))
(define-fun not__77 () Bool (not eq_113))
(assert not__77)
(define-fun eq_114 () Bool (= mul_61 0))
...
(define-fun output0_stride0 () Int mul_70)
