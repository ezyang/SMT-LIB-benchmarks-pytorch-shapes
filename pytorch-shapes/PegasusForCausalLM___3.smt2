...
(assert not__21)
(define-fun lt_6 () Bool (< hidden_states_size1 1))
(define-fun not__22 () Bool (not lt_6))
(assert not__22)
(define-fun gt_1 () Bool (> hidden_states_size1 1))
(assert gt_1)
(define-fun lt_7 () Bool (< hidden_states_size2 0))
(define-fun not__23 () Bool (not lt_7))
(assert not__23)
(define-fun eq_29 () Bool (= hidden_states_size0 -1))
...
(assert not__26)
(define-fun lt_8 () Bool (< hidden_states_size1 2))
(define-fun not__27 () Bool (not lt_8))
(assert not__27)
(define-fun lt_9 () Bool (< hidden_states_size0 2))
(assert lt_9)
(define-fun lt_10 () Bool (< hidden_states_size2 2))
(define-fun not__28 () Bool (not lt_10))
(assert not__28)
(define-fun gt_2 () Bool (> hidden_states_size2 1))
(assert gt_2)
(define-fun eq_32 () Bool (= mul_6 0))
(define-fun not__29 () Bool (not eq_32))
(assert not__29)
(define-fun lt_11 () Bool (< hidden_states_size2 mul_6))
(assert lt_11)
(define-fun eq_33 () Bool (= 0 hidden_states_size2))
...
(assert ge_9)
(define-fun eq_35 () Bool (= mul_5 mul_5))
(assert eq_35)
(define-fun eq_36 () Bool (= hidden_states_size0 mul_4))
(define-fun not__32 () Bool (not eq_36))
(assert not__32)
(define-fun eq_37 () Bool (= mul_4 hidden_states_size0))
...
(assert not__42)
(define-fun gt_3 () Bool (> mul_31 1024))
(assert gt_3)
...
(define-fun mul_36 () Int (* 1024 sub_7))
(define-fun add_17 () Int (+ add_16 mul_36))
(define-fun add_18 () Int (+ add_17 1023))
(define-fun mul_37 () Int (* 4 add_18))
(define-fun mul_38 () Int (* hidden_states_size0 16))
(define-fun mul_39 () Int (* mul_38 64))
(define-fun eq_53 () Bool (= mul_33 mul_39))
(define-fun not__44 () Bool (not eq_53))
(assert not__44)
(define-fun gt_4 () Bool (> mul_39 0))
(assert gt_4)
(define-fun mod_3 () Int (mod mul_33 mul_39))
(define-fun eq_54 () Bool (= mod_3 0))
(assert eq_54)
(define-fun eq_55 () Bool (= mul_39 0))
(define-fun not__45 () Bool (not eq_55))
(assert not__45)
(define-fun floordiv_1 () Int (div mul_33 mul_39))
(define-fun eq_56 () Bool (= floordiv floordiv_1))
(assert eq_56)
(define-fun eq_57 () Bool (= floordiv_1 floordiv))
(assert eq_57)
(define-fun mul_40 () Int (* mul_32 16))
(define-fun mul_41 () Int (* mul_40 64))
(define-fun eq_58 () Bool (= mul_41 0))
(define-fun not__46 () Bool (not eq_58))
(assert not__46)
(define-fun gt_5 () Bool (> floordiv 1))
(assert gt_5)
(define-fun lt_13 () Bool (< 1 mul_31))
(assert lt_13)
(define-fun mul_42 () Int (* mul_38 floordiv))
...
(assert not__48)
(define-fun mul_44 () Int (* 64 floordiv))
(define-fun mul_45 () Int (* mul_44 16))
(define-fun mul_46 () Int (* mul_45 hidden_states_size0))
(define-fun mul_47 () Int (* mul_45 sub))
(define-fun add_19 () Int (+ 1 mul_47))
(define-fun mul_48 () Int (* mul_44 15))
(define-fun add_20 () Int (+ add_19 mul_48))
(define-fun mul_49 () Int (* 64 sub_7))
...
(assert eq_60)
(define-fun eq_61 () Bool (= mul_44 1))
...
(define-fun not__51 () Bool (not lt_15))
(assert not__51)
(define-fun lt_16 () Bool (< 1 mul_45))
(assert lt_16)
(define-fun mul_51 () Int (* mul_4 16))
(define-fun mul_52 () Int (* mul_51 64))
(define-fun eq_63 () Bool (= mul_33 mul_52))
(assert eq_63)
(define-fun eq_64 () Bool (= floordiv hidden_states_size1))
(assert eq_64)
(define-fun eq_65 () Bool (= mul_38 -1))
(define-fun not__52 () Bool (not eq_65))
(assert not__52)
(define-fun ge_11 () Bool (>= mul_38 0))
(assert ge_11)
(define-fun eq_66 () Bool (= mul_43 mul_39))
(define-fun not__53 () Bool (not eq_66))
(assert not__53)
(define-fun mod_4 () Int (mod mul_43 mul_39))
(define-fun eq_67 () Bool (= mod_4 0))
(assert eq_67)
(define-fun floordiv_2 () Int (div mul_43 mul_39))
(define-fun eq_68 () Bool (= hidden_states_size0 mul_38))
(define-fun not__54 () Bool (not eq_68))
(assert not__54)
(define-fun eq_69 () Bool (= mul_38 hidden_states_size0))
(define-fun not__55 () Bool (not eq_69))
(assert not__55)
(define-fun mod_5 () Int (mod hidden_states_size0 mul_38))
(define-fun eq_70 () Bool (= mod_5 0))
(define-fun not__56 () Bool (not eq_70))
(assert not__56)
(define-fun mod_6 () Int (mod mul_38 mul_38))
(define-fun eq_71 () Bool (= mod_6 0))
(assert eq_71)
(define-fun mul_53 () Int (* 16 floordiv))
(define-fun mul_54 () Int (* mul_53 64))
(define-fun eq_72 () Bool (= mul_54 0))
(define-fun not__57 () Bool (not eq_72))
(assert not__57)
(define-fun eq_73 () Bool (= mul_38 mul_38))
(assert eq_73)
(define-fun eq_74 () Bool (= floordiv_2 floordiv))
(assert eq_74)
(define-fun lt_17 () Bool (< 1 mul_44))
(assert lt_17)
(define-fun lt_18 () Bool (< 64 mul_44))
(assert lt_18)
(define-fun mul_55 () Int (* floordiv floordiv))
(define-fun mul_56 () Int (* mul_55 16))
(define-fun mul_57 () Int (* mul_55 15))
(define-fun add_23 () Int (+ 1 mul_57))
(define-fun mul_58 () Int (* floordiv sub_7))
(define-fun add_24 () Int (+ add_23 mul_58))
(define-fun add_25 () Int (+ add_24 sub_7))
(define-fun mul_59 () Int (* 4 add_25))
(define-fun mul_60 () Int (* mul_53 floordiv))
(define-fun eq_75 () Bool (= mul_60 0))
(define-fun not__58 () Bool (not eq_75))
(assert not__58)
(define-fun eq_76 () Bool (= mul_55 mul_55))
(assert eq_76)
(define-fun eq_77 () Bool (= mul_11 0))
(define-fun not__59 () Bool (not eq_77))
(assert not__59)
(define-fun eq_78 () Bool (= mul_10 0))
