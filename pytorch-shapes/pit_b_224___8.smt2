...
(set-info :example-cls_token_size2 512)
(declare-const cls_token_stride0 Int)
(set-info :example-cls_token_stride0 131584)
(declare-const cls_token_stride1 Int)
(set-info :example-cls_token_stride1 512)
...
(assert eq_73)
(define-fun eq_74 () Bool (= cls_token_size2 512))
(assert eq_74)
...
(assert not__69)
(define-fun mul_47 () Int (* 1024 cls_token_size0))
(define-fun sub_13 () Int (- cls_token_size0 1))
(define-fun mul_48 () Int (* 1024 sub_13))
(define-fun add_22 () Int (+ 1 mul_48))
(define-fun add_23 () Int (+ add_22 1023))
(define-fun mul_49 () Int (* 4 add_23))
(define-fun mul_50 () Int (* cls_token_size0 1024))
...
(assert ge_11)
(define-fun mul_51 () Int (* mul_21 1024))
(define-fun eq_79 () Bool (= mul_50 mul_51))
(assert eq_79)
(define-fun eq_80 () Bool (= cls_token_size0 cls_token_size0))
(assert eq_80)
(define-fun eq_81 () Bool (= cls_token_size1 1024))
(define-fun not__73 () Bool (not eq_81))
(assert not__73)
(define-fun mod_4 () Int (mod 1024 cls_token_size1))
(define-fun eq_82 () Bool (= mod_4 0))
(assert eq_82)
(define-fun floordiv_6 () Int (div 1024 cls_token_size1))
...
(assert not__75)
(define-fun eq_85 () Bool (= 1024 floordiv_6))
(assert eq_85)
(define-fun mul_53 () Int (* floordiv_6 cls_token_size0))
(define-fun eq_86 () Bool (= floordiv_6 1024))
(assert eq_86)
...
(assert gt_12)
(define-fun lt_34 () Bool (< floordiv_6 1024))
(define-fun not__83 () Bool (not lt_34))
(assert not__83)
(define-fun gt_13 () Bool (> floordiv_6 1024))
