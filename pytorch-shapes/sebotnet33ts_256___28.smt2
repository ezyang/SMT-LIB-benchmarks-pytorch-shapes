...
(assert not__74)
(define-fun mul_66 () Int (* 16 x_size0))
(define-fun mul_67 () Int (* 16 sub))
(define-fun add_43 () Int (+ 1 mul_67))
(define-fun add_44 () Int (+ add_43 15))
...
(define-fun mul_70 () Int (* 1024 add_45))
...
(define-fun mul_76 () Int (* mul_72 1023))
...
(define-fun mul_79 () Int (* x_size0 1024))
...
(assert not__93)
(define-fun eq_99 () Bool (= self_conv3_1x1_bn_running_mean_size0 1024))
(assert eq_99)
(define-fun eq_100 () Bool (= self_conv3_1x1_bn_running_var_size0 1024))
(assert eq_100)
...
(define-fun truediv_4 () Real (/ mul_81 1024))
...
(define-fun mul_93 () Int (* 1024 add_60))
...
(assert not__116)
(define-fun eq_124 () Bool (= self_shortcut_bn_running_mean_size0 1024))
(assert eq_124)
(define-fun eq_125 () Bool (= self_shortcut_bn_running_var_size0 1024))
(assert eq_125)
...
(define-fun truediv_6 () Real (/ mul_103 1024))
