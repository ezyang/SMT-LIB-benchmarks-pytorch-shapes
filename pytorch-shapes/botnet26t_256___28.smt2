...
(set-info :example-___stack0_size1 256)
...
(set-info :example-___stack0_stride1 256)
(declare-const ___stack0_stride2 Int)
(set-info :example-___stack0_stride2 16)
...
(set-info :example-self_post_attn_running_mean_size0 256)
...
(set-info :example-self_post_attn_running_var_size0 256)
...
(assert eq_60)
(define-fun eq_61 () Bool (= 256 ___stack0_size1))
(assert eq_61)
...
(assert eq_71)
(define-fun eq_72 () Bool (= ___stack0_size1 256))
(assert eq_72)
...
(define-fun mul_48 () Int (* 1024 add_28))
...
(define-fun mul_57 () Int (* ___stack0_size0 1024))
...
(assert not__74)
(define-fun eq_91 () Bool (= self_conv3_1x1_bn_running_mean_size0 1024))
(assert eq_91)
(define-fun eq_92 () Bool (= self_conv3_1x1_bn_running_var_size0 1024))
(assert eq_92)
...
(define-fun truediv_2 () Real (/ mul_59 1024))
...
(define-fun eq_99 () Bool (= add_31 shortcut_size3))
(assert eq_99)
(define-fun eq_100 () Bool (= add_30 shortcut_size2))
(assert eq_100)
(define-fun eq_101 () Bool (= shortcut_size1 1024))
(assert eq_101)
(define-fun eq_102 () Bool (= ___stack0_size0 shortcut_size0))
(assert eq_102)
(define-fun eq_103 () Bool (= shortcut_size0 ___stack0_size0))
(assert eq_103)
(define-fun eq_104 () Bool (= shortcut_size2 add_30))
(assert eq_104)
(define-fun eq_105 () Bool (= shortcut_size3 add_31))
(assert eq_105)
(define-fun eq_106 () Bool (= mul_59 mul_59))
(assert eq_106)
(define-fun eq_107 () Bool (= mul_16 0))
(define-fun not__84 () Bool (not eq_107))
(assert not__84)
(define-fun eq_108 () Bool (= mul_33 0))
(define-fun not__85 () Bool (not eq_108))
(assert not__85)
(define-fun eq_109 () Bool (= mul_34 0))
(define-fun not__86 () Bool (not eq_109))
(assert not__86)
(define-fun eq_110 () Bool (= mul_37 0))
(define-fun not__87 () Bool (not eq_110))
(assert not__87)
(define-fun eq_111 () Bool (= mul_40 0))
(define-fun not__88 () Bool (not eq_111))
(assert not__88)
(define-fun eq_112 () Bool (= mul_60 0))
(define-fun not__89 () Bool (not eq_112))
(assert not__89)
(define-fun eq_113 () Bool (= mul_63 0))
(define-fun not__90 () Bool (not eq_113))
(assert not__90)
(define-fun eq_114 () Bool (= mul_66 0))
(define-fun not__91 () Bool (not eq_114))
(assert not__91)
(define-fun eq_115 () Bool (= mul_56 0))
...
(define-fun output4_size0 () Int ___stack0_size0)
(define-fun output4_size1 () Int 1024)
(define-fun output4_size2 () Int add_30)
(define-fun output4_size3 () Int add_31)
(define-fun output4_stride0 () Int mul_51)
(define-fun output4_stride1 () Int mul_50)
(define-fun output4_stride2 () Int add_31)
