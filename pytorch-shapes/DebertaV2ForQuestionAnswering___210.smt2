...
(assert eq_23)
(define-fun mul_19 () Int (* attention_mask_size3 attention_mask_size2))
...
(assert eq_35)
(define-fun eq_36 () Bool (= hidden_states_size2 1536))
(assert eq_36)
(define-fun mul_21 () Int (* 1536 hidden_states_size1))
(define-fun mul_22 () Int (* 1536 sub_1))
(define-fun add_12 () Int (+ 1 mul_22))
(define-fun add_13 () Int (+ add_12 1535))
(define-fun mul_23 () Int (* 4 add_13))
(define-fun mul_24 () Int (* hidden_states_size1 1536))
...
(assert not__29)
(define-fun mul_25 () Int (* mul_4 1536))
(define-fun eq_40 () Bool (= mul_24 mul_25))
(assert eq_40)
...
(define-fun mul_28 () Int (* mul_27 1536))
...
(assert ge_10)
(define-fun mul_29 () Int (* mul_27 24))
(define-fun eq_48 () Bool (= mul_28 mul_29))
(define-fun not__35 () Bool (not eq_48))
(assert not__35)
(define-fun gt_1 () Bool (> mul_29 0))
(assert gt_1)
(define-fun mod_3 () Int (mod mul_28 mul_29))
(define-fun eq_49 () Bool (= mod_3 0))
(assert eq_49)
(define-fun eq_50 () Bool (= mul_29 0))
(define-fun not__36 () Bool (not eq_50))
(assert not__36)
(define-fun floordiv_1 () Int (div mul_28 mul_29))
(define-fun eq_51 () Bool (= floordiv floordiv))
(assert eq_51)
(define-fun mul_30 () Int (* mul_29 64))
(define-fun eq_52 () Bool (= mul_30 0))
...
(assert gt_2)
(define-fun lt_6 () Bool (< 1 mul_26))
(assert lt_6)
(define-fun eq_54 () Bool (= floordiv_1 64))
(assert eq_54)
(define-fun mul_31 () Int (* hidden_states_size0 24))
...
(define-fun mul_35 () Int (* mul_34 24))
(define-fun mul_36 () Int (* mul_35 hidden_states_size0))
(define-fun mul_37 () Int (* mul_35 sub))
(define-fun add_14 () Int (+ 1 mul_37))
(define-fun mul_38 () Int (* mul_34 23))
(define-fun add_15 () Int (+ add_14 mul_38))
(define-fun sub_7 () Int (- floordiv 1))
(define-fun mul_39 () Int (* 64 sub_7))
(define-fun add_16 () Int (+ add_15 mul_39))
(define-fun add_17 () Int (+ add_16 63))
(define-fun mul_40 () Int (* 4 add_17))
(define-fun eq_56 () Bool (= mul_34 mul_34))
(assert eq_56)
(define-fun eq_57 () Bool (= mul_34 1))
(define-fun not__41 () Bool (not eq_57))
(assert not__41)
(define-fun eq_58 () Bool (= mul_34 0))
(define-fun not__42 () Bool (not eq_58))
(assert not__42)
(define-fun lt_9 () Bool (< mul_34 0))
(define-fun not__43 () Bool (not lt_9))
(assert not__43)
(define-fun lt_10 () Bool (< 1 mul_35))
(assert lt_10)
(define-fun mul_41 () Int (* floordiv 64))
(define-fun eq_59 () Bool (= mul_33 mul_41))
(define-fun not__44 () Bool (not eq_59))
(assert not__44)
(define-fun gt_3 () Bool (> mul_41 0))
(assert gt_3)
(define-fun mod_4 () Int (mod mul_33 mul_41))
(define-fun eq_60 () Bool (= mod_4 0))
(assert eq_60)
(define-fun eq_61 () Bool (= mul_41 0))
(define-fun not__45 () Bool (not eq_61))
(assert not__45)
(define-fun floordiv_2 () Int (div mul_33 mul_41))
(define-fun eq_62 () Bool (= hidden_states_size0 floordiv_2))
(define-fun not__46 () Bool (not eq_62))
(assert not__46)
(define-fun eq_63 () Bool (= floordiv_2 hidden_states_size0))
(define-fun not__47 () Bool (not eq_63))
(assert not__47)
(define-fun mod_5 () Int (mod hidden_states_size0 floordiv_2))
(define-fun eq_64 () Bool (= mod_5 0))
(define-fun not__48 () Bool (not eq_64))
(assert not__48)
(define-fun mod_6 () Int (mod mul_31 floordiv_2))
(define-fun eq_65 () Bool (= mod_6 0))
(assert eq_65)
(define-fun mul_42 () Int (* 24 floordiv))
(define-fun mul_43 () Int (* mul_42 64))
(define-fun eq_66 () Bool (= mul_43 0))
(define-fun not__49 () Bool (not eq_66))
(assert not__49)
(define-fun eq_67 () Bool (= mul_31 floordiv_2))
(assert eq_67)
(define-fun eq_68 () Bool (= mul_26 0))
(define-fun not__50 () Bool (not eq_68))
(assert not__50)
(define-fun lt_11 () Bool (< 1 mul_34))
(assert lt_11)
(define-fun lt_12 () Bool (< 64 mul_34))
(assert lt_12)
(define-fun mul_44 () Int (* floordiv floordiv))
(define-fun mul_45 () Int (* mul_44 24))
(define-fun mul_46 () Int (* mul_44 23))
(define-fun add_18 () Int (+ 1 mul_46))
(define-fun mul_47 () Int (* floordiv sub_7))
(define-fun add_19 () Int (+ add_18 mul_47))
(define-fun add_20 () Int (+ add_19 sub_7))
(define-fun mul_48 () Int (* 4 add_20))
(define-fun mul_49 () Int (* mul_42 floordiv))
(define-fun eq_69 () Bool (= mul_49 0))
(define-fun not__51 () Bool (not eq_69))
(assert not__51)
(define-fun eq_70 () Bool (= mul_44 mul_44))
(assert eq_70)
...
(assert not__53)
(define-fun lt_14 () Bool (< floordiv mul_44))
(assert lt_14)
(define-fun eq_72 () Bool (= mul_49 mul_49))
(assert eq_72)
(define-fun floordiv_3 () Int (div mul_49 mul_49))
(define-fun eq_73 () Bool (= floordiv_3 24))
(define-fun not__54 () Bool (not eq_73))
(assert not__54)
(define-fun mod_7 () Int (mod 24 floordiv_3))
(define-fun eq_74 () Bool (= mod_7 0))
(assert eq_74)
(define-fun ge_11 () Bool (>= floordiv_3 0))
(assert ge_11)
(define-fun floordiv_4 () Int (div 24 floordiv_3))
(define-fun mul_50 () Int (* mul_44 floordiv_4))
(define-fun mul_51 () Int (* floordiv_3 floordiv_4))
...
(assert not__55)
(define-fun eq_76 () Bool (= floordiv_4 1))
(define-fun not__56 () Bool (not eq_76))
(assert not__56)
(define-fun eq_77 () Bool (= floordiv_3 1))
(assert eq_77)
(define-fun eq_78 () Bool (= mul_44 1))
(define-fun not__57 () Bool (not eq_78))
(assert not__57)
(define-fun eq_79 () Bool (= floordiv_4 0))
(define-fun not__58 () Bool (not eq_79))
(assert not__58)
(define-fun lt_15 () Bool (< mul_44 0))
(define-fun not__59 () Bool (not lt_15))
(assert not__59)
(define-fun gt_4 () Bool (> floordiv_4 1))
(assert gt_4)
(define-fun lt_16 () Bool (< 1 mul_50))
(assert lt_16)
(define-fun eq_80 () Bool (= floordiv_4 24))
(assert eq_80)
(define-fun eq_81 () Bool (= mul_11 0))
(define-fun not__60 () Bool (not eq_81))
(assert not__60)
(define-fun eq_82 () Bool (= mul_48 0))
(define-fun not__61 () Bool (not eq_82))
(assert not__61)
(define-fun eq_83 () Bool (= mul_40 0))
(define-fun not__62 () Bool (not eq_83))
(assert not__62)
(define-fun output0_size0 () Int floordiv_3)
(define-fun output0_size1 () Int floordiv_4)
(define-fun output0_size2 () Int floordiv)
(define-fun output0_size3 () Int floordiv)
(define-fun output0_stride0 () Int mul_50)
(define-fun output0_stride1 () Int mul_44)
(define-fun output0_stride2 () Int floordiv)
(define-fun output0_stride3 () Int 1)
(define-fun output0_storage_offset () Int 0)
(define-fun output1_size0 () Int 24)
(define-fun output1_size1 () Int floordiv)
(define-fun output1_size2 () Int 64)
(define-fun output1_stride0 () Int mul_34)
