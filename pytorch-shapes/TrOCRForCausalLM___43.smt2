...
(set-info :example-attention_mask_size2 256)
(declare-const attention_mask_size3 Int)
(set-info :example-attention_mask_size3 256)
(declare-const attention_mask_stride0 Int)
(set-info :example-attention_mask_stride0 65536)
(declare-const attention_mask_stride1 Int)
(set-info :example-attention_mask_stride1 65536)
(declare-const attention_mask_stride2 Int)
(set-info :example-attention_mask_stride2 256)
