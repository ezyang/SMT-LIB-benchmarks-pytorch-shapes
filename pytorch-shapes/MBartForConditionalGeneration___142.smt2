...
(assert eq_100)
(define-fun eq_101 () Bool (= residual_size2 1024))
(assert eq_101)
...
(define-fun mul_78 () Int (* 1024 floordiv))
(define-fun mul_79 () Int (* residual_size0 floordiv))
(define-fun mul_80 () Int (* mul_79 1024))
...
(assert not__86)
(define-fun gt_4 () Bool (> mul_78 1024))
(assert gt_4)
...
(define-fun mul_83 () Int (* 1024 sub_16))
(define-fun add_42 () Int (+ add_41 mul_83))
(define-fun add_43 () Int (+ add_42 1023))
...
(assert eq_135)
(define-fun eq_136 () Bool (= encoder_hidden_states_size2 1024))
(assert eq_136)
(define-fun mul_86 () Int (* 1024 encoder_hidden_states_size1))
(define-fun mul_87 () Int (* 1024 sub_11))
(define-fun add_44 () Int (+ 1 mul_87))
(define-fun add_45 () Int (+ add_44 1023))
(define-fun mul_88 () Int (* 4 add_45))
(define-fun mul_89 () Int (* encoder_hidden_states_size1 1024))
...
(assert not__98)
(define-fun mul_90 () Int (* mul_49 1024))
...
(define-fun mul_91 () Int (* 1024 floordiv_1))
(define-fun mul_92 () Int (* encoder_hidden_states_size0 floordiv_1))
(define-fun mul_93 () Int (* mul_92 1024))
...
(assert ge_24)
(define-fun mul_101 () Int (* 64 floordiv_1))
...
(define-fun mul_106 () Int (* 64 sub_17))
...
(define-fun mul_109 () Int (* mul_108 64))
...
(assert not__114)
(define-fun mul_114 () Int (* 64 floordiv))
...
(define-fun mul_119 () Int (* 64 sub_16))
...
(assert lt_40)
(define-fun lt_41 () Bool (< 64 mul_101))
(assert lt_41)
