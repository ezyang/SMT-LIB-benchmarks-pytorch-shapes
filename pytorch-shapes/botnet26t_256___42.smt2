...
(set-info :example-___stack0_size2 256)
...
(set-info :example-___stack1_size1 256)
(declare-const ___stack1_size2 Int)
(set-info :example-___stack1_size2 256)
(declare-const ___stack1_stride0 Int)
(set-info :example-___stack1_stride0 65536)
(declare-const ___stack1_stride1 Int)
(set-info :example-___stack1_stride1 256)
...
(set-info :example-v__base_size2 256)
(declare-const v__base_stride0 Int)
(set-info :example-v__base_stride0 32768)
(declare-const v__base_stride1 Int)
(set-info :example-v__base_stride1 256)
...
(assert eq_62)
(define-fun eq_63 () Bool (= ___stack0_size2 256))
(assert eq_63)
...
(assert not__62)
(define-fun lt_30 () Bool (< 16 ___stack0_size1))
(assert lt_30)
(define-fun mul_54 () Int (* 16 v_size2))
(define-fun lt_31 () Bool (< 256 ___stack0_size1))
(define-fun not__63 () Bool (not lt_31))
(assert not__63)
(define-fun eq_91 () Bool (= 256 ___stack0_size1))
(assert eq_91)
...
(assert eq_109)
(define-fun eq_110 () Bool (= ___stack0_size1 16))
(define-fun not__79 () Bool (not eq_110))
(assert not__79)
(define-fun mod_3 () Int (mod ___stack0_size1 16))
(define-fun eq_111 () Bool (= mod_3 0))
(assert eq_111)
(define-fun floordiv_1 () Int (div ___stack0_size1 16))
(define-fun mul_70 () Int (* mul_66 16))
...
(assert eq_114)
(define-fun mul_72 () Int (* floordiv_1 16))
...
(assert lt_36)
(define-fun eq_119 () Bool (= floordiv_1 16))
(assert eq_119)
(define-fun sub_10 () Int (- floordiv_1 1))
(define-fun sub_11 () Int (- sub_10 1))
(define-fun floordiv_2 () Int (div sub_11 2))
(define-fun mod_4 () Int (mod sub_11 2))
(define-fun eq_120 () Bool (= mod_4 0))
(assert eq_120)
(define-fun add_26 () Int (+ floordiv_2 1))
(define-fun gt_4 () Bool (> ___stack0_size1 1))
(assert gt_4)
(define-fun gt_5 () Bool (> mul_68 1))
(assert gt_5)
(define-fun ge_14 () Bool (>= add_26 1))
(assert ge_14)
(define-fun ge_15 () Bool (>= mul_65 0))
(assert ge_15)
(define-fun ge_16 () Bool (>= add_26 0))
(assert ge_16)
(define-fun eq_121 () Bool (= add_26 0))
(define-fun not__84 () Bool (not eq_121))
(assert not__84)
(define-fun mul_75 () Int (* add_26 8))
(define-fun mul_76 () Int (* mul_75 mul_65))
(define-fun mul_77 () Int (* mul_76 8))
(define-fun mul_78 () Int (* mul_76 7))
(define-fun add_27 () Int (+ 1 mul_78))
(define-fun sub_12 () Int (- mul_65 1))
(define-fun mul_79 () Int (* mul_75 sub_12))
(define-fun add_28 () Int (+ add_27 mul_79))
(define-fun mul_80 () Int (* add_26 7))
(define-fun add_29 () Int (+ add_28 mul_80))
(define-fun sub_13 () Int (- add_26 1))
(define-fun add_30 () Int (+ add_29 sub_13))
(define-fun mul_81 () Int (* 4 add_30))
(define-fun mul_82 () Int (* mul_66 8))
(define-fun mul_83 () Int (* mul_82 add_26))
(define-fun eq_122 () Bool (= mul_83 0))
(define-fun not__85 () Bool (not eq_122))
(assert not__85)
(define-fun eq_123 () Bool (= add_26 1))
(define-fun not__86 () Bool (not eq_123))
(assert not__86)
(define-fun eq_124 () Bool (= add_26 add_26))
(assert eq_124)
(define-fun eq_125 () Bool (= mul_75 mul_75))
(assert eq_125)
(define-fun eq_126 () Bool (= mul_76 mul_76))
(assert eq_126)
(define-fun eq_127 () Bool (= mul_75 1))
(define-fun not__87 () Bool (not eq_127))
(assert not__87)
(define-fun eq_128 () Bool (= mul_75 0))
(define-fun not__88 () Bool (not eq_128))
(assert not__88)
(define-fun lt_37 () Bool (< mul_75 0))
(define-fun not__89 () Bool (not lt_37))
(assert not__89)
(define-fun lt_38 () Bool (< 1 mul_76))
(assert lt_38)
(define-fun lt_39 () Bool (< 1 mul_55))
(assert lt_39)
(define-fun lt_40 () Bool (< 16 mul_55))
(assert lt_40)
(define-fun lt_41 () Bool (< 256 mul_55))
(assert lt_41)
(define-fun lt_42 () Bool (< 131072 mul_55))
(assert lt_42)
(define-fun eq_129 () Bool (= 1048576 mul_55))
(assert eq_129)
(define-fun eq_130 () Bool (= mul_11 0))
(define-fun not__90 () Bool (not eq_130))
(assert not__90)
(define-fun eq_131 () Bool (= mul_23 0))
(define-fun not__91 () Bool (not eq_131))
(assert not__91)
(define-fun eq_132 () Bool (= mul_32 0))
(define-fun not__92 () Bool (not eq_132))
(assert not__92)
(define-fun eq_133 () Bool (= mul_81 0))
...
(define-fun output0_size3 () Int add_26)
(define-fun output0_stride0 () Int mul_76)
(define-fun output0_stride1 () Int mul_75)
(define-fun output0_stride2 () Int add_26)
