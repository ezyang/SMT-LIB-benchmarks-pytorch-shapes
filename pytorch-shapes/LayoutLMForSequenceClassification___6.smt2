...
(set-info :example-outputs_last_hidden_state_size0 1)
(declare-const outputs_last_hidden_state_size1 Int)
(set-info :example-outputs_last_hidden_state_size1 512)
(declare-const outputs_last_hidden_state_size2 Int)
(set-info :example-outputs_last_hidden_state_size2 768)
(declare-const outputs_last_hidden_state_stride0 Int)
(set-info :example-outputs_last_hidden_state_stride0 393216)
(declare-const outputs_last_hidden_state_stride1 Int)
(set-info :example-outputs_last_hidden_state_stride1 768)
(declare-const outputs_last_hidden_state_stride2 Int)
(set-info :example-outputs_last_hidden_state_stride2 1)
(declare-const outputs_last_hidden_state_storage_offset Int)
(set-info :example-outputs_last_hidden_state_storage_offset 0)
...
(set-info :example-outputs_pooler_output_size0 1)
(declare-const outputs_pooler_output_size1 Int)
(set-info :example-outputs_pooler_output_size1 768)
(declare-const outputs_pooler_output_stride0 Int)
(set-info :example-outputs_pooler_output_stride0 768)
(declare-const outputs_pooler_output_stride1 Int)
(set-info :example-outputs_pooler_output_stride1 1)
(declare-const outputs_pooler_output_storage_offset Int)
(set-info :example-outputs_pooler_output_storage_offset 0)
...
(set-info :example-logits_size0 1)
(declare-const logits_size1 Int)
(set-info :example-logits_size1 2)
(declare-const logits_stride0 Int)
(set-info :example-logits_stride0 2)
(declare-const logits_stride1 Int)
(set-info :example-logits_stride1 1)
(declare-const logits_storage_offset Int)
(set-info :example-logits_storage_offset 0)
...
(check-sat)
(get-value (labels_size0 labels_stride0 labels_storage_offset outputs_last_hidden_state_size0 outputs_last_hidden_state_size1 outputs_last_hidden_state_size2 outputs_last_hidden_state_stride0 outputs_last_hidden_state_stride1 outputs_last_hidden_state_stride2 outputs_last_hidden_state_storage_offset outputs_pooler_output_size0 outputs_pooler_output_size1 outputs_pooler_output_stride0 outputs_pooler_output_stride1 outputs_pooler_output_storage_offset logits_size0 logits_size1 logits_stride0 logits_stride1 logits_storage_offset output0_storage_offset))
