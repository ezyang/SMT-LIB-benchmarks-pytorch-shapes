...
(set-info :example-input_size1 128)
(declare-const input_size2 Int)
(set-info :example-input_size2 96)
(declare-const input_size3 Int)
(set-info :example-input_size3 128)
(declare-const input_stride0 Int)
(set-info :example-input_stride0 1572864)
(declare-const input_stride1 Int)
(set-info :example-input_stride1 12288)
(declare-const input_stride2 Int)
(set-info :example-input_stride2 128)
...
(define-fun eq_26 () Bool (= input_size1 128))
(assert eq_26)
...
(define-fun mul_26 () Int (* input_size0 64))
...
(define-fun output3_size1 () Int 64)
